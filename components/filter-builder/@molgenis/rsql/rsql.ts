...
// https://github.com/molgenis/molgenis-js-rsql/blob/master/src/rsql.js
// TODO: Remove this file and import from "@molgenis/rsql" instead when v0.1.2 is available via NPM.
