  ...
  (u.prototype = {
    ...
    open: function(c) {
      ...
      return (
        ...
        setTimeout(function() {
          b.content
            ? (b._addClassToMFP(r), b._setFocus())
      ...
      (b.content = a),
        a
          ? b.st.showCloseBtn && b.st.closeBtnInside && b.currTemplate[c] === !0
            ? b.content.find(".mfp-close").length || b.content.append(A())
            : (b.content = a)
          : (b.content = ""),
        z(l),
    ...
    _hasScrollBar: function(a) {
      return (
        (b.isIE7 ? e.height() : document.body.scrollHeight) > (a || w.height())
      );
    },
    _setFocus: function() {
      ...
      getInline: function(c, d) {
        if ((H(), c.src)) {
          ...
          if (f.length) {
            ...
            g &&
              g.tagName &&
              (E || ((D = e.hiddenClass), (E = y(D)), (D = "mfp-" + D)),
              (F = f
                .after(E)
                .detach()
                .removeClass(D))),
          ...
          c && c.enabled
            ? ((g += " mfp-gallery"),
              ...
              x("UpdateStatus" + d, function(a, c) {
                c.text &&
                  (c.text = U(c.text, b.currItem.index, b.items.length));
              }),
