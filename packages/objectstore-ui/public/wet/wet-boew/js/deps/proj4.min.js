  ...
  return (function a(b, c, d) {
  ...
  })(
    {
      ...
      2: [
        function(a, b) {
          function c(a, b) {
            ...
            var f = d(a);
            if ("object" != typeof f) return void b(a);
            var h = g(f),
              i = c.projections.get(h.projName);
            i ? (e(this, h), e(this, i), this.init(), b(null, this)) : b(a);
          }
          var d = a("./parseCode"),
            e = a("./extend"),
            f = a("./projections"),
            g = a("./deriveConstants");
          (c.projections = f), c.projections.start(), (b.exports = c);
        },
        {
          "./deriveConstants": 32,
          "./extend": 33,
      ...
      35: [
        function(a, b) {
          var c = a("./core");
          (c.defaultDatum = "WGS84"),
            (c.Proj = a("./Proj")),
            (c.WGS84 = new c.Proj("WGS84")),
            (c.Point = a("./Point")),
            (c.toPoint = a("./common/toPoint")),
            (c.defs = a("./defs")),
            (c.transform = a("./transform")),
            (c.mgrs = a("mgrs")),
            (c.version = a("../package.json").version),
            a("./includedProjections")(c),
            (b.exports = c);
        },
        {
          "../package.json": 67,
