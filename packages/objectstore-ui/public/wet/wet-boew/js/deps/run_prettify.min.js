...
!(function() {
  "use strict";
  function a(a) {
    var b = f.addEventListener,
      c = !1,
      d = !0,
      h = b ? "addEventListener" : "attachEvent",
      i = b ? "removeEventListener" : "detachEvent",
      j = b ? "" : "on",
      k = function(b) {
        ("readystatechange" != b.type || "complete" == f.readyState) &&
          (("load" == b.type ? e : f)[i](j + b.type, k, !1),
          !c && (c = !0) && a.call(e, b.type || b));
      },
      l = function() {
        try {
          g.doScroll("left");
        } catch (a) {
          return void e.setTimeout(l, 50);
        }
        k("poll");
      };
    if ("complete" == f.readyState) a.call(e, "lazy");
    else {
      if (f.createEventObject && g.doScroll) {
        try {
          d = !e.frameElement;
        } catch (m) {}
        d && l();
      }
      f[h](j + "DOMContentLoaded", k, !1),
        f[h](j + "readystatechange", k, !1),
        e[h](j + "load", k, !1);
    }
  }
  function b(a) {
                ...
                for (var b = 0; a > b; ++b)
                  !(function(a) {
                    e.setTimeout(function() {
                      e.exports[q[a]].apply(e, arguments);
                    }, 0);
                  })(b);
              }
            : void 0;
  ...
  for (
    var e = window,
      f = document,
      g = f.documentElement,
      h = f.head || f.getElementsByTagName("head")[0] || g,
      i = "",
      j = f.getElementsByTagName("script"),
      k = j.length;
    --k >= 0;

  ) {
    var l = j[k],
      m = l.src.match(/^[^?#]*\/run_prettify\.js(\?[^#]*)?(?:#.*)?$/);
    if (m) {
      (i = m[1] || ""), l.parentNode.removeChild(l);
      break;
    }
  }
  var n = !0,
  ...
  for (
    var r = "https://cdn.rawgit.com/google/code-prettify/master/loader",
      k = 0,
      s = o.length;
    s > k;
    ++k
    ...
    (function(a) {
      ...
      (b.onload = b.onerror = b.onreadystatechange = function() {
        !b ||
          (b.readyState && !/loaded|complete/.test(b.readyState)) ||
        ...
        (b.src = r + "/lang-" + encodeURIComponent(o[k]) + ".js"),
        h.insertBefore(b, h.firstChild);
    })(o[k]);
  for (var t = o.length, u = [], k = 0, s = p.length; s > k; ++k)
    u.push(r + "/skins/" + encodeURIComponent(p[k]) + ".css");
  u.push(r + "/prettify.css"), b(u);
  var v = (function() {
      ...
      (function() {
              ...
              if (/\\[bdsw]/i.test(j)) g.push(j);
                ...
                i > h + 2 && "-" === d[h + 1]
                  ...
                  65 > k ||
                    ...
                    (65 > k ||
                      l > 90 ||
                      e.push([32 | Math.max(65, l), 32 | Math.min(k, 90)]),
                    97 > k ||
                      l > 122 ||
                      e.push([-33 & Math.max(97, l), -33 & Math.min(k, 122)]));
              }
            }
            e.sort(function(a, b) {
        ...
        function e(a, b, c, d, e) {
          if (c) {
            ...
            d(f), e.push.apply(e, f.decorations);
          }
        }
        function f(a) {
          for (var b = void 0, c = a.firstChild; c; c = c.nextSibling) {
            var d = c.nodeType;
            b = 1 === d ? (b ? a : c) : 3 === d && S.test(c.nodeValue) ? a : b;
          }
          return b === a ? void 0 : b;
        }
        function g(a, b) {
          ...
          !(function() {
            for (
              var e = a.concat(b), g = [], h = {}, i = 0, j = e.length;
              j > i;
              ++i
            ) {
              var k = e[i],
            ...
            h = function(a) {
              for (
                ...
                if ("string" == typeof t) r = !1;
                  ...
                  var v = f[s.charAt(0)];
                  if (v) (u = s.match(v[1])), (t = v[0]);
                  else {
                    for (var w = 0; g > w; ++w)
                      if (((v = b[w]), (u = s.match(v[1])))) {
                        t = v[0];
                        break;
                      }
                    u || (t = K);
                  }
                  (r = t.length >= 5 && "lang-" === t.substring(0, 5)),
                    !r || (u && "string" == typeof u[1]) || ((r = !1), (t = N)),
                    r || (o[s] = t);
                }
                var x = m;
                if (((m += s.length), r)) {
                  var y = u[1],
                    z = s.indexOf(y),
                    A = z + y.length;
                  u[2] && ((A = s.length - u[2].length), (z = A - y.length));
                  var B = t.substring(5);
                  e(j, i + x, s.substring(0, z), h, k),
                    e(j, i + x + z, y, l(B, y), k),
                    e(j, i + x + A, s.substring(A), h, k);
                } else k.push(i + x, t);
              }
              a.decorations = k;
            };
        ...
        function i(a, b, c) {
          function d(a) {
            ...
            else for (var n = a.firstChild; n; n = n.nextSibling) d(n);
          }
          function e(a) {
            function b(a, c) {
            ...
            for (
              var c, d = b(a.nextSibling, 0);
              (c = d.parentNode) && 1 === c.nodeType;
          ...
          for (
            var m = Math.max(0, (b - 1) | 0) || 0, k = 0, n = j.length;
            n > k;
            ++k
          )
            (i = j[k]),
              (i.className = "L" + ((k + m) % 10)),
            ...
            for (; h > i; ) {
              ...
              if (1 !== w.nodeType && (t = d.substring(f, q))) {
                ...
                z.replaceChild(y, w),
                  y.appendChild(w),
                  u > f &&
                    ((g[i + 1] = w = x.createTextNode(d.substring(q, u))),
        ...
        function k(a, b) {
          for (var c = b.length; --c >= 0; ) {
            ...
            U.hasOwnProperty(d)
              ? p.console &&
                console.warn("cannot override language handler %s", d)
              : (U[d] = a);
          }
        }
        function l(a, b) {
          return (
            (a && U.hasOwnProperty(a)) ||
        ...
        function m(a) {
          ...
          try {
            ...
            p.console && console.log((f && f.stack) || f);
          }
        }
        function n(a, b, c) {
          var d = c || !1,
        ...
        function o(a, b) {
          ...
          function d() {
            for (
              var b = p.PR_SHOULD_USE_CONTINUATION ? o.now() + 250 : 1 / 0;
              q < j.length && o.now() < b;
              q++
            ) {
              for (var c = j[q], e = x, h = c; (h = h.previousSibling); ) {
                var k = h.nodeType,
                  l = (7 === k || 8 === k) && h.nodeValue;
                if (
                  l
                    ? !/^\??prettify\b/.test(l)
                    : 3 !== k || /\S/.test(h.nodeValue)
                )
                  break;
                if (l) {
                  (e = {}),
              ...
              var n = c.className;
              if ((e !== x || s.test(n)) && !t.test(n)) {
                for (var y = !1, z = c.parentNode; z; z = z.parentNode) {
                  var A = z.tagName;
                  if (w.test(A) && z.className && s.test(z.className)) {
                    y = !0;
                    break;
                  }
                }
                if (!y) {
                  ...
                  if (!B) {
                    ...
                    !B &&
                      (C = f(c)) &&
                      v.test(C.tagName) &&
                      (B = C.className.match(r)),
                      B && (B = B[1]);
                  }
                  var D;
                  if (u.test(c.tagName)) D = 1;
                  else {
                    var E = c.currentStyle,
                      F = g.defaultView,
                      G = E
                        ? E.whiteSpace
                        : F && F.getComputedStyle
                        ? F.getComputedStyle(c, null).getPropertyValue(
                            "white-space"
                          )
                        : 0;
                    D = G && "pre" === G.substring(0, 3);
                  }
                  var H = e.linenums;
                  (H = "true" === H || +H) ||
                    ((H = n.match(/\blinenums\b(?::(\d+))?/)),
                    (H = H ? (H[1] && H[1].length ? +H[1] : !0) : !1)),
                    H && i(c, H, D);
                  var I = {
                    langExtension: B,
                    sourceNode: c,
            ...
            q < j.length ? p.setTimeout(d, 250) : "function" == typeof a && a();
          }
          for (
            var e = b || document.body,
              g = e.ownerDocument || document,
              h = [c("pre"), c("code"), c("xmp")],
              j = [],
              k = 0;
            k < h.length;
            ++k
          )
            for (var l = 0, n = h[k].length; n > l; ++l) j.push(h[k][l]);
          h = null;
          var o = Date;
          o.now ||
            (o = {
        ...
        var p = window,
          q = ["break,continue,do,else,for,if,return,while"],
          r = [
            q,
          ...
          C = [t, v, u, x, y, z, A, B],
          D = /^(DIR|FILE|array|vector|(de|priority_)?queue|(forward_)?list|stack|(const_)?(reverse_)?iterator|(unordered_)?(multi)?(set|map)|bitset|u?(int|float)\d*)\b/,
          E = "str",
          F = "kwd",
          G = "com",
          H = "typ",
        ...
        k(T, ["default-code"]),
          ...
          k(g([], [[P, /^[\s\S]+/]]), ["uq.val"]),
          k(
            h({ keywords: t, hashComments: !0, cStyleComments: !0, types: D }),
            ["c", "cc", "cpp", "cxx", "cyc", "m"]
          ),
          k(h({ keywords: "null,true,false" }), ["json"]),
          k(
            h({
              keywords: v,
              hashComments: !0,
          ...
          k(h({ keywords: u, cStyleComments: !0 }), ["java"]),
          k(h({ keywords: B, hashComments: !0, multiLineStrings: !0 }), [
            "bash",
            "bsh",
            "csh",
            "sh"
          ...
          k(h({ keywords: x, cStyleComments: !0, regexLiterals: !0 }), [
            "javascript",
            "js",
            "ts",
            "typescript"
        ...
        var V = (p.PR = {
            ...
            PR_TAG: L,
            PR_TYPE: H,
            prettyPrintOne: IN_GLOBAL_SCOPE ? (p.prettyPrintOne = n) : (a = n),
            prettyPrint: (b = IN_GLOBAL_SCOPE ? (p.prettyPrint = o) : (b = o))
          }),
          W = p.define;
        "function" == typeof W &&
          W.amd &&
          W("google-code-prettify", [], function() {
            return V;
          });
      })(),
      b
