  ...
  (a.color = {}),
    (a.color.make = function(b, c, d, e) {
      ...
      return (
        ...
        (f.toString = function() {
          return f.a >= 1
            ? "rgb(" + [f.r, f.g, f.b].join(",") + ")"
            : "rgba(" + [f.r, f.g, f.b, f.a].join(",") + ")";
        }),
    ...
    (a.color.parse = function(c) {
      var d,
        e = a.color.make;
      if (
        (d = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/.exec(
          c
        ))
      )
        return e(parseInt(d[1], 10), parseInt(d[2], 10), parseInt(d[3], 10));
      if (
        (d = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]+(?:\.[0-9]+)?)\s*\)/.exec(
          c
        ))
      )
        return e(
      ...
      if (
        (d = /rgb\(\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*\)/.exec(
          c
        ))
      )
        return e(
  ...
  (function(a) {
    ...
    function c(c, e, f, g) {
      ...
      function j(b) {
        a.extend(!0, ea, b),
          ...
          null == ea.xaxis.color &&
            (ea.xaxis.color = a.color
              .parse(ea.grid.color)
              .scale("a", 0.22)
              .toString()),
          null == ea.yaxis.color &&
            (ea.yaxis.color = a.color
              .parse(ea.grid.color)
              .scale("a", 0.22)
              .toString()),
          null == ea.xaxis.tickColor &&
            (ea.xaxis.tickColor = ea.grid.tickColor || ea.xaxis.color),
          null == ea.yaxis.tickColor &&
            (ea.yaxis.tickColor = ea.grid.tickColor || ea.yaxis.color),
          null == ea.grid.borderColor && (ea.grid.borderColor = ea.grid.color),
          null == ea.grid.tickColor &&
            (ea.grid.tickColor = a.color
              .parse(ea.grid.color)
              .scale("a", 0.22)
              .toString());
        var d,
        ...
        for (f = ea.xaxes.length || 1, d = 0; f > d; ++d)
          (e = ea.xaxes[d]),
            ...
            e.font &&
              ...
              e.font.lineHeight ||
                (e.font.lineHeight = Math.round(1.15 * e.font.size)));
        ...
        for (
          ea.xaxis.noTicks &&
            null == ea.xaxis.ticks &&
            (ea.xaxis.ticks = ea.xaxis.noTicks),
            ea.yaxis.noTicks &&
              null == ea.yaxis.ticks &&
              (ea.yaxis.ticks = ea.yaxis.noTicks),
            ea.x2axis &&
              ((ea.xaxes[1] = a.extend(!0, {}, ea.xaxis, ea.x2axis)),
              (ea.xaxes[1].position = "top"),
              null == ea.x2axis.min && (ea.xaxes[1].min = null),
              null == ea.x2axis.max && (ea.xaxes[1].max = null)),
            ea.y2axis &&
              ((ea.yaxes[1] = a.extend(!0, {}, ea.yaxis, ea.y2axis)),
            ...
            ea.grid.coloredAreasColor &&
              (ea.grid.markingsColor = ea.grid.coloredAreasColor),
            ...
            null != ea.highlightColor &&
              (ea.series.highlightColor = ea.highlightColor),
            d = 0;
          d < ea.xaxes.length;
          ++d
        )
      ...
      function m(a, b) {
        var c = a[b + "axis"];
        return (
          "object" == typeof c && (c = c.n), "number" != typeof c && (c = 1), c
        );
      }
      function n() {
      ...
      function o(a) {
        ...
        return (
          void 0 !== d.x1 && (d.x = d.x1), void 0 !== d.y1 && (d.y = d.y1), d
        );
      }
      function p(a) {
        var b,
      ...
      function r() {
        ...
        for (b = 0; b < da.length; ++b) {
          if (
            ((k = da[b]),
            null == k.color
              ? ((k.color = g[l].toString()), ++l)
              : "number" == typeof k.color && (k.color = g[k.color].toString()),
            null == k.lines.show)
          ) {
            var n,
              o = !0;
      ...
      function s() {
        ...
        for (c = 0; c < da.length; ++c) {
          if (((g = da[c]), (o = g.data), (p = g.datapoints.format), !p)) {
            if (
              ...
              var t = !!(
                (g.bars.show && g.bars.zero) ||
                (g.lines.show && g.lines.zero)
              );
              p.push({
                y: !0,
                number: !0,
          ...
          if (null == g.datapoints.pointsize) {
            ...
            for (
              g.xaxis.used = g.yaxis.used = !0, d = e = 0;
              d < o.length;
              ++d, e += j
            ) {
              m = o[d];
                ...
                for (f = 0; j > f; ++f)
                  (k = i[e + f]),
                    null != k &&
                      ((l = p[f]),
                      l.autoscale !== !1 &&
                        (l.x && b(g.xaxis, k, k), l.y && b(g.yaxis, k, k))),
                    (i[e + f] = null);
              else if (
                u &&
                e > 0 &&
        ...
        for (c = 0; c < da.length; ++c) {
          ...
          if (g.bars.show) {
            ...
            g.bars.horizontal
              ? ((x += A), (z += A + g.bars.barWidth))
              : ((w += A), (y += A + g.bars.barWidth));
          }
      ...
      function t() {
        c
          ...
          .filter(function() {
            return (
              !a(this).hasClass("flot-overlay") &&
              !a(this).hasClass("flot-base")
            );
          })
          .remove(),
      ...
      function u() {
        ea.grid.hoverable && (ha.mousemove(T), ha.bind("mouseleave", U)),
      ...
      function w(a) {
        ...
        "x" == a.direction
          ? ((c = a.scale = na / Math.abs(e(a.max) - e(a.min))),
            (d = Math.min(e(a.max), e(a.min))))
          : ((c = a.scale = oa / Math.abs(e(a.max) - e(a.min))),
            (c = -c),
        ...
        for (
          var b = a.options,
            ...
            f =
              d ||
              ("x" == a.direction
                ? Math.floor(fa.width / (c.length || 1))
                : null),
            g = a.direction + "Axis " + a.direction + a.n + "Axis",
            h =
              "flot-" +
              a.direction +
              "-axis flot-" +
              ...
              "-axis " +
              g,
            i = b.font || "flot-tick-label tickLabel",
            j = 0;
          j < c.length;
          ++j
        ) {
      ...
      function y(b) {
        ...
        a.each(f ? ka : la, function(a, c) {
          c &&
            (c.show || c.reserveSpace) &&
            (c === b
              ? (m = !0)
              : c.options.position === e && (m ? (k = !1) : (j = !1)),
            m || (l = !1));
        }),
          k && (h = 0),
          null == g && (g = l ? "full" : 5),
          ...
          f
            ? ((d += i),
              "bottom" == e
                ? ((ma.bottom += d + h),
                  (b.box = { top: fa.height - ma.bottom, height: d }))
                : ((b.box = { top: ma.top + h, height: d }), (ma.top += d + h)))
            : ((c += i),
              "left" == e
                ? ((b.box = { left: ma.left + h, width: c }),
                  (ma.left += c + h))
                : ((ma.right += c + h),
                  (b.box = { left: fa.width - ma.right, width: c }))),
          (b.position = e),
          (b.tickLength = g),
          (b.box.padding = i),
          (b.innermost = j);
      ...
      function z(a) {
        "x" == a.direction
          ? ((a.box.left = ma.left - a.labelWidth / 2),
            (a.box.width = fa.width - ma.left - ma.right + a.labelWidth))
          : ((a.box.top = ma.top - a.labelHeight / 2),
      ...
      function A() {
        ...
        if (null == c)
          for (c = 0, b = 0; b < da.length; ++b)
            c = Math.max(
              c,
              2 * (da[b].points.radius + da[b].points.lineWidth / 2)
            );
        var d = { left: c, right: c, top: c, bottom: c };
        a.each(n(), function(a, b) {
          b.reserveSpace &&
            b.ticks &&
            b.ticks.length &&
            ("x" === b.direction
              ? ((d.left = Math.max(d.left, b.labelWidth / 2)),
                (d.right = Math.max(d.right, b.labelWidth / 2)))
              : ((d.bottom = Math.max(d.bottom, b.labelHeight / 2)),
      ...
      function B() {
        ...
        for (var e in ma)
          "object" == typeof ea.grid.borderWidth
            ? (ma[e] += d ? ea.grid.borderWidth[e] : 0)
            : (ma[e] += d ? ea.grid.borderWidth : 0);
        if (
          (a.each(c, function(a, b) {
            var c = b.options;
            (b.show = null == c.show ? b.used : c.show),
              (b.reserveSpace =
                null == c.reserveSpace ? b.show : c.reserveSpace),
              C(b);
          }),
          d)
        ) {
      ...
      function D(b) {
        var c,
          e = b.options;
        c =
          "number" == typeof e.ticks && e.ticks > 0
            ? e.ticks
            : 0.3 * Math.sqrt("x" == b.direction ? fa.width : fa.height);
        var f = (b.max - b.min) / c,
        ...
        if (
          (b.tickGenerator ||
            ((b.tickGenerator = function(a) {
              var b,
                ...
                f = 0,
                g = Number.NaN;
              do (b = g), (g = e + f * a.tickSize), c.push(g), ++f;
              while (g < a.max && g != b);
              return c;
            }),
            (b.tickFormatter = function(a, b) {
              ...
              if (null != b.tickDecimals) {
                ...
                if (f < b.tickDecimals)
                  return (
                    (f ? d : d + ".") + ("" + c).substr(1, b.tickDecimals - f)
                  );
              }
              return d;
            })),
          a.isFunction(e.tickFormatter) &&
            (b.tickFormatter = function(a, b) {
          ...
          if (l && l.used && l != b) {
            ...
            if (
              (m.length > 0 &&
                (null == e.min && (b.min = Math.min(b.min, m[0])),
                null == e.max &&
                  m.length > 1 &&
                  (b.max = Math.max(b.max, m[m.length - 1]))),
              (b.tickGenerator = function(a) {
                var b,
                  c,
                  d = [];
              ...
              var n = Math.max(
                  0,
                  -Math.floor(Math.log(b.delta) / Math.LN10) + 1
                ),
                o = b.tickGenerator(b);
              (o.length > 1 && /\..*0$/.test((o[1] - o[0]).toFixed(n))) ||
                (b.tickDecimals = n);
            }
          }
        }
      ...
      function E(b) {
        var c = b.options.ticks,
          d = [];
        null == c || ("number" == typeof c && c > 0)
          ? (d = b.tickGenerator(b))
          : c && (d = a.isFunction(c) ? c(b) : c);
        var e, f;
        for (b.ticks = [], e = 0; e < d.length; ++e) {
          var g = null,
            h = d[e];
          "object" == typeof h
            ? ((f = +h[0]), h.length > 1 && (g = h[1]))
            : (f = +h),
            null == g && (g = b.tickFormatter(f, b)),
            isNaN(f) || b.ticks.push({ v: f, label: g });
        }
      }
      function F(a, b) {
        a.options.autoscaleMargin &&
          b.length > 0 &&
          (null == a.options.min && (a.min = Math.min(a.min, b[0].v)),
          null == a.options.max &&
            b.length > 1 &&
            (a.max = Math.max(a.max, b[b.length - 1].v)));
      }
      function G() {
      ...
      function J() {
              ...
              if (!j || !k)
                if (
                  ...
                  ia.beginPath(),
                    ...
                    (ia.lineWidth = l),
                    j
                      ? (ia.moveTo(h.to + m, i.from), ia.lineTo(h.to + m, i.to))
                      : (ia.moveTo(h.from, i.to + m),
            ...
            for (
                  ...
                  : ((q = 0),
                    (p =
                      "full" == v
                        ...
                        : u.left -
                          ma.left +
                          ("left" == t.position ? u.width : 0))),
                t.innermost ||
                  ((ia.strokeStyle = t.options.color),
                  ia.beginPath(),
                  (r = s = 0),
              ...
              (r = s = 0),
                isNaN(w) ||
                  ...
                  w > t.max ||
                  ("full" == v &&
                    (("object" == typeof d && d[t.position] > 0) || d > 0) &&
                    (w == t.min || w == t.max)) ||
                  ("x" == t.direction
                    ? ((p = t.p2c(w)),
                      (s = "full" == v ? -oa : v),
        ...
        d &&
          ((e = ea.grid.borderColor),
          "object" == typeof d || "object" == typeof e
            ? ("object" != typeof d &&
                (d = { top: d, right: d, bottom: d, left: d }),
              "object" != typeof e &&
                (e = { top: e, right: e, bottom: e, left: e }),
              d.top > 0 &&
                ((ia.strokeStyle = e.top),
                (ia.lineWidth = d.top),
                ia.beginPath(),
      ...
      function K() {
        a.each(n(), function(a, b) {
          ...
          if ((fa.removeText(j), b.show && 0 != b.ticks.length))
                ...
                !c.label ||
                  ...
                  ("x" == b.direction
                    ? ((f = "center"),
                      ...
                      "bottom" == b.position
                        ? (e = h.top + h.padding)
                        : ((e = h.top + h.height - h.padding), (g = "bottom")))
                    : ((g = "middle"),
                      (e = ma.top + b.p2c(c.v)),
                      "left" == b.position
                        ? ((d = h.left + h.width - h.padding), (f = "right"))
                        : (d = h.left + h.padding)),
      ...
      function M(a) {
        ...
        function c(a, b, c) {
          for (
            ...
            if (null != l && null != n) {
              ...
              if (
                (h || (ia.beginPath(), ia.moveTo(b.p2c(l), c.p2c(f)), (h = !0)),
                m >= c.max && o >= c.max)
              )
                ...
                var p = l,
                  q = n;
                o >= m && m < c.min && o >= c.min
                  ? ((l = ((c.min - m) / (o - m)) * (n - l) + l), (m = c.min))
                  : m >= o &&
                    o < c.min &&
                    m >= c.min &&
                    ((n = ((c.min - m) / (o - m)) * (n - l) + l), (o = c.min)),
                  m >= o && m > c.max && o <= c.max
                    ? ((l = ((c.max - m) / (o - m)) * (n - l) + l), (m = c.max))
                    : o >= m &&
                      o > c.max &&
                      m <= c.max &&
                      ((n = ((c.max - m) / (o - m)) * (n - l) + l),
        ...
        g && ((ia.fillStyle = g), c(a.datapoints, a.xaxis, a.yaxis)),
        ...
        function b(a, b, c, d, e, f, g, h) {
          for (var i = a.points, j = a.pointsize, k = 0; k < i.length; k += j) {
            ...
            null == l ||
              ...
              (m = g.p2c(m) + d),
              "circle" == h
                ? ia.arc(l, m, b, 0, e ? Math.PI : 2 * Math.PI, !1)
                : h(ia, l, m, b, e),
              ia.closePath(),
              c && ((ia.fillStyle = c), ia.fill()),
              ia.stroke());
          }
        }
        ia.save(), ia.translate(ma.left, ma.top);
      ...
      function O(a, b, c, d, e, f, g, h, i, j, k) {
        ...
        j
          ...
          m < g.min ||
            ...
            (m = g.p2c(m)),
            (o = h.p2c(o)),
            f && ((i.fillStyle = f(n, o)), i.fillRect(l, o, m - l, n - o)),
            k > 0 &&
              (p || q || r || s) &&
              (i.beginPath(),
              i.moveTo(l, n),
      ...
      function Q(b, c, d, e) {
        ...
        return (
          (g.a = "number" == typeof f ? f : 0.4), g.normalize(), g.toString()
        );
      }
      function R() {
        if (
          (null != ea.legend.container
            ? a(ea.legend.container).html("")
          ...
          for (
            ...
            (b = da[i]),
              b.label &&
                ((d = h ? h(b.label, b) : b.label),
                d && f.push({ label: d, color: b.color }));
          if (ea.legend.sorted)
            if (a.isFunction(ea.legend.sorted)) f.sort(ea.legend.sorted);
            else if ("reverse" == ea.legend.sorted) f.reverse();
            else {
          ...
          for (var i = 0; i < f.length; ++i) {
            var k = f[i];
            i % ea.legend.noColumns == 0 &&
              (g && e.push("</tr>"), e.push("<tr>"), (g = !0)),
              e.push(
                '<td class="legendColorBox"><div style="border:1px solid ' +
                  ea.legend.labelBoxBorderColor +
          ...
          if ((g && e.push("</tr>"), 0 != e.length)) {
            var l =
              ...
              e.join("") +
              "</table>";
            if (null != ea.legend.container) a(ea.legend.container).html(l);
            else {
              var m = "",
              ...
              null == o[0] && (o = [o, o]),
                "n" == n.charAt(0)
                  ? (m += "top:" + (o[1] + ma.top) + "px;")
                  : "s" == n.charAt(0) &&
                    (m += "bottom:" + (o[1] + ma.bottom) + "px;"),
                "e" == n.charAt(1)
                  ? (m += "right:" + (o[0] + ma.right) + "px;")
                  : "w" == n.charAt(1) &&
                    (m += "left:" + (o[0] + ma.left) + "px;");
              var p = a(
                '<div class="legend">' +
              ...
              if (0 != ea.legend.backgroundOpacity) {
                ...
                null == q &&
                  ((q = ea.grid.backgroundColor),
                  (q =
                    q && "string" == typeof q
                      ? a.color.parse(q)
                      : a.color.extract(p, "background-color")),
                  (q.a = 1),
                  (q = q.toString()));
                var r = p.children();
                a(
                  ...
                  .prependTo(p)
                  .css("opacity", ea.legend.backgroundOpacity);
              }
            }
          }
        }
      ...
      function W(a, b, d) {
        ...
        if (
          (i &&
            ((i.pageX = parseInt(
              i.series.xaxis.p2c(i.datapoint[0]) + e.left + ma.left,
              10
            )),
            (i.pageY = parseInt(
              i.series.yaxis.p2c(i.datapoint[1]) + e.top + ma.top,
              10
            ))),
          ...
          for (var j = 0; j < ra.length; ++j) {
            ...
            k.auto != a ||
              (i &&
                k.series == i.series &&
                k.point[0] == i.datapoint[0] &&
                k.point[1] == i.datapoint[1]) ||
              $(k.series, k.point);
          }
      ...
      function Z(a, b, c) {
        ...
        var e = _(a, b);
        -1 == e
          ? (ra.push({ series: a, point: b, auto: c }), X())
          : c || (ra[e].auto = !1);
      }
      function $(a, b) {
      ...
      function aa(b, c) {
        var d = c[0],
          ...
          g = b.yaxis,
          h =
            "string" == typeof b.highlightColor
              ? b.highlightColor
              : a.color
                  .parse(b.color)
                  .scale("a", 0.5)
        ...
        if (!(d < f.min || d > f.max || e < g.min || e > g.max)) {
          ...
          (d = f.p2c(d)),
            ...
            "circle" == b.points.symbol
              ? ja.arc(d, e, j, 0, 2 * Math.PI, !1)
              : b.points.symbol(ja, d, e, j, !1),
            ja.closePath(),
            ja.stroke();
        }
      }
      ...
      function ca(b, c, d, e) {
        ...
        for (
          var f = ia.createLinearGradient(0, d, 0, c),
            g = 0,
            h = b.colors.length;
          h > g;
          ++g
      ...
      var da = [],
        ...
        ka = [],
        la = [],
        ma = { left: 0, right: 0, top: 0, bottom: 0 },
        na = 0,
        oa = 0,
        pa = {
          processOptions: [],
      ...
      (qa.setData = k),
        ...
        (qa.getAxes = function() {
          var b = {};
          return (
            a.each(ka.concat(la), function(a, c) {
    ...
    a.fn.detach ||
      ...
      (b.prototype.resize = function(a, b) {
        if (0 >= a || 0 >= b)
          throw new Error(
            "Invalid dimensions for plot, width = " + a + ", height = " + b
          );
        var c = this.element,
          d = this.context,
          e = this.pixelRatio;
        this.width != a &&
          ((c.width = a * e), (c.style.width = a + "px"), (this.width = a)),
          this.height != b &&
            ((c.height = b * e),
            (c.style.height = b + "px"),
            (this.height = b)),
                ...
                for (var h in g)
                  if (e.call(g, h)) {
                    for (var i, j = g[h].positions, k = 0; (i = j[k]); k++)
                      i.active
                        ? i.rendered || (c.append(i.element), (i.rendered = !0))
                        : (j.splice(k--, 1), i.rendered && i.element.detach());
        ...
        return (
          null == c &&
            (null == this.textContainer &&
              (this.textContainer = a("<div class='flot-text'></div>")
                .css({
                  position: "absolute",
                  top: 0,
                  left: 0,
      ...
      (b.prototype.getTextInfo = function(b, c, d, e, f) {
        ...
        if (
          ...
          var k = a("<div></div>")
            .html(c)
            .css({ position: "absolute", "max-width": f, top: -9999 })
            .appendTo(this.getTextLayer(b));
          "object" == typeof d
            ? k.css({ font: g, color: d.color })
      ...
      (b.prototype.removeText = function(a, b, c, d, f, g) {
        if (null == d) {
          ...
          for (
            var l, m = this.getTextInfo(a, d, f, g).positions, n = 0;
            (l = m[n]);
            n++
          )
