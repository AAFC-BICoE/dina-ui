  ...
  })(
    {
      ...
      16: [
        function(a, b) {
          ...
          b.exports = function(a, b) {
            for (
              var d, e, f = 0.5 * a, g = c - 2 * Math.atan(b), h = 0;
              15 >= h;
              h++
            )
              if (
                ((d = a * Math.sin(g)),
                (e = c - 2 * Math.atan(b * Math.pow((1 - d) / (1 + d), f)) - g),
                (g += e),
                Math.abs(e) <= 1e-10)
              )
                return g;
      ...
      17: [
        function(a, b) {
          var c = 1,
            ...
            h = 0.75,
            i = 0.46875,
            j = 0.013020833333333334,
            k = 0.007120768229166667,
            l = 0.3645833333333333,
            m = 0.005696614583333333,
            n = 0.3076171875;
          b.exports = function(a) {
            var b = [];
            (b[0] = c - a * (d + a * (e + a * (f + a * g)))),
              (b[1] = a * (h - a * (e + a * (f + a * g))));
            var o = a * a;
            return (
              (b[2] = o * (i - a * (j + a * k))),
        ...
        function(a, b) {
          ...
          b.exports = function(a, b, d) {
            var e = a * d,
              f = 0.5 * a;
            return (
              (e = Math.pow((1 - e) / (1 + e), f)), Math.tan(0.5 * (c - b)) / e
            );
          };
        },
        {}
          ...
          var c = Math.PI / 2,
            ...
            l = function(a) {
              ...
              if (((this.datum_type = g), a)) {
                ...
                (this.datum_type = a.grids ? f : this.datum_type),
                  (this.a = a.a),
                  (this.b = a.b),
                  (this.es = a.es),
                  (this.ep2 = a.ep2),
                  (this.datum_params = a.datum_params),
                  this.datum_type === f && (this.grids = a.grids);
              }
            };
          (l.prototype = {
            compare_datums: function(a) {
              return this.datum_type !== a.datum_type
                ...
                : this.datum_type === f || a.datum_type === f
            ...
            geocentric_to_geodetic: function(a) {
              ...
              if (
                ...
                if (((o = !0), (q = 0), d / this.a < t))
                  return (r = c), void (s = -this.b);
      ...
      30: [
        function(a, b) {
          ...
          b.exports = function(a, b, i) {
            ...
            return (
              b.datum_type === e && ((b.a = g), (b.es = h)),
              (a.es !== b.es || a.a !== b.a || j(r) || j(b.datum_type)) &&
                (a.geodetic_to_geocentric(i),
                j(a.datum_type) && a.geocentric_to_wgs84(i),
                j(b.datum_type) && b.geocentric_from_wgs84(i),
                b.geocentric_to_geodetic(i)),
              b.datum_type === e && this.apply_gridshift(b, 1, i),
              (a.a = n),
              (a.es = o),
              (b.a = p),
              (b.es = q),
      ...
      32: [
        function(a, b) {
          var c = a("./constants/Datum"),
            ...
            i = 0.04722222222222222,
            j = 0.022156084656084655;
          b.exports = function(a) {
        ...
        function(a, b) {
          ...
          b.exports = function(a) {
            ...
            for (f in e)
              (g = e[f]),
                f in i
                  ? ((h = i[f]), "function" == typeof h ? h(g) : (b[h] = g))
                  : (b[f] = g);
            return (
          ...
          (c.init = function() {
            ...
            (this.es = 1 - a * a),
              ...
              this.lat_ts
                ? (this.k0 = this.sphere
                    ? Math.cos(this.lat_ts)
                    : d(this.e, Math.sin(this.lat_ts), Math.cos(this.lat_ts)))
                : this.k0 || (this.k0 = this.k ? this.k : 1);
          }),
            (c.forward = function(a) {
              var b = a.x,
                c = a.y;
      ...
      64: [
        function(a, b) {
          ...
          b.exports = function k(a, b, l) {
            function m(a, b) {
              return (
                (a.datum.datum_type === e || a.datum.datum_type === f) &&
                "WGS84" !== b.datumCode
              );
            }
            var n;
            return (
              Array.isArray(l) && (l = j(l)),
              a.datum &&
                b.datum &&
                (m(a, b) || m(b, a)) &&
                ((n = new i("WGS84")), k(a, n, l), (a = n)),
              "enu" !== a.axis && h(a, !1, l),
              "longlat" === a.projName
                ? ((l.x *= c), (l.y *= c))
                : (a.to_meter && ((l.x *= a.to_meter), (l.y *= a.to_meter)),
                  a.inverse(l)),
              a.from_greenwich && (l.x += a.from_greenwich),
              (l = g(a.datum, b.datum, l)),
              b.from_greenwich && (l.x -= b.from_greenwich),
              "longlat" === b.projName
                ? ((l.x *= d), (l.y *= d))
                : (b.forward(l),
                  b.to_meter && ((l.x /= b.to_meter), (l.y /= b.to_meter))),
              "enu" !== b.axis && h(b, !0, l),
              l
            );
          };
        ...
        function(a, b) {
              ...
              ? ((e = a.shift()),
                ...
                1 === a.length
                  ...
                  ? "TOWGS84" === e
                    ? (b[e] = a)
                    : ((b[e] = {}),
                      ["UNIT", "PRIMEM", "VERT_DATUM"].indexOf(e) > -1
                        ? ((b[e] = { name: a[0].toLowerCase(), convert: a[1] }),
                          3 === a.length && (b[e].auth = a[2]))
                        : "SPHEROID" === e
                        ? ((b[e] = { name: a[0], a: a[1], rf: a[2] }),
                          4 === a.length && (b[e].auth = a[3]))
                        : [
                            "GEOGCS",
                            "GEOCCS",
                            "DATUM",
          ...
          function g(a) {
            ...
            "GEOGCS" === a.type
              ...
              a.GEOGCS &&
                ((a.datumCode = a.GEOGCS.DATUM
                  ? a.GEOGCS.DATUM.name.toLowerCase()
                  : a.GEOGCS.name.toLowerCase()),
            ...
            d.forEach(c),
              a.long0 ||
                !a.longc ||
                ("Albers_Conic_Equal_Area" !== a.PROJECTION &&
                  "Lambert_Azimuthal_Equal_Area" !== a.PROJECTION) ||
                (a.long0 = a.longc);
          }
