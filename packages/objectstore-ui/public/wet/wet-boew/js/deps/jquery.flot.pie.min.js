!(function(a) {
  function b(b) {
    ...
    function f(b) {
      for (
        var c = 0, d = 0, e = 0, f = t.series.pie.combine.color, g = [], h = 0;
        h < b.length;
        ++h
      ) {
        var i = b[h].data;
        a.isArray(i) && 1 == i.length && (i = i[0]),
          a.isArray(i)
            ? !isNaN(parseFloat(i[1])) && isFinite(i[1])
              ? (i[1] = +i[1])
              : (i[1] = 0)
            : (i = !isNaN(parseFloat(i)) && isFinite(i) ? [1, +i] : [1, 0]),
          (b[h].data = [i]);
      }
      for (var h = 0; h < b.length; ++h) c += b[h].data[0][1];
      for (var h = 0; h < b.length; ++h) {
        var i = b[h].data[0][1];
        i / c <= t.series.pie.combine.threshold &&
          ((d += i), e++, f || (f = b[h].color));
      }
      for (var h = 0; h < b.length; ++h) {
        var i = b[h].data[0][1];
        (2 > e || i / c > t.series.pie.combine.threshold) &&
          g.push(
            a.extend(b[h], {
              data: [[1, i]],
              color: b[h].color,
    ...
    function g(b, e) {
      ...
      function i() {
        function b(a, b, c) {
          0 >= a ||
            ...
            (c
              ? (y.fillStyle = b)
              : ((y.strokeStyle = b), (y.lineJoin = "round")),
            y.beginPath(),
        ...
        function c() {
          function b(b, c, d) {
            ...
            if (0 != t.series.pie.label.background.opacity) {
              ...
              a(
                ...
                .css("opacity", t.series.pie.label.background.opacity)
                .insertBefore(o);
            }
            return !0;
          }
          for (
            ...
            if (
              m[f].percent >= 100 * t.series.pie.label.threshold &&
              !b(m[f], c, f)
            )
              return !1;
            c += m[f].angle;
      ...
      if (s) {
        ...
        (y = e),
          ...
          (v = j / 2),
          "auto" == t.series.pie.offset.left
            ? (t.legend.position.match("w") ? (v += l / 2) : (v -= l / 2),
              u > v ? (v = u) : v > j - u && (v = j - u))
            : (v += t.series.pie.offset.left);
        var m = b.getData(),
          n = 0;
        do n > 0 && (u *= d), (n += 1), f(), t.series.pie.tilt <= 0.8 && g();
        while (!i() && c > n);
        n >= c &&
          (f(),
          s.prepend(
    ...
    function h(a) {
      if (t.series.pie.innerRadius > 0) {
        a.save();
        var b =
          t.series.pie.innerRadius > 1
            ? t.series.pie.innerRadius
            : u * t.series.pie.innerRadius;
    ...
    function j(a, c) {
      for (
        var d,
          ...
          g = b.getOptions(),
          h =
            g.series.pie.radius > 1
              ? g.series.pie.radius
              : u * g.series.pie.radius,
          j = 0;
        j < f.length;
        ++j
      ) {
        ...
        if (k.pie.show) {
          if (
            ...
            y.arc(
              ...
              0,
              h,
              k.startAngle + k.angle / 2,
              k.startAngle + k.angle,
              !1
            ),
            y.closePath(),
            (d = a - v),
    ...
    function n(a, c) {
      var d = p(a);
      -1 == d
        ? (z.push({ series: a, auto: c }), b.triggerRedrawOverlay())
        : c || (z[d].auto = !1);
    }
    function o(a) {
    ...
    function q(a, b) {
      function c(a) {
        a.angle <= 0 ||
          isNaN(a.angle) ||
          ((b.fillStyle =
            "rgba(255, 255, 255, " + d.series.pie.highlight.opacity + ")"),
          b.beginPath(),
      ...
      var d = a.getOptions(),
        e =
          d.series.pie.radius > 1
            ? d.series.pie.radius
            : u * d.series.pie.radius;
    ...
    b.hooks.processOptions.push(function(a, b) {
      b.series.pie.show &&
        ((b.grid.show = !1),
        "auto" == b.series.pie.label.show &&
          (b.legend.show
            ? (b.series.pie.label.show = !1)
            : (b.series.pie.label.show = !0)),
        "auto" == b.series.pie.radius &&
          (b.series.pie.label.show
            ? (b.series.pie.radius = 0.75)
            : (b.series.pie.radius = 1)),
        b.series.pie.tilt > 1
          ? (b.series.pie.tilt = 1)
          : b.series.pie.tilt < 0 && (b.series.pie.tilt = 0));
    }),
      b.hooks.bindEvents.push(function(a, b) {
        var c = a.getOptions();
        c.series.pie.show &&
          (c.grid.hoverable && b.unbind("mousemove").mousemove(k),
