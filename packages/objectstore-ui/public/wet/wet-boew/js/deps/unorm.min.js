!(function(a) {
  ...
  function b(a, b, c) {
    var d = w[b];
    return (
      d || ((d = a(b, c)), d.feature && ++x[(b >> 8) & 255] > l && (w[b] = d)),
      d
    );
  }
  function c(a, b, c) {
    var d = 65280 & b,
      e = v.udata[d] || {},
      f = e[b];
    return f ? new v(b, f) : new v(b, k);
  }
  function d(a, b, c) {
    return c ? a(b, c) : new v(b, null);
  }
  function e(a, b, c) {
    var d;
    if (n > b || (b >= n + q && m > b) || b > m + u) return a(b, c);
    if (b >= n && n + q > b) {
      var e = {},
        f = (b - n) * r;
      for (d = 0; r > d; ++d) e[o + d] = m + s * (d + f);
      return new v(b, [, , e]);
    }
    var g = b - m,
      h = g % s,
      i = [];
    if (0 !== h) i[0] = [m + g - h, p + h];
    else
      for (
        i[0] = [n + Math.floor(g / t), o + Math.floor((g % t) / s)],
          i[2] = {},
          d = 1;
        s > d;
        ++d
  ...
  function f(a, b, c) {
    return 60 > b || (b > 13311 && 42607 > b) ? new v(b, k) : a(b, c);
  }
  function g(a) {
    return F("NFD", a);
  }
  ...
  for (
    var k = [null, 0, {}],
      ...
      u = q * t,
      v = function(a, b) {
        (this.codepoint = a), (this.feature = b);
      },
      w = {},
      x = [],
      y = 0;
    ...
    x[y] = 0;
  var z = [f, b, d, e, c];
  (v.fromCharCode = z.reduceRight(function(a, b) {
    return function(c, d) {
      return b(a, c, d);
    };
  }, null)),
    (v.isHighSurrogate = function(a) {
      return a >= 55296 && 56319 >= a;
    }),
    (v.isLowSurrogate = function(a) {
      return a >= 56320 && 57343 >= a;
    }),
    (v.prototype.prepFeature = function() {
      this.feature ||
        (this.feature = v.fromCharCode(this.codepoint, !0).feature);
    }),
    (v.prototype.toString = function() {
      if (this.codepoint < 65536) return String.fromCharCode(this.codepoint);
      var a = this.codepoint - 65536;
      return String.fromCharCode(
        Math.floor(a / 1024) + 55296,
        (a % 1024) + 56320
      );
    }),
    (v.prototype.getDecomp = function() {
      return this.prepFeature(), this.feature[0] || null;
    }),
    (v.prototype.isCompatibility = function() {
      return this.prepFeature(), !!this.feature[1] && 256 & this.feature[1];
    }),
    (v.prototype.isExclude = function() {
      return this.prepFeature(), !!this.feature[1] && 512 & this.feature[1];
    }),
    (v.prototype.getCanonicalClass = function() {
      return this.prepFeature(), this.feature[1] ? 255 & this.feature[1] : 0;
    }),
    (v.prototype.getComposite = function(a) {
      if ((this.prepFeature(), !this.feature[2])) return null;
      var b = this.feature[2][a.codepoint];
      return b ? v.fromCharCode(b) : null;
    });
  var A = function(a) {
    (this.str = a), (this.cursor = 0);
  };
  A.prototype.next = function() {
    if (this.str && this.cursor < this.str.length) {
      var a,
        b = this.str.charCodeAt(this.cursor++);
      return (
        v.isHighSurrogate(b) &&
          this.cursor < this.str.length &&
          v.isLowSurrogate((a = this.str.charCodeAt(this.cursor))) &&
          ((b = 1024 * (b - 55296) + (a - 56320) + 65536), ++this.cursor),
        v.fromCharCode(b)
      );
    }
  ...
  var B = function(a, b) {
    (this.it = a), (this.canonical = b), (this.resBuf = []);
  };
  B.prototype.next = function() {
    function a(b, c) {
      var d = c.getDecomp();
      if (!d || (b && c.isCompatibility())) return [c];
      for (var e = [], f = 0; f < d.length; ++f) {
        var g = a(b, v.fromCharCode(d[f]));
        e = e.concat(g);
      }
      return e;
    }
  ...
  C.prototype.next = function() {
    ...
    if (0 === this.resBuf.length)
      do {
        ...
        var c = this.resBuf.length;
        if (0 !== a)
          for (; c > 0; --c) {
            var d = this.resBuf[c - 1],
              e = d.getCanonicalClass();
            if (a >= e) break;
          }
        this.resBuf.splice(c, 0, b);
      } while (0 !== a);
    return this.resBuf.shift();
  };
  var D = function(a) {
  ...
  D.prototype.next = function() {
    for (; 0 === this.resBuf.length; ) {
      ...
      if (0 === this.procBuf.length)
        (this.lastClass = a.getCanonicalClass()), this.procBuf.push(a);
      else {
        var b = this.procBuf[0],
          c = b.getComposite(a),
          d = a.getCanonicalClass();
        c && (this.lastClass < d || 0 === this.lastClass)
          ? (this.procBuf[0] = c)
          : (0 === d && ((this.resBuf = this.procBuf), (this.procBuf = [])),
            (this.lastClass = d),
            this.procBuf.push(a));
      }
    }
  ...
  var E = function(a, b) {
      switch (a) {
        case "NFD":
          return new C(new B(new A(b), !0));
        case "NFKD":
          return new C(new B(new A(b), !1));
        case "NFC":
          return new D(new C(new B(new A(b), !0)));
        case "NFKC":
          return new D(new C(new B(new A(b), !1)));
      }
      throw a + " is invalid";
    },
    F = function(a, b) {
      for (var c, d = E(a, b), e = ""; (c = d.next()); ) e += c.toString();
      return e;
    };
  v.udata = {
    0: {
  ...
  var G = { nfc: i, nfd: g, nfkc: j, nfkd: h };
  "object" == typeof module
    ...
    String.prototype.normalize ||
      ((String.prototype.normalize = function(a) {
        var b = "" + this;
        if (((a = void 0 === a ? "NFC" : a), "NFC" === a)) return G.nfc(b);
        if ("NFD" === a) return G.nfd(b);
        if ("NFKC" === a) return G.nfkc(b);
        if ("NFKD" === a) return G.nfkd(b);
        throw new RangeError("Invalid normalization form: " + a);
      }),
      (G.shimApplied = !0));
})(this);
