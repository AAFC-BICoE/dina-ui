...
!(function(a) {
  ...
  function e(b) {
    ...
    a.each(b, function(a, h) {
      (c = a.match(/^([^A-Z]+?)([A-Z])/)),
        c &&
          -1 !== f.indexOf(c[1] + " ") &&
          ((d = a.replace(c[0], c[2].toLowerCase())),
          (g[d] = a),
          "o" === c[1] && e(b[a]));
    }),
      (b._hungarianMap = g);
    ...
    a.each(c, function(e, i) {
      (h = b._hungarianMap[e]),
        h === d ||
          (!g && c[h] !== d) ||
          ("o" === h.charAt(0)
            ? (c[h] || (c[h] = {}), a.extend(!0, c[h], c[e]), f(b[h], c[h], g))
            : (c[h] = c[e]));
    });
  }
  function g(a) {
    ...
    !a.sEmptyTable &&
      ...
      Ha(a, a, "sZeroRecords", "sEmptyTable"),
      !a.sLoadingRecords &&
        c &&
  ...
  function j(c) {
    if (!Wa.__browser) {
      ...
      var e = a("<div/>")
          ...
          .append(
            a("<div/>")
              ...
              .append(a("<div/>").css({ width: "100%", height: 10 }))
          )
          .appendTo("body"),
        f = e.children(),
        g = f.children();
      (d.barWidth = f[0].offsetWidth - f[0].clientWidth),
        (d.bScrollOversize =
          100 === g[0].offsetWidth && 100 !== f[0].clientWidth),
  ...
  function m(b, c, e) {
    ...
    (g._bAttrSrc =
      a.isPlainObject(l) && (o(l.sort) || o(l.type) || o(l.filter))),
      (g._setter = null),
    ...
    g.bSortable && (p || q)
      ? p && !q
        ? ((g.sSortingClass = h.sSortableAsc),
          (g.sSortingClassJUI = h.sSortJUIAscAllowed))
        : !p && q
        ? ((g.sSortingClass = h.sSortableDesc),
          (g.sSortingClassJUI = h.sSortJUIDescAllowed))
  ...
  function u(b, c, e, f) {
    var g = b.aoData.length,
      h = a.extend(!0, {}, Wa.models.oRow, { src: e ? "dom" : "data", idx: g });
  ...
  function B(b) {
    ...
    if (
      "string" != typeof b ||
      (-1 === b.indexOf(".") && -1 === b.indexOf("[") && -1 === b.indexOf("("))
    )
      return function(a, c) {
        return a[b];
      };
        ...
        if (((h = l[n].match(ob)), (i = l[n].match(pb)), h)) {
          if (
            ...
            for (var p = 0, q = e.length; q > p; p++)
              (j = {}), c(j, e[p], k), b[l[n]].push(j);
          else b[l[n]] = e;
          return;
        }
        i && ((l[n] = l[n].replace(pb, "")), (b = b[l[n]](e))),
  ...
  function G(a, b, c, e) {
    ...
    if ("dom" !== c && ((c && "auto" !== c) || "dom" !== h.src)) {
      ...
      if (j)
        if (e !== d) i(j[e], e);
        else for (f = 0, g = j.length; g > f; f++) i(j[f], f);
      ...
      p = function(b) {
        if (e === d || e === l)
          if (((h = m[l]), (i = a.trim(b.innerHTML)), h && h._bAttrSrc)) {
            ...
            n
              ? (h._setter || (h._setter = C(h.mData)), h._setter(f, i))
              : (f[l] = i);
        l++;
      };
    if (k)
    ...
    if (null === l.nTr) {
      for (
        ...
        (i = b.aoColumns[j]),
          ...
          (h._DT_CellIndex = { row: d, column: j }),
          n.push(h),
          (e && !i.mRender && i.mData === j) ||
            (a.isPlainObject(i.mData) && i.mData._ === j + ".display") ||
            (h.innerHTML = y(b, d, j, "display")),
          i.sClass && (h.className += " " + i.sClass),
          i.bVisible && !e
            ? g.appendChild(h)
            : !i.bVisible && e && h.parentNode.removeChild(h),
          i.fnCreatedCell &&
            i.fnCreatedCell.call(b.oInstance, h, y(b, d, j), m, d, j);
    ...
    if (d) {
      ...
      if ((f && (d.id = f), e.DT_RowClass)) {
        ...
        (c.__rowc = c.__rowc ? mb(c.__rowc.concat(g)) : g),
          a(d)
            .removeClass(c.__rowc.join(" "))
            .addClass(e.DT_RowClass);
      }
  ...
  function K(b) {
    ...
    for (j && (f = a("<tr/>").appendTo(h)), c = 0, d = l.length; d > c; c++)
      (g = l[c]),
        ...
        j && e.appendTo(f),
        b.oFeatures.bSort &&
          (e.addClass(g.sSortingClass),
          g.bSortable !== !1 &&
            (e.attr("tabindex", b.iTabIndex).attr("aria-controls", b.sTableId),
            Aa(b, g.nTh, c))),
    ...
    if (
      ...
      a(h)
        .find(">tr>th, >tr>td")
        .addClass(k.sHeaderTH),
      a(i)
        .find(">tr>th, >tr>td")
        .addClass(k.sFooterTH),
      null !== i)
    ) {
      var m = b.aoFooter[0];
    ...
    if (c) {
      ...
      for (f = 0, g = o.length; g > f; f++) {
        ...
        for (h = 0, i = o[f].length; i > h; h++)
          if (((m = 1), (n = 1), p[f][h] === d)) {
            for (
              l.appendChild(o[f][h].cell), p[f][h] = 1;
              o[f + m] !== d && o[f][h].cell == o[f + m][h].cell;
  ...
  function M(b) {
    ...
    if (-1 !== a.inArray(!1, c)) return void na(b, !1);
    var e = [],
      f = 0,
      g = b.asStripeClasses,
      h = g.length,
    ...
    (b.bDrawing = !0),
      j !== d &&
        -1 !== j &&
        ((b._iDisplayStart = k ? j : j >= b.fnRecordsDisplay() ? 0 : j),
    ...
    if (0 !== l.length)
      ...
      1 == b.iDraw && "ajax" == Oa(b)
        ? (w = i.sLoadingRecords)
        : i.sEmptyTable && 0 === b.fnRecordsTotal() && (w = i.sEmptyTable),
        (e[0] = a("<tr/>", { class: h ? g[0] : "" }).append(
          a("<td />", {
            valign: "top",
            colSpan: q(b),
    ...
    La(b, "aoHeaderCallback", "header", [
      a(b.nTHead).children("tr")[0],
      D(b),
      m,
      n,
      l
    ]),
      La(b, "aoFooterCallback", "footer", [
        a(b.nTFoot).children("tr")[0],
        D(b),
        m,
        n,
        l
      ...
      for (d = o[f], k = 0, e = d.firstChild; e; ) {
        if (
          ...
          for (
            ...
            for (g = 0; m > g; g++)
              (b[f + g][j + h] = { cell: e, unique: n }), (b[f + g].nTr = d);
        e = e.nextSibling;
      }
  }
  function Q(a, b, c) {
  ...
  function R(b, c, d) {
    ...
    var l = {
      ...
      error: function(c, d, e) {
        ...
        -1 === a.inArray(!0, f) &&
          ("parsererror" == d
            ? Ga(b, 0, "Invalid JSON response", 1)
            : 4 === c.readyState && Ga(b, 0, "Ajax error", 7)),
          na(b, !1);
      }
    };
    (b.oAjaxData = c),
      ...
      b.fnServerData
        ...
        : b.sAjaxSource || "string" == typeof h
        ? (b.jqXHR = a.ajax(a.extend(l, { url: h || b.sAjaxSource })))
        : a.isFunction(h)
        ? (b.jqXHR = h.call(i, c, j, b))
        : ((b.jqXHR = a.ajax(a.extend(l, h))), (h.data = g));
  }
  function S(a) {
    ...
    i.bFilter && (p("sSearch", j.sSearch), p("bRegex", j.bRegex)),
      i.bSort &&
        (a.each(m, function(a, b) {
          q.order.push({ column: b.col, dir: b.dir }),
            p("iSortCol_" + a, b.col),
            p("sSortDir_" + a, b.dir);
        }),
  ...
  function V(b, c) {
    var e =
      a.isPlainObject(b.ajax) && b.ajax.dataSrc !== d
        ? b.ajax.dataSrc
        : b.sAjaxDataProp;
  ...
  function W(b) {
    ...
    var k = a("<div/>", {
      ...
      n = a("input", k)
        ...
        .on("keyup.DT search.DT input.DT paste.DT cut.DT", m ? ub(l, m) : l)
  ...
  function Y(b) {
    for (
      var c, d, e = Wa.ext.search, f = b.aiDisplay, g = 0, h = e.length;
      h > g;
      g++
    ) {
  ...
  function Z(a, b, c, d, e, f) {
    if ("" !== b) {
      for (
        var g, h = [], i = a.aiDisplay, j = _(b, d, e, f), k = 0;
        k < i.length;
        k++
      )
        (g = a.aoData[i[k]]._aFilterData[c]), j.test(g) && h.push(i[k]);
      a.aiDisplay = h;
    }
  }
  function $(a, b, c, d, e, f) {
    var g,
      ...
      l = a.aiDisplayMaster,
      m = [];
    if ((0 !== Wa.ext.search.length && (c = !0), (h = aa(a)), b.length <= 0))
      a.aiDisplay = l.slice();
    else {
      for (
        (h || c || k.length > b.length || 0 !== b.indexOf(k) || a.bSorted) &&
          (a.aiDisplay = l.slice()),
          g = a.aiDisplay,
          i = 0;
        i < g.length;
          ...
          (b = j[d]),
            b.bSearchable
              ? ((h = y(a, c, d, "filter")),
                ...
                null === h && (h = ""),
                "string" != typeof h && h.toString && (h = h.toString()))
              : (h = ""),
            h.indexOf &&
              -1 !== h.indexOf("&") &&
              ((rb.innerHTML = h), (h = sb ? rb.textContent : rb.innerText)),
  ...
  function da(b) {
    var c = b.sTableId,
      d = b.aanFeatures.i,
      e = a("<div/>", { class: b.oClasses.sInfo, id: d ? null : c + "_info" });
    return (
      d ||
        (b.aoDrawCallback.push({ fn: ea, sName: "information" }),
  ...
  function ga(a) {
    ...
    for (
      ...
      (d = f[b]), d.sWidth && (d.nTh.style.width = va(d.sWidth));
  ...
  function ja(b) {
    ...
    return (
      ...
      l
        .children()
        .append(b.oLanguage.sLengthMenu.replace("_MENU_", i[0].outerHTML)),
      a("select", l)
        .val(b._iDisplayLength)
        .on("change.DT", function(c) {
          ia(b, a(this).val()), M(b);
        }),
  ...
  function la(a, b, c) {
    ...
    0 === f || -1 === e
      ...
      : Ga(a, 0, "Unknown paging action: " + b, 5);
    var g = a._iDisplayStart !== d;
    return (
      (a._iDisplayStart = d), g && (La(a, null, "page", [a]), c && M(a)), g
    );
  }
  function ma(b) {
    return a("<div/>", {
      ...
      .html(b.oLanguage.sProcessing)
      .insertBefore(b.nTable)[0];
  }
  function na(b, c) {
    b.oFeatures.bProcessing &&
      a(b.aanFeatures.r).css("display", c ? "block" : "none"),
  ...
  function oa(b) {
    ...
    l.length || (l = null);
    var o = a(m, { class: g.sScrollWrapper })
      .append(
        a(m, { class: g.sScrollHead })
          .css({
            overflow: "hidden",
            position: "relative",
            border: 0,
          ...
          .append(
            a(m, { class: g.sScrollHeadInner })
              .css({ "box-sizing": "content-box", width: d.sXInner || "100%" })
              .append(
                j
                  .removeAttr("id")
                  .css("margin-left", 0)
      ...
      .append(
        a(m, { class: g.sScrollBody })
          .css({ position: "relative", overflow: "auto", width: n(e) })
          .append(c)
      );
    l &&
      o.append(
        a(m, { class: g.sScrollFoot })
          .css({ overflow: "hidden", border: 0, width: e ? n(e) : "100%" })
          .append(
            a(m, { class: g.sScrollFootInner }).append(
              k
                .removeAttr("id")
                .css("margin-left", 0)
    ...
    return (
      ...
      (b.nScrollBody = r),
      (b.nScrollFoot = s),
      b.aoDrawCallback.push({ fn: pa, sName: "scrolling" }),
      o[0]
    );
  }
  function pa(b) {
    ...
    (b.scrollBarVis = S),
      ...
      I &&
        ((i = I.clone().prependTo(F)), (e = I.find("tr")), (g = i.find("tr"))),
      ...
      "" === p
        ? ((H.width = "100%"),
          K &&
            (F.find("tbody").height() > y.offsetHeight ||
              "scroll" == z.css("overflow-y")) &&
            (H.width = va(F.outerWidth() - s)),
          (l = F.outerWidth()))
        : "" !== q && ((H.width = va(q)), (l = F.outerWidth())),
      qa(R, f),
      qa(function(b) {
      ...
      F.outerWidth() < l
        ? ((k =
            y.scrollHeight > y.offsetHeight || "scroll" == z.css("overflow-y")
              ? l + s
              : l),
          K &&
            (y.scrollHeight > y.offsetHeight ||
              "scroll" == z.css("overflow-y")) &&
            (H.width = va(k - s)),
          ("" === p || "" !== q) && Ga(b, 1, "Possible column misalignment", 6))
        : (k = "100%"),
      (A.width = va(k)),
      (u.width = va(k)),
  ...
  function qa(a, b, c) {
    for (var d, e, f = 0, g = 0, h = b.length; h > g; ) {
      for (d = b[g].firstChild, e = c ? c[g].firstChild : null; d; )
        1 === d.nodeType && (c ? a(d, e, f) : a(d, f), f++),
          (d = d.nextSibling),
  ...
  function ra(c) {
    ...
    for (y && -1 !== y.indexOf("%") && (t = y), d = 0; d < p.length; d++)
      (e = h[p[d]]),
        null !== e.sWidth && ((e.sWidth = sa(e.sWidthOrig, u)), (v = !0));
    if (x || (!v && !k && !j && m == q(c) && m == s.length))
      ...
      k && l
        ...
        ? (A.css("width", "auto"),
          A.removeAttr("width"),
          A.width() < u.clientWidth && t && A.width(u.clientWidth))
        : j
        ? A.width(u.clientWidth)
        : t && A.width(t);
      var D = 0;
      for (d = 0; d < p.length; d++) {
        var E = a(s[d]),
          ...
          G = w.bBounding
            ? Math.ceil(s[d].getBoundingClientRect().width)
            : E.outerWidth();
  ...
  function xa(a) {
    var b,
      ...
      j = (a.aoColumns, 0),
      k = a.aiDisplayMaster;
    for (s(a), f = wa(a), b = 0, c = f.length; c > b; b++)
      (e = f[b]), e.formatter && j++, Ca(a, e.col);
  ...
  function za(b, c, e, f) {
    var g,
      ...
      k = function(b, c) {
        var e = b._idx;
        return (
          e === d && (e = a.inArray(b[1], j)),
          e + 1 < j.length ? e + 1 : c ? null : 0
        );
      };
    if (
      ("number" == typeof i[0] && (i = b.aaSorting = [i]),
      ...
      -1 !== l
        ? ((g = k(i[l], !0)),
          ...
          null === g ? i.splice(l, 1) : ((i[l][1] = j[g]), (i[l]._idx = g)))
        : (i.push([c, j[0], 0]), (i[i.length - 1]._idx = 0));
  ...
  function Ca(a, b) {
    ...
    for (
      var f,
        g,
        h = Wa.ext.type.order[d.sType + "-pre"],
        i = 0,
        j = a.aoData.length;
      j > i;
      i++
    ...
    if (b.oFeatures.bStateSave && !b.bDestroying) {
      var c = {
        ...
        columns: a.map(b.aoColumns, function(a, c) {
          return { visible: a.bVisible, search: ba(b.aoPreSearchCols[c]) };
        })
      };
    ...
    var f,
      ...
      i = function(c) {
        ...
        if (
          ...
          for (f = 0, g = c.columns.length; g > f; f++) {
            var l = c.columns[f];
  ...
  function Ia(b, c, d) {
    ...
    for (var f in c)
      c.hasOwnProperty(f) &&
        ((e = c[f]),
        a.isPlainObject(e)
          ? (a.isPlainObject(b[f]) || (b[f] = {}), a.extend(!0, b[f], e))
          : d && "data" !== f && "aaData" !== f && a.isArray(e)
          ? (b[f] = e.slice())
          : (b[f] = e));
    return b;
  }
  ...
  function La(b, c, d, e) {
    ...
    if (
      (c &&
        (f = a.map(b[c].slice().reverse(), function(a, c) {
  ...
  function Pa(a, b) {
    ...
    return (
      d >= b
        ? (c = jb(0, b))
        : e >= a
        ? ((c = jb(0, d - 2)), c.push("ellipsis"), c.push(b - 1))
        : a >= b - 1 - e
        ? ((c = jb(b - (d - 2), b)),
  ...
  function Ra(a) {
    return function() {
      var b = [Fa(this[Wa.ext.iApiIndex])].concat(
  ...
  var Sa,
    ...
    Wa = function(b) {
      (this.$ = function(a, b) {
        ...
        (this.fnAddData = function(b, c) {
          var e = this.api(!0),
            f =
              a.isArray(b) && (a.isArray(b[0]) || a.isPlainObject(b[0]))
                ? e.rows.add(b)
                : e.row.add(b);
        ...
        (this.fnDeleteRow = function(a, b, c) {
          var e = this.api(!0),
            ...
            h = g.aoData[f[0][0]];
          return (
            f.remove(), b && b.call(this, g, h), (c === d || c) && e.draw(), h
          );
        }),
      ...
      return (
        this.each(function() {
          ...
          for (q = 0, n = y.length; n > q; q++) {
            ...
            if (
              z.nTable == this ||
              z.nTHead.parentNode == this ||
              (z.nTFoot && z.nTFoot.parentNode == this)
            ) {
          ...
          (null === r || "" === r) &&
            ((r = "DataTables_Table_" + Wa.ext._unique++), (this.id = r));
          ...
          (D.nTable = this),
            ...
            p.aLengthMenu &&
              !p.iDisplayLength &&
              (p.iDisplayLength = a.isArray(p.aLengthMenu[0])
                ? p.aLengthMenu[0][0]
                : p.aLengthMenu[0]),
            (p = Ia(a.extend(!0, {}, w), p)),
            Ha(D.oFeatures, p, [
          ...
          if (
            (p.bJQueryUI
              ? (a.extend(E, Wa.ext.oJUIClasses, p.oClasses),
                p.sDom === w.sDom &&
                  "lfrtip" === w.sDom &&
                  (D.sDom = '<"H"lfr>t<"F"ip>'),
                D.renderer
                  ? a.isPlainObject(D.renderer) &&
                    !D.renderer.header &&
                    (D.renderer.header = "jqueryui")
                  : (D.renderer = "jqueryui"))
              : a.extend(E, Wa.ext.classes, p.oClasses),
            x.addClass(E.sTable),
            D.iInitDisplayStart === d &&
              ((D.iInitDisplayStart = p.iDisplayStart),
          ...
          a.extend(!0, G, p.oLanguage),
            G.sUrl &&
              ...
              (s = !0)),
            null === p.asStripeClasses &&
              (D.asStripeClasses = [E.sStripeOdd, E.sStripeEven]);
          ...
          if (
            (0 !== L.length && (P(D.aoHeader, L[0]), (K = Q(D))),
            null === p.aoColumns)
          )
          ...
          if (
            (t(D, p.aoColumnDefs, J, function(a, b) {
              m(D, a, b);
            }),
            I.length)
          ) {
            ...
            O = function() {
              ...
              if (
                (0 === g.length &&
                  ...
                  (g = a("<tfoot/>").appendTo(x)),
                0 === g.length || 0 === g.children().length
                  ? x.addClass(E.sNoFooter)
                  : g.length > 0 &&
                    ((D.nTFoot = g[0]), P(D.aoFooter, D.nTFoot)),
                p.aaData)
              )
                for (q = 0; q < p.aaData.length; q++) u(D, p.aaData[q]);
              else
                (D.bDeferLoading || "dom" == Oa(D)) &&
                  v(D, a(D.nTBody).children("tr"));
    ...
    hb = function(a, b, c) {
      var e = [],
        f = 0,
        g = a.length;
      if (c !== d) for (; g > f; f++) a[f] && a[f][b] && e.push(a[f][b][c]);
      else for (; g > f; f++) a[f] && e.push(a[f][b]);
      return e;
    },
    ib = function(a, b, c, e) {
      var f = [],
        g = 0,
        h = b.length;
      if (e !== d) for (; h > g; g++) a[b[g]][c] && f.push(a[b[g]][c][e]);
      else for (; h > g; g++) f.push(a[b[g]][c]);
      return f;
    },
    jb = function(a, b) {
      var c,
  ...
  var nb = function(a, b, c) {
    ...
    xb = function(b) {
      ...
      return b
        ? b.nTable && b.oApi
          ? [b]
          : b.nodeName && "table" === b.nodeName.toLowerCase()
          ? ((c = a.inArray(b, f)), -1 !== c ? [e[c]] : null)
          : b && "function" == typeof b.settings
          ? b.settings().toArray()
  ...
  (Ta = function(b, c) {
    ...
    if (a.isArray(b)) for (var f = 0, g = b.length; g > f; f++) e(b[f]);
    else e(b);
    (this.context = mb(d)),
      c && a.merge(this, c),
          ...
          if ("table" === b) (f = c.call(q, o[g], g)), f !== d && n.push(f);
            ...
            for (
              ...
              (m = l[i]),
                (f =
                  "cell" === b
                    ? c.call(q, o[g], m.row, m.column, g, i)
                    : c.call(q, o[g], m, g, i, k)),
                f !== d && n.push(f);
        }
        if (n.length || e) {
    ...
    (Ta.register = Ua = function(b, c) {
      if (a.isArray(b))
        for (var d = 0, e = b.length; e > d; d++) Ta.register(b[d], c);
      else {
        var f,
          g,
          h,
        ...
        for (f = 0, g = j.length; g > f; f++) {
          ...
          var m = l(k, h);
          m ||
            ((m = { name: h, val: {}, methodExt: [], propExt: [] }), k.push(m)),
  ...
  var Ab = function(b, c, e, f, g) {
      var h,
        ...
        o = typeof c;
      for (
        (c && "string" !== o && "function" !== o && c.length !== d) ||
          (c = [c]),
          j = 0,
          k = c.length;
        k > j;
      ...
      var p = Sa.selector[b];
      if (p.length) for (j = 0, k = p.length; k > j; j++) n = p[j](f, g, n);
      return mb(n);
    },
    Bb = function(b) {
      return (
        ...
        a.extend({ search: "none", order: "current", page: "all" }, b)
      );
    },
    Cb = function(a) {
    ...
    Eb = function(b, c, e) {
      var f,
        g = function(c) {
          ...
          if ((f || (f = Db(b, e)), null !== g && -1 !== a.inArray(g, f)))
            return [g];
  ...
  Ua("rows()", function(b, c) {
    ...
    Ua("row().data()", function(a) {
      ...
      return a === d
        ? b.length && this.length
          ...
          : d
        : ((b[0].aoData[this[0]]._aData = a), G(b[0], this[0], "data"), this);
    }),
    ...
    Ua("row.add()", function(b) {
      ...
      var c = this.iterator("table", function(a) {
        return b.nodeName && "TR" === b.nodeName.toUpperCase()
          ? v(a, b)[0]
          : u(a, b);
      });
      return this.row(c[0]);
  ...
  var Fb = function(b, c, d, e) {
    ...
    Gb = function(a, b) {
      ...
      if (c.length) {
        ...
        e &&
          e._details &&
          (e._details.remove(), (e._detailsShow = d), (e._details = d));
      }
    },
    Hb = function(a, b) {
      var c = a.context;
          ...
          b.on(e, function(b, c, d, e) {
            if (a === c)
              for (var f, h = q(c), i = 0, j = g.length; j > i; i++)
                (f = g[i]),
                  f._details &&
                    f._details.children("td[colspan]").attr("colspan", h);
          }),
          b.on(f, function(c, d) {
            if (a === d)
  ...
  Ua(Lb, function(a, b) {
    ...
    return a === d
      ...
      : (a === !0
          ...
          : a === !1
          ? Gb(this)
          : c.length && this.length && Fb(c[0], c[0].aoData[this[0]], a, b),
        this);
  }),
    ...
    var f,
      ...
      r = function(c) {
          ...
          for (g = [], h = 0, i = n.length; i > h; h++)
            for (f = n[h], j = 0; q > j; j++)
              (k = { row: f, column: j }),
                e
                  ? ((l = m[f]),
                    c(k, y(b, f, j), l.anCells ? l.anCells[j] : null) &&
                      g.push(k))
                  : g.push(k);
          return g;
        }
        ...
        var o = p
          ...
          .toArray();
        return o.length || !c.nodeName
          ? o
          : ((l = a(c).closest("*[data-dt-row]")),
            l.length
  ...
  Ua("cells()", function(b, c, e) {
    ...
    (Wa.isDataTable = Wa.fnIsDataTable = function(b) {
      var c = a(b).get(0),
        d = !1;
      return b instanceof Wa.Api
        ? !0
        : (a.each(Wa.settings, function(b, e) {
      ...
      return (
        ...
        this.iterator("table", function(d) {
          ...
          (d.bDestroying = !0),
            ...
            d.bJUI &&
              (a(
                "th span." + g.sSortIcon + ", td span." + g.sSortIcon,
                j
              ).detach(),
          ...
          l[p](),
            ...
            !c &&
              f &&
              (f.insertBefore(h, d.nTableReinsertBefore),
  ...
  a.extend(Rb, {
    ...
    a.extend(Wa.ext.type.detect, [
      ...
      function(a, b) {
        return bb(a) || ("string" == typeof a && -1 !== a.indexOf("<"))
          ? "html"
          : null;
      }
    ]),
      ...
      header: {
        _: function(b, c, d, e) {
          a(b.nTable).on("order.dt.DT", function(a, f, g, h) {
            if (b === f) {
              var i = d.idx;
              c.removeClass(
                d.sSortingClass + " " + e.sSortAsc + " " + e.sSortDesc
              ).addClass(
                "asc" == h[i]
                  ? e.sSortAsc
                  : "desc" == h[i]
        ...
        jqueryui: function(b, c, d, e) {
          a("<div/>")
            ...
            .append(c.contents())
            .append(
              a("<span/>").addClass(e.sSortIcon + " " + d.sSortingClassJUI)
            )
            .appendTo(c),
            a(b.nTable).on("order.dt.DT", function(a, f, g, h) {
              if (b === f) {
                var i = d.idx;
                c
                  .removeClass(e.sSortAsc + " " + e.sSortDesc)
                  .addClass(
                    "asc" == h[i]
                      ? e.sSortAsc
                      : "desc" == h[i]
