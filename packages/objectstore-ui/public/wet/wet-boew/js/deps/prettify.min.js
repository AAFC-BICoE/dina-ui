...
!(function() {
  function a(a) {
    ...
    function d(a) {
      ...
      for (var h = 0; h < m.length; ++h) {
        var o = m[h];
        g.push(c(o[0])),
          o[1] > o[0] && (o[1] + 1 > o[0] && g.push("-"), g.push(c(o[1])));
      }
  ...
  function d(a) {
    for (var b = void 0, c = a.firstChild; c; c = c.nextSibling) {
      var d = c.nodeType;
      b = 1 === d ? (b ? a : c) : 3 === d && Q.test(c.nodeValue) ? a : b;
    }
    return b === a ? void 0 : b;
  }
  function e(b, d) {
    ...
    !(function() {
      for (
        var c = b.concat(d), g = [], h = {}, i = 0, j = c.length;
        j > i;
        ++i
      ) {
        var k = c[i],
      ...
      h = function(a) {
        for (
          ...
          if (((m += s.length), r)) {
            ...
            var B = t.substring(5);
            c(k, i + x, s.substring(0, z), h, l),
              c(k, i + x + z, y, j(B, y), l),
              c(k, i + x + A, s.substring(A), h, l);
          } else l.push(i + x, t);
        }
        a.decorations = l;
      };
  ...
  function g(a, b, c) {
    ...
    for (var m = Math.max(0, (b - 1) | 0) || 0, k = 0, n = j.length; n > k; ++k)
      (i = j[k]),
  ...
  function i(a, b) {
    for (var c = b.length; --c >= 0; ) {
      var d = b[c];
      S.hasOwnProperty(d)
        ? n.console && console.warn("cannot override language handler %s", d)
        : (S[d] = a);
    }
  }
  function j(a, b) {
    return (
      (a && S.hasOwnProperty(a)) ||
  ...
  function k(a) {
    ...
    try {
      ...
      n.console && console.log((f && f.stack) || f);
    }
  }
  function l(a, b, c) {
    var d = c || !1,
  ...
  function m(a, b) {
    ...
    function e() {
      for (
        var b = n.PR_SHOULD_USE_CONTINUATION ? p.now() + 250 : 1 / 0;
        q < j.length && p.now() < b;
        q++
      ) {
        for (var c = j[q], f = x, i = c; (i = i.previousSibling); ) {
          var l = i.nodeType,
            m = (7 === l || 8 === l) && i.nodeValue;
          if (m ? !/^\??prettify\b/.test(m) : 3 !== l || /\S/.test(i.nodeValue))
            break;
          if (m) {
            (f = {}),
              m.replace(/\b(\w+)=([\w:.%+-]+)/g, function(a, b, c) {
                f[b] = c;
              });
            break;
          }
            ...
            if (u.test(c.tagName)) D = 1;
              ...
              var E = c.currentStyle,
                ...
                G = E
                  ...
                  ? F.getComputedStyle(c, null).getPropertyValue("white-space")
                  : 0;
              D = G && "pre" === G.substring(0, 3);
            }
            var H = f.linenums;
            (H = "true" === H || +H) ||
              ((H = o.match(/\blinenums\b(?::(\d+))?/)),
      ...
      q < j.length ? n.setTimeout(e, 250) : "function" == typeof a && a();
    }
    for (
      var f = b || document.body,
        h = f.ownerDocument || document,
        i = [c("pre"), c("code"), c("xmp")],
        j = [],
        l = 0;
      l < i.length;
      ++l
    )
      for (var m = 0, o = i[l].length; o > m; ++m) j.push(i[l][m]);
    i = null;
    var p = Date;
    p.now ||
      (p = {
  ...
  var n = window,
    o = ["break,continue,do,else,for,if,return,while"],
    p = [
      o,
    ...
    z = [o, "case,done,elif,esac,eval,fi,function,in,local,set,then,until"],
    A = [r, t, s, v, w, x, y, z],
    B = /^(DIR|FILE|array|vector|(de|priority_)?queue|(forward_)?list|stack|(const_)?(reverse_)?iterator|(unordered_)?(multi)?(set|map)|bitset|u?(int|float)\d*)\b/,
    C = "str",
    D = "kwd",
    E = "com",
    F = "typ",
  ...
  i(R, ["default-code"]),
    ...
    i(e([], [[N, /^[\s\S]+/]]), ["uq.val"]),
    i(f({ keywords: r, hashComments: !0, cStyleComments: !0, types: B }), [
      "c",
      "cc",
      "cpp",
      "cxx",
    ...
    i(f({ keywords: "null,true,false" }), ["json"]),
    i(
      f({
        keywords: t,
        hashComments: !0,
    ...
    i(f({ keywords: s, cStyleComments: !0 }), ["java"]),
    i(f({ keywords: z, hashComments: !0, multiLineStrings: !0 }), [
      "bash",
      "bsh",
      "csh",
      "sh"
    ...
    i(f({ keywords: v, cStyleComments: !0, regexLiterals: !0 }), [
      "javascript",
      "js",
      "ts",
      "typescript"
  ...
  "function" == typeof U &&
    U.amd &&
    U("google-code-prettify", [], function() {
      return T;
    });
})();
