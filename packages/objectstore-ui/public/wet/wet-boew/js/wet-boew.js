...
(window.Modernizr = (function(e, t, n) {
        ...
        for (var r = 0, i, s, u, a = e.length; r < a; r++)
          l.setAttribute("type", (s = e[r])),
            ...
            i &&
              ...
              /^range$/.test(s) && l.style.WebkitAppearance !== n
                ? (o.appendChild(l),
                  (u = t.defaultView),
                  (i =
                    u.getComputedStyle &&
                    u.getComputedStyle(l, null).WebkitAppearance !==
                      "textfield" &&
                    l.offsetHeight !== 0),
                  o.removeChild(l))
                : /^(search|tel)$/.test(s) ||
                  (/^(url|email)$/.test(s)
                    ? (i = l.checkValidity && l.checkValidity() === !1)
                    : (i = l.value != c))),
            (b[e[r]] = !!i);
        return b;
      })(
  ...
  var r = "2.8.3",
    ...
    N = function(t) {
      ...
      var r;
      return (
        T("@media " + t + " { #" + u + " { position: absolute; } }", function(
          t
        ) {
          r =
  ...
  !O(C, "undefined") && !O(C.call, "undefined")
    ...
    (y.fontface = function() {
      var e;
      return (
        T('@font-face {font-family:"font";src:url("https://")}', function(
          n,
          r
        ) {
  ...
  for (var B in y)
    k(y, B) &&
      ((x = B.toLowerCase()), (i[x] = y[B]()), E.push((i[x] ? "" : "no-") + x));
  return (
    i.input || H(),
    (i.addTest = function(e, t) {
      if (typeof e == "object") for (var r in e) k(e, r) && i.addTest(r, e[r]);
      else {
        e = e.toLowerCase();
        if (i[e] !== n) return i;
  ...
  Modernizr.addTest("mathml", function() {
    ...
    if (document.createElementNS) {
      var t = "http://www.w3.org/1998/Math/MathML",
        n = document.createElement("div");
      n.style.position = "absolute";
      var r = n
        .appendChild(document.createElementNS(t, "math"))
        .appendChild(document.createElementNS(t, "mfrac"));
      r
        .appendChild(document.createElementNS(t, "mi"))
        .appendChild(document.createTextNode("xx")),
        r
          .appendChild(document.createElementNS(t, "mi"))
          .appendChild(document.createTextNode("yy")),
        document.body.appendChild(n),
        (e = n.offsetHeight > n.offsetWidth);
    }
    return e;
  }),
  Modernizr.addTest(
...
(function($, window, document, undef) {
  ...
  var getUrlParts = function(url) {
      ...
      return {
        ...
        params: (function() {
          var results = {},
            queryString = encodeURI(decodeURI(a.search.replace(/^\?/, "")))
              .replace(/'/g, "%27")
              .split("&"),
  ...
  yepnope.addPrefix("i18n", function(resourceObj) {
    resourceObj.url =
      paths.js + "/" + resourceObj.url + lang + paths.mode + ".js";
    return resourceObj;
  });
  ...
  Modernizr.load = function(options) {
    var i, i_len, i_cache, testReady, complete;
    if (!$.isArray(options)) {
      options = [options];
    }
    ...
    },
    {
      ...
      complete: function() {
        ...
        if (!Modernizr.mathml) {
          ...
          $document.one(
            "timerpoke.wb wb-init." + componentName,
            selector,
            function() {
              ...
              Modernizr.load([
                {
                  load:
                    "timeout=500!https://cdn.jsdelivr.net/npm/mathjax@2.7.1/MathJax.js?config=Accessible",
                  complete: function() {
                    Modernizr.load([
                      {
...
(function(wb) {
  ...
  wb.formattedNumCompare = function(a, b) {
    ...
    for (i = 0; i !== len; i += 1) {
      result =
        parseInt(aNumbers[i], 10) * aMultiple -
        parseInt(bNumbers[i], 10) * bMultiple;
      if (result !== 0) {
        break;
      }
    }
  ...
  wb.date = {
    ...
    compare: function(dateValue1, dateValue2) {
      ...
      if (
        isFinite((dateValue1 = convert(dateValue1).valueOf())) &&
        isFinite((dateValue2 = convert(dateValue2).valueOf()))
      ) {
...
(function($, wb) {
  ...
  $document.on("ajax-fetch.wb", function(event) {
    ...
    var caller = event.element || event.target,
      ...
      fetchNoCacheKey =
        fetchOpts.nocachekey || wb.cacheBustKey || "wbCacheBust";
    ...
    if (caller === event.target || event.currentTarget === event.target) {
      ...
      $.ajax(fetchOpts)
        .done(function(response, status, xhr) {
          ...
          fetchData.pointer = $(
            "<div id='" + wb.getId() + "' data-type='" + responseType + "' />"
...
(function($, window, wb) {
  ...
  var componentName = "wb-calevt",
    ...
    init = function(event) {
      ...
      if (elm) {
        ...
        // Load ajax content
        $.when
          .apply($, $.map($elm.find("[data-calevt]"), getAjax))
          .always(function() {
            processEvents($elm);
    ...
    getEvents = function(obj) {
      ...
      for (i = 0; i !== iLen; i += 1) {
        ...
        if (tCollection.length !== 0) {
          ...
          strDate1 =
            tCollectionTemp.nodeName.toLowerCase() === "time"
              ? tCollectionTemp
                  .getAttribute("datetime")
                  .substr(0, 10)
                  .split("-")
              : tCollectionTemp.className
                  .match(dateTimeRegExp)[1]
                  .substr(0, 10)
                  .split("-");
  ...
  $document.on("keydown", ".wb-calevt-cal .cal-days td > ul li", function(
    event
  ) {
...
(function($, window, document, wb, undef) {
  var i18nText,
    ...
    init = function() {
      ...
      $calBase = $(
        "<div class='wb-clndr' role='application'>" +
          "<div class='cal-nav'>" +
          ...
          (function() {
            ...
            for (m = 0; m < 12; m += 1) {
              months +=
                "<option value='" + m + "'>" + textMonthNames[m] + "</option>";
            }
      ...
      for (week = 1; week < 7; week += 1) {
        ...
        for (day = 0; day < 7; day += 1) {
          if ((week === 1 && day < firstDay) || dayCount > lastDay) {
            ...
            isCurrentDate =
              dayCount === currDay && month === currMonth && year === currYear;
            className =
              "cal-index-" + dayCount + (isCurrentDate ? " cal-curr-day " : "");
            ...
            printDate =
              displayDate(date) +
              (isCurrentDate
                ? "<span class='wb-inv'>" + textCurrentDay + "</span>"
                : "");
    ...
    displayDate = function(date) {
      ...
      return i18nText.format.replace(/\{ddd\}|\{d\}|\{M\}|\{Y\}/g, function(
        match
      ) {
        switch (match) {
          case "{ddd}":
...
(function($, window, document, wb) {
  ...
  var componentName = "wb-charts",
    ...
    createCharts = function($elm) {
              ...
              fn: {
                "/series/pie/label/formatter": function(label, series) {
                  ...
                  if (!optionsCharts.decimal) {
                    ...
                    textlabel = Math.round(
                      series.percent * Math.pow(10, optionsCharts.decimal)
                    );
            ...
            defaults: {
              ...
              fn: {
                "/getcellvalue": function(elem) {
                  ...
                  var cellValue = $.trim(
                    elem.dataset.wbChartsValue || $(elem).text()
                  );
                  return [
                    parseFloat(
                      cellValue.replace(
      ...
      function applyPreset(baseline, $elem, attribute) {
        var config = $.extend(true, {}, baseline.defaults || baseline),
          fn = $.extend(
            true,
            {},
            (baseline.defaults && baseline.defaults.fn) || {}
          ),
        ...
        if (tokens.length) {
          ...
          for (i = 0, iLength = tblTokens.length; i !== iLength; i += 1) {
            ...
            if (
              ...
              token.slice(0, prefixLength) !== prefix
            ) {
              continue;
            }
       ...
       */
      function getColumnGroupHeaderCalculateSteps(
        colGroupHead,
        referenceValuePosition
      ) {
        ...
        for (i = 0, iLen = colRefValue.cell.length; i !== iLen; i += 1) {
          ...
          if (
            i === 0 ||
            (i > 0 && colCurent.cell[i - 1].uid !== headerCell.uid)
          ) {
            ...
            if (headerCell.type === 1 || headerCell.type === 7) {
              if (headerCell.child.length !== 0) {
                calcStep =
                  calcStep * groupHeaderCalculateStepsRecursive(headerCell, 1);
              }
            }
          }
        }
       ...
       */
      function getRowGroupHeaderCalculateSteps(
        rowGroupHead,
        referenceValuePosition,
        dataColgroupStart
      ) {
        ...
        for (i = 0, iLen = rowRefValueCells.length; i !== iLen; i += 1) {
          ...
          if (
            headerCell.colpos >= dataColgroupStart &&
            (headerCell.type === 1 || headerCell.type === 7)
          ) {
            if (headerCell.child.length !== 0) {
              calcStep =
                calcStep *
                headerCell.child.length *
                groupHeaderCalculateStepsRecursive(headerCell, 1);
            }
          }
        }
      ...
      function groupHeaderCalculateStepsRecursive(headerCell, refValue) {
        ...
        for (kIndex = 0; kIndex !== childLength; kIndex += 1) {
          ...
          if (headerCellChild.child.length !== 0) {
            calcStep =
              calcStep *
              groupHeaderCalculateStepsRecursive(headerCellChild, subRefValue);
          }
        }
        return calcStep;
      }
      ...
      function setInnerStepValues(
        ...
        for (i = 0, iLength = vectorHead.cell.length; i !== iLength; i += 1) {
          ...
          if (
            (i !== 0 && headerCell.uid === vectorHead.cell[i - 1].uid) ||
            (dataColgroupStart && headerCell.colpos < dataColgroupStart)
          ) {
            continue;
          }
          ...
          if (headerCell.type === 1 || headerCell.type === 7) {
            ...
            if (headerCell.child.length > 0) {
              setInnerStepValuesChildRecursive(
                headerCell,
                headerLevel,
                stepsValue,
                referenceValue
       ...
       * @param {number} referenceValue - Reference Value Vector ID
       */
      function setInnerStepValuesChildRecursive(
        headerCell,
        headerLevel,
        stepsValue,
        referenceValue
        ...
        for (i = 0, iLength = headerCell.child.length; i !== iLength; i += 1) {
          ...
          if (headerLevel < referenceValue) {
            currentHeaderCellChild.flotDelta =
              flotDelta * currentHeaderCellChild.child.length;
          } else {
      ...
      function setUpperStepValues(vectorHead, referenceValue) {
        ...
        for (i = referenceValue - 1; i !== -1; i -= 1) {
          ...
          for (
            k = 0, kLen = currentVectorHead.cell.length;
            k !== kLen;
            k += 1
          ) {
            ...
            if (
              currentCell.flotDelta ||
              (k > 0 && currentCell.uid === currentVectorHead.cell[k - 1].uid)
            ) {
              continue;
            }
      ...
      function getLabels(labelVector, dataColgroupStart) {
        ...
        for (i = 0, iLen = labelVector.cell.length; i !== iLen; i += 1) {
          ...
          if (
            (i !== 0 && currentCell.uid === labelVector.cell[i - 1].uid) ||
      ...
      function getlabelsVectorPosition(arrVectorHeaders) {
        ...
        return (
          (!labelPosition ||
          (labelPosition && labelPosition > arrVectorHeaders.length)
            ? parsedData.theadRowStack.length
            : labelPosition) - 1
        );
      }
      ...
      function verticalLabels(parsedData) {
        ...
        if (
          !reverseTblParsing ||
          (reverseTblParsing && optionsCharts.referencevalue === false)
        ) {
        ...
        stepsValue = getColumnGroupHeaderCalculateSteps(
          parsedData.colgrouphead,
          columnReferenceValue
        );
        ...
        if (!reverseTblParsing) {
          ...
          labelsVectorPosition = getlabelsVectorPosition(
            parsedData.colgrouphead.col
          );
        }
        ...
        setInnerStepValues(
          parsedData.colgrouphead.col[columnReferenceValue],
          headerlevel,
          stepsValue,
          columnReferenceValue
        );
      ...
      function horizontalLabels(parsedData) {
        ...
        for (
          i = 0, iLength = parsedData.colgroup.length;
          i !== iLength;
          i += 1
        ) {
        ...
        stepsValue = getRowGroupHeaderCalculateSteps(
          theadRowStack,
          rowReferenceValue,
          dataColgroupStart
        );
        ...
        // Get the labelling
        return getLabels(
          theadRowStack[labelsVectorPosition],
          dataColgroupStart
        );
      }
      ...
      function wrapTableIntoDetails() {
        ...
        $summary = $(
          "<summary>" + captionHtml + i18nText.tableMention + "</summary>"
        );
        $elm.wrap("<details/>").before($summary);

        $summary.trigger("wb-init.wb-details");
      }

      function createContainer(withDimension) {
        $elm.wrap("<figure class='" + optionsCharts.graphclass + "'/>").before(
      ...
      if (optionFlot.series && optionFlot.series.pie) {
        ...
        for (rIndex; rIndex >= 0; rIndex -= 1) {
          ...
          for (i = 0, iLength = dataGroupVector.length; i !== iLength; i += 1) {
            ...
            // For each cells
            for (
              j = 0, jLength = currentDataGroupVector.cell.length;
              j !== jLength;
              j += 1
            ) {
              ...
              if (
                (!reverseTblParsing &&
                  (dataCell.row.type !== 2 ||
                    (previousDataCell &&
                      previousDataCell.rowgroup.uid !==
                        dataCell.rowgroup.uid))) ||
                (reverseTblParsing && dataCell.col.type !== 2) ||
                  (previousDataCell &&
                    previousDataCell.col.type !== 1 &&
                    previousDataCell.col.groupstruct.uid !==
                      dataCell.col.groupstruct.uid)
              ) {
                break;
              }
              ...
              cellValue = optionsCharts.getcellvalue(
                !reverseTblParsing
            ...
            // Apply any preset
            pieQuaterFlotSeries = applyPreset(
              defaultsOptions.series,
              $(header.elem),
              "flot"
            );
            ...
            pieQuaterFlotSeries.label = !reverseTblParsing
              ? $(
                  currentDataGroupVector.dataheader[
                    currentDataGroupVector.dataheader.length - 1
                  ].elem
                ).text()
              : $(
                  currentDataGroupVector.header[
                    currentDataGroupVector.header.length - 1
                  ].elem
                ).text();
        ...
        if (!optionsCharts.legendinline) {
          ...
          $(".legend > table", $wetChartContainer)
            .removeAttr("style")
            .addClass("font-small");
      ...
      for (i = 0, iLength = dataGroupVector.length; i !== iLength; i += 1) {
        ...
        if (
          currVectorOptions.bars ||
          (optionFlot.bars && !currVectorOptions.lines)
        ) {
      ...
      for (i = 0, iLength = dataGroupVector.length; i !== iLength; i += 1) {
        ...
        currVectorOptions =
          currDataVector.header[currDataVector.header.length - 1].chartOption;

        // For each cells
        for (
          j = 0, jLength = currDataVector.cell.length;
          j !== jLength;
          j += 1
        ) {
          ...
          if (
            (!reverseTblParsing && dataCell.col.groupstruct.type === 2) ||
        ...
        currVectorOptions.label = $(
          currDataVector.header[currDataVector.header.length - 1].elem
        ).text();

        if (currVectorOptions.bars) {
          // Adjust the bars width
          currVectorOptions.bars.barWidth =
            currVectorOptions.bars.barWidth * (1 / nbBarChart);
        }
  ...
  // Bind the init event of the plugin
  $document.on(
    "timerpoke.wb " + initEvent + " " + tableParsingCompleteEvent,
    selector,
    function(event) {
      var eventType = event.type,
        elm = event.target;
...
(function($, window, wb) {
  ...
  if (Modernizr.details) {
    ...
    $document.on(
      "click keydown toggle." + componentName,
      selector + " summary",
      function(event) {
...
(function($, window, wb) {
  ...
  var componentName = "wb-data-ajax",
    ...
    ajaxTypes = ["before", "replace", "after", "append", "prepend"],
    ...
    ajax = function(event, ajxInfo) {
      ...
      if (
        ...
        if (
          (wb.pageUrlParts.protocol !== urlParts.protocol ||
            wb.pageUrlParts.host !== urlParts.host) &&
          (!Modernizr.cors || settings.forceCorsFallback)
        ) {
    ...
    getURL = function(url, referer) {
      var refers, httpRef, regHttpRef, i, i_len;
    ...
    ajxFetched = function(elm, fetchObj) {
      ...
      if (content && content.length > 0) {
        ...
        $elm.trigger(contentUpdatedEvent, {
          "ajax-type": ajaxType,
          content: content
        });
      }
  ...
  $document.on(
    "timerpoke.wb " + initEvent + " " + updateEvent + " ajax-fetched.wb",
    selector,
    function(event) {
      var eventTarget = event.target;
...
(function($, window, wb) {
  ...
  var componentName = "wb-inview",
    ...
    onInView = function($elm) {
      ...
      if ($elm.hasClass("wb-dismissable")) {
        if ($dataInView.hasClass("wb-overlay")) {
          $dataInView
            ...
            .on("click vclick", function(event) {
              var which = event.which;
      ...
      if (viewState !== oldViewState) {
        ...
        show =
          inView ||
          ($elm.hasClass("show-none") ? false : viewState === "partial");
  ...
  // Bind the init event of the plugin
  $document.on(
    "timerpoke.wb " + initEvent + " " + scrollEvent,
    selector,
    function(event) {
      var eventTarget = event.target,
...
(function($, window, wb) {
  ...
  // Bind the init event of the plugin
  $document.on(
    "timerpoke.wb " + initEvent + " " + picturefillEvent,
    selector,
    function(event) {
      var eventTarget = event.target,
        eventType = event.type;
...
(function($, window, wb) {
    ...
    onResize = function() {
      ...
      for (i = $elms.length - 1; i !== -1; i -= 1) {
        ...
        for (j = $children.length - 1; j !== -1; j -= 1) {
          ...
          if (
            childCSS.length > 0 &&
            childCSS.substr(childCSS.length - 1) !== cssPropertySeparator
          ) {
  ...
  $document.on(
    "txt-rsz.wb win-rsz-width.wb win-rsz-height.wb " +
      contentUpdatedEvent +
      " wb-updated.wb-tables wb-update" +
      selector,
    onResize
  );
  ...
  var componentName = "wb-facebook",
    ...
    init = function(event) {
      ...
      if (ele) {
        Modernizr.load({
          load: [
            (protocol.indexOf("http") === -1 ? "http:" : protocol) +
...
(function($, window, wb) {
  ...
  var componentName = "wb-favicon",
    ...
    mobile = function(favicon, event, data) {
      ...
      if (faviconMobile.hasClass(componentName)) {
        faviconPath =
          data.path !== null
            ? data.path
            : getPath(favicon.getAttribute("href"));
    ...
    icon = function(favicon, event, data) {
      var faviconPath =
        data.path !== null ? data.path : getPath(favicon.getAttribute("href"));
...
(function($, window, wb, undef) {
    ...
    Templates = {
      ...
      flickr: function(data) {
        ...
        return (
          ...
          wb.escapeAttribute(JSON.stringify(flickrData)) +
          "'><img src='" +
          flickrData.thumbnail +
          "' alt='" +
          wb.escapeAttribute(flickrData.title) +
          "' title='" +
          wb.escapeAttribute(flickrData.title) +
      ...
      youtube: function(data) {
        ...
        return (
          ...
          wb.escapeAttribute(JSON.stringify(youtubeDate)) +
          "'><a href='javascript:;'><img src='" +
          wb.pageUrlParts.protocol +
          "//img.youtube.com/vi/" +
          youtubeDate.videoId +
          "/mqdefault.jpg' alt='" +
          wb.escapeAttribute(youtubeDate.title) +
          "' title='" +
          wb.escapeAttribute(youtubeDate.title) +
          "' class='img-responsive' /></a></li>"
        );
      ...
      pinterest: function(data) {
        var content = fromCharCode(data.description).replace(
          /<a href="\/pin[^"]*"><img ([^>]*)><\/a>([^<]*)(<a .*)?/,
          "<a href='" +
            data.link +
      ...
      if (elm) {
        ...
        for (i = last; i !== -1; i -= 1) {
          ...
          if (fElem.attr("data-ajax")) {
            ...
            $content.data(componentName + "-postProcess", [
              ".wb-lbx",
              ".wb-mltmd"
            ]);
      ...
      for (i = 0; i !== len; i += 1) {
        ...
        if (items[i].publishedDate === undef) {
          items[i].publishedDate =
            items[i].published || items[i].pubDate || items[i].updated || "";
        }
    ...
    parseEntries = function(entries, limit, $elm, feedtype) {
      ...
      if ($details.length !== 0) {
        if ($details.attr("role") === "tabpanel") {
          ...
          activate = false;
          $elm.empty().addClass("waiting");
          $details.children("summary").on("click.wb-feeds", function(event) {
  ...
  $document.on(
    "ajax-fetched.wb data-ready.wb-feeds",
    selector + " " + feedLinkSelector,
          ...
          case "ajax-fetched":
            ...
            if (response.documentElement) {
              ...
              data = response.responseData
                ...
                : response.items || response.feed.entry;
            }
            break;
          default:
  ...
  $document.on("click", selector + " .feed-youtube", function(event) {
    ...
    if ($youTubeOverlay.length === 0) {
      $youTubeOverlay = $(
        "<section id='wb-feeds-youtube-lbx' class='mfp-hide modal-dialog modal-content overlay-def'>" +
...
(function($, window, wb) {
  ...
  var componentName = "wb-filter",
    ...
    init = function(event) {
      ...
      if (elm) {
        ...
        Modernizr.load({
          ...
          nope: ["site!deps/unorm" + wb.getMode() + ".js"]
        });
        ...
        totalEntries = $elm.find(
          (settings.section || "") + " " + settings.selector
        ).length;
        ...
        filterUI =
          ...
          elm.id +
          '-info">' +
          infoFormater(totalEntries, totalEntries) +
          "</p>";
    ...
    infoFormater = function(nbItem, total) {
      return infoText.replace(/_NBITEM_/g, nbItem).replace(/_TOTAL_/g, total);
    },
    /*
    ...
    filter = function($field, $elm, settings) {
      var unAccent = function(str) {
        ...
        $item,
        text,
        searchFilterRegularExp;

      $elm.find("." + filterClass).removeClass(filterClass);

      searchFilterRegularExp = buildSearchFilterRegularExp(
        settings.filterType,
        filter
      );
  ...
  var componentName = "wb-fnote",
    ...
    init = function(event) {
      ...
      if (elm) {
        ...
        $document.on(
          "click vclick",
          "main :not(" + selector + ") sup a.fn-lnk",
          function(event) {
            var eventTarget = event.target,
              which = event.which,
              refId,
            ...
            if (!which || which === 1) {
              refId =
                "#" +
                wb.jqEscape(eventTarget.getAttribute("href").substring(1));
        ...
        $document.on("click vclick", selector + " dd p.fn-rtn a", function(
          event
        ) {
          var which = event.which,
            ref,
          ...
          complete: function() {
            ...
            validator = $form.validate({
              ...
              errorPlacement: function($error, $element) {
                ...
                if (
                  ...
                  $error.insertBefore(
                    $form.find("input[name='" + $element.attr("name") + "']")
                  );
                  return;
                }

                $error.appendTo(
                  $form.find("label[for='" + $element.attr("id") + "']")
                );
                return;
              },
              ...
              showErrors: function(errorMap) {
                ...
                var $errors = $form
                    ...
                    .filter(":not(:hidden)"),
                  $errorfields = $form.find(
                    "input.error, select.error, textarea.error"
                  ),
                  prefixStart =
                    "<span class='prefix'>" + i18nText.error + "&#160;",
                ...
                if ($errors.length !== 0) {
                  ...
                  summary =
                    ...
                    summaryHeading +
                    "><ul>";
                  $errorfields.closest(".form-group").addClass("has-error");
                  len = $errors.length;
                  for (i = 0; i !== len; i += 1) {
                    $error = $errors.eq(i);
                    ...
                    if ($errors[i].classList.contains("wb-server-error")) {
                      if ($errors[i].id) {
                        var myParent = document.getElementById($errors[i].id)
                          .parentElement;
                        if (myParent === null) {
                          summary +=
                            "<li><a>" +
                            prefix +
                            ($fieldName.length !== 0
                              ? $fieldName.html() + separator
                              : "") +
                            $error.text() +
                            separator +
                            i18nText.errorCorrect +
                            "</a></li>";
                        } else {
                          if (
                            myParent.hasAttribute("for") &&
                            myParent.getAttribute("for").length > 0
                          ) {
                            summary +=
                              "<li><a href='#" +
                              myParent.getAttribute("for") +
                              "'>" +
                              prefix +
                              ($fieldName.length !== 0
                                ? $fieldName.html() + separator
                            ...
                            if (
                              myParent.getElementsByTagName("input")[0] &&
                              myParent.getElementsByTagName("input")[0].name
                                .length > 0
                            ) {
                              summary +=
                                "<li><a href='#" +
                                myParent.getElementsByTagName("input")[0].id +
                                "'>" +
                                prefix +
                                ($fieldName.length !== 0
                                  ? $fieldName.html() + separator
                              ...
                              if (
                                myParent.tagName === "LEGEND" &&
                                (myParent.parentElement.getElementsByTagName(
                                  "input"
                                )[0].type === "checkbox" ||
                                  (myParent.parentElement.getElementsByTagName(
                                    "input"
                        ...
                        $error.html(
                          "<strong>" + prefix + $error.text() + "</strong>"
                        );
                      }
                    } else {
                      summary +=
                        "<li><a href='#" +
                        $error.data("element-id") +
                        "'>" +
                        prefix +
                        ($fieldName.length !== 0
                          ? $fieldName.html() + separator
            ...
            $form
              ...
              .each(function() {
                if (
                  this.attributes.for &&
                  this.attributes.for.value.length > 0
                ) {
                  $("form")
                    .validate()
                    .element($("[id =" + this.attributes.for.value + "]"));
                } else if ($(this).find("input")[0]) {
                  $("form")
                    .validate()
                    .element($(this).find("input")[0]);
                } else if (
                  $(this)
                    .next(".radio, .checkbox")
                    .children("label")
      ...
      if (elm) {
        ...
        $document.one(dependenciesLoadedEvent, function() {
          ...
          if (firstLink) {
            ...
            $elm.magnificPopup(settings).data("wbLbxFilter", settings.filter);
          }
        ...
        callbacks = {
          open: function() {
            ...
            for (i = 0; i !== len; i += 1) {
              button = $buttons[i];
              button.innerHTML +=
                "<span class='wb-inv'> " + button.title + "</span>";
            }
            ...
            $wrap
              .append("<span tabindex='0' class='lbx-end wb-inv'></span>")
              .find(".activate-open")
              .trigger("wb-activate");
          ...
          parseAjax: function(mfpResponse) {
            ...
            if (selector) {
              $response = $("<div>" + mfpResponse.data + "</div>").find(
                selector
              );
            } else {
    ...
    createCloseButton = function($modal) {
      if ($modal !== null && $modal.hasClass("modal-dialog")) {
        var footer = $modal.find(".modal-footer").first(),
          ...
          hasButton =
            hasFooter && $(footer).find(".popup-modal-dismiss").length !== 0,
  ...
  $document.on("click vclick", ".mfp-wrap a[href^='#']", function(event) {
    ...
    if (!which || which === 1) {
      ...
      linkTarget = document.getElementById(
        eventTarget.getAttribute("href").substring(1)
      );
...
(function($, window, document, wb) {
  ...
  var componentName = "wb-menu",
    ...
    init = function(event) {
      ...
      if (elm) {
        ...
        if (ajaxFetch) {
          ...
          ajaxFetch =
            $elm.data("ajax-replace") ||
            $elm.data("ajax-append") ||
            $elm.data("ajax-prepend");
          if (!ajaxFetch) {
     ...
     * @return {string}
     */
    createCollapsibleSection = function(
      section,
      sectionIndex,
      sectionsLength,
      $items,
      ...
      var k,
        ...
        sectionHtml =
          "<li><details>" +
          "<summary class='mb-item" +
          ($section.hasClass("wb-navcurr") ||
          $section.children(".wb-navcurr").length !== 0
            ? " wb-navcurr'"
            : "'") +
          menuitem +
          sectionsLength +
      ...
      for (k = 0; k !== itemsLength; k += 1) {
        ...
        if (elm && subItemsLength === 0 && elm.nodeName.toLowerCase() === "a") {
          ...
          sectionHtml += createCollapsibleSection(
            elm,
            k,
            itemsLength,
            $subItems,
        ...
        for (j = 0; j !== sectionsLength; j += 1) {
          ...
          if (itemsLength !== 0) {
            ...
            if (parent.nodeName.toLowerCase() === "li") {
              ...
              section.getElementsByTagName("a")[0]
            ) {
    ...
    onAjaxLoaded = function($elm, $ajaxResult) {
      var $info = $("#wb-info"),
        inner = function() {
          var $ajaxed =
              $ajaxResult && $ajaxResult.attr("data-type") === "string"
                ? $ajaxResult
                : $elm,
          ...
          if ($language.length !== 0) {
            ...
            for (i = 0; i !== len; i += 1) {
              panel += $langItems[i].innerHTML.replace(
                /(<a\s.*<\/a>?)/,
                "<li>$1</li>"
              );
            }
          ...
          panelDOM.innerHTML =
            ...
            document.getElementById("wb-glb-mn").getElementsByTagName("h2")[0]
              .innerHTML +
            "</div></header><div class='modal-body'>" +
            panel +
            "</div>";
          panelDOM.className +=
            " wb-overlay modal-content overlay-def wb-panel-r";
           ...
           */
          $ajaxed.find(":discoverable").attr("tabindex", "-1");
  ...
  $document.on(
    "timerpoke.wb " + initEvent + " ajax-fetched.wb ajax-failed.wb",
    selector,
    function(event) {
      var eventType = event.type,
        elm,
  ...
  $document.on(
    "touchstart click",
    selector + " .item[aria-haspopup=true]",
    function(event) {
  ...
  $document.on(
    "click",
    selector + " [role=menu] [aria-haspopup=true]",
    function(event) {
      ...
      if (!isOpen) {
        ...
        if (
          $.contains(menuContainer, menuItem) &&
    ...
    if (!(event.ctrlKey || event.altKey || event.metaKey)) {
      ...
      if (which === TAB_KC) {
        ...
        if (which === UP_KC || which === DOWN_KC) {
          ...
          hasPopup &&
          (which === ENTER_KC || which === SPACE_KC || which === RIGHT_KC)
        ) {
          $parent = $menuItem.parent();
          ...
          if ($parentMenu.attr("role") === "menubar") {
            ...
            if ($parentMenu.length !== 0) {
              ...
              event.preventDefault();
              $menuItem.trigger("click").trigger("setfocus.wb");
            }
          }
...
(function($, window, wb, undef) {
  ...
  var componentName = "wb-mltmd",
            ...
            try {
              ...
              if (
                ...
                for (i = 0; i < i_len; i++) {
                  ...
                  if (
                    i_cache.dataset.L2 &&
                    i_cache.contentWindow === e.source
                  ) {
      ...
      if (time !== undef) {
        if (time.charAt(time.length - 1) === "s") {
          ...
          for (i = 0, partLength = parts.length; i < partLength; i += 1) {
            timeStringPortion =
              i === 0 ? parseFloat(parts[i]) : parseInt(parts[i], 10);
      ...
      for (i = 0; i !== len; i += 1) {
        ...
        if (captionElement.attr("data-begin") !== undef) {
          begin = parseTime(captionElement.attr("data-begin"));
            ...
            captionElement.attr("data-end") !== undef
          ...
          if (args) {
            ...
            try {
              ...
              this.object.setOption("captions", "track", {
                languageCode: this.object.getOption("captions", "tracklist")[0]
                  .languageCode
              });
            }
          } else {
    ...
    youTubeEvents = function(event) {
      ...
      switch (event.data) {
        case null:
          $media.trigger("canplay").trigger("durationchange");
          break;
        case -1:
          event.target.unMute();
        ...
        case 1:
          if (media.dataset.L2) {
            ...
            youTubeApi.call(
              $mltmPlayerElm.get(0),
              "setCaptionsVisible",
              $mltmPlayerElm.hasClass(captionClass)
            );
          }
          $media
            .trigger("canplay")
    ...
    onResize = function() {
      $(
        selector + " object, " + selector + " iframe, " + selector + " video"
      ).trigger(resizeEvent);
    };
  ...
  $document.on("ajax-fetched.wb " + templateLoadedEvent, selector, function(
    event
  ) {
    var $this = $(this);
  ...
  $document.on(initializedEvent, selector, function(event) {
    if (event.namespace === componentName) {
      var $this = $(this),
        ...
        captions =
          $media.children("track[kind='captions']").attr("src") || undef,
        id = $this.attr("id"),
        ...
        height =
          type === "video" ? $media.attr("height") || $media.height() : 0,
  ...
  $document.on(renderUIEvent, selector, function(event, type, data) {
    if (event.namespace === componentName) {
      ...
      $media.after(tmpl(template, data)).wrap('<div class="display"></div>');

      $eventReceiver = $media.is("object")
        ? $media.children(":first-child")
        : $media;
      ...
      // Load the captions
      if (
        currentUrl.absolute.replace(currentUrl.hash || "#", "") !==
        captionsUrl.absolute.replace(captionsUrl.hash || "#", "")
      ) {
        loadCaptionsExternal($media, captionsUrl.absolute);
      } else {
        loadCaptionsInternal(
          $media,
          $("#" + wb.jqEscape(captionsUrl.hash.substring(1)))
        );
      }
    }
  });
  ...
  $document.on("click", selector, function(event) {
    ...
    if (
      className.match(/playpause|-play|-pause|display/) ||
      $target.is("object") ||
      $target.is("video")
    ) {
      ...
      $target.hasClass("progress-bar")
    ) {
      this.player(
        "setCurrentTime",
        this.player("getDuration") *
          ((event.pageX - $target.offset().left) / $target.width())
      );
    } else if (className.match(/\brewind\b|-backward/)) {
      this.player(
        "setCurrentTime",
        this.player("getCurrentTime") - this.player("getDuration") * 0.05
      );
  ...
  $document.on("keydown", dispCtrls, function(event) {
    ...
    if (!(event.ctrlKey || event.altKey || event.metaKey)) {
      switch (which) {
        ...
        case 37:
          playerTarget.player(
            ...
            this.parentNode.player("getCurrentTime") -
              this.parentNode.player("getDuration") * 0.05
          );
          break;
        ...
        case 38:
          volume =
            Math.round(playerTarget.player("getVolume") * 100) / 100 + step;
      ...
      case "timeupdate":
        ...
        $this
          ...
          .attr(
            "value",
            Math.round(
              (currentTime / eventTarget.player("getDuration")) * 1000
            ) / 10
          )
          .trigger("wb-update.wb-progress");

        $this
          .find(".wb-mm-tmln-crrnt span:nth-child(2)")
          .text(formatTime(currentTime));

        if (
          $this.hasClass(captionClass) &&
          $.data(eventTarget, "captions") !== undef
        ) {
          updateCaptions(
            $this.find(".wb-mm-cc"),
            currentTime,
      ...
      case "ccloadfail":
        if (eventNamespace === componentName) {
          $this
            .find(".wb-mm-cc")
            .append(
              "<p class='errmsg'><span>" + i18nText.cc_error + "</span></p>"
            )
            .end()
            .find(".cc")
            .attr("disabled", "");
      ...
      if ($(event.currentTarget).hasClass("video")) {
        if (media.videoWidth === 0 || media.videoWidth === undef) {
          ...
          newHeight = Math.round(
            $media.width() * (!isNaN(ratio) ? ratio : 0.5625)
          );
      ...
      if (event.namespace === "wb") {
        ...
        var menu = wb.init(event.target, componentName, selector),
          ...
          pageUrl =
            ...
            windowLocation.pathname.replace(/^([^\/])/, "/$1"),
          ...
          localBreadcrumbQuery,
          localBreadcrumbLinkUrl;
        ...
        if (menu) {
          ...
          if (!match && breadcrumb) {
            ...
            if (!breadcrumbLinksArray) {
              ...
              localBreadcrumbLinksArray = [];
              localBreadcrumbLinksUrlArray = [];
              localBreadcrumbLinks = (breadcrumb.jquery
                ? breadcrumb[0]
                : breadcrumb
              ...
              if (len) {
                ...
                if (linkHref && linkHref.charAt(0) !== "#") {
                  ...
                  localBreadcrumbLinksUrlArray.push(
                    child.hostname + child.pathname.replace(/^([^\/])/, "/$1")
                  );
                }
              }
            ...
            for (j = localBreadcrumbLinksArray.length - 1; j !== -1; j -= 1) {
              ...
              for (i = 0; i !== len; i += 1) {
                ...
                if (
                  localBreadcrumbLinkUrl.slice(-linkUrl.length) === linkUrl &&
                  (linkQueryLen === 0 ||
                    localBreadcrumbQuery.slice(-linkQueryLen) === linkQuery)
                ) {
                  match = true;
                  break;
                }
          ...
          if (match) {
            ...
            if (
              menu.className.indexOf("wb-menu") !== -1 &&
              link.className.indexOf("item") === -1
            ) {
              $(link)
                .closest(".sm")
                .parent()
  ...
  var componentName = "wb-overlay",
    ...
    init = function(event) {
      ...
      if (elm) {
        ...
        var isPanel =
            $elm.attr("class").indexOf("wb-panel") > -1 ? true : false,
        ...
        if (isPanel || isPopup) {
          ...
          var hasFooter = footer && footer.length !== 0 ? true : false,
            ...
            closeClassFtr =
              ($elm.hasClass("wb-panel-l") ? "pull-right " : "pull-left ") +
              closeClass,
            closeTextFtr = i18nText.close,
    ...
    openOverlay = function(overlayId, noFocus) {
      ...
      if (
        $overlay.hasClass("wb-popup-full") ||
        $overlay.hasClass("wb-popup-mid")
      ) {
        $overlay.attr(
          "data-pgtitle",
          document.getElementsByTagName("H1")[0].textContent
      ...
      if (!noFocus) {
        $overlay.scrollTop(0).trigger(setFocusEvent);
      }
          ...
          switch (which) {
            ...
            case 9:
              ...
              if (overlay.className.indexOf(ignoreOutsideClass) === -1) {
                ...
                index =
                  $focusable.index(event.target) + (event.shiftKey ? -1 : 1);

                if (index === -1 || index === length) {
                  event.preventDefault();
                  $focusable
                    .eq(index === -1 ? length - 1 : 0)
                    .trigger(setFocusEvent);
                }
              }
              break;
...
(function($, window, document, wb) {
  ...
  var componentName = "wb-rsz",
    ...
    $document = wb.doc,
    sizes = [],
    events = ["txt-rsz.wb", "win-rsz-width.wb", "win-rsz-height.wb"],
    ...
    viewChange = function(viewportWidth) {
      ...
      if (viewName !== currentView) {
        ...
        wb.html.removeClass(currentView || "").addClass(viewName);
  ...
  var $modal,
    ...
    defaults = {
      ...
      refreshCallback: function(response) {
        /* callback function used to check the server response */
    ...
    initModalDialog = function(callback) {
      ...
      if ($document.find(modalID).length === 0) {
        ...
        temp.innerHTML =
          ...
          "<section id='" +
          componentName +
          "-modal' class='mfp-hide modal-dialog modal-content overlay-def'>" +
          "<header class='modal-header'><h2 class='modal-title'>" +
          i18nText.timeoutTitle +
          "</h2></header>" +
    ...
    initRefreshOnClick = function($elm, settings) {
      if (settings.refreshOnClick) {
        $document.on("click", function(event) {
          ...
          if (
            (!className || className.indexOf(confirmClass) === -1) &&
            ...
            if (
              !lastActivity ||
              currentTime - lastActivity > settings.refreshLimit
            ) {
              $elm
    ...
    confirm = function(event) {
      ...
      if (
        ...
        getCurrentTime() - settings.start <= settings.reactionTime
      ) {
        $(selector)
          .trigger(resetEvent, settings)
          .trigger(keepaliveEvent, settings);
  ...
  var componentName = "wb-share",
    ...
    defaults = {
      ...
      sites: {
        ...
        gmail: {
          name: "Gmail",
          url:
            "https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=&su={t}&body={u}%0A{d}"
        },
        linkedin: {
          name: "LinkedIn®",
          url:
            "https://www.linkedin.com/shareArticle?mini=true&amp;url={u}&amp;title={t}&amp;ro=false&amp;summary={d}&amp;source="
        },
        myspace: {
          name: "MySpace",
        ...
        pinterest: {
          name: "Pinterest",
          url:
            "https://www.pinterest.com/pin/create/button/?url={u}&amp;media={i}&amp;description={t}"
        },
        reddit: {
          name: "reddit",
    ...
    init = function(event) {
      ...
      if (elm) {
        ...
        shareText =
          i18nText.shareText +
          (settings.custType.length !== 0
            ? settings.custType
            : i18nText[settings.type]);
        pnlId = settings.pnlId;
        id = "shr-pg" + (pnlId.length !== 0 ? "-" + pnlId : panelCount);
        pageHref = encodeURIComponent(settings.url);

        regex = /\'|&#39;|&apos;/g;
        pageTitle = encodeURIComponent(settings.title).replace(regex, "%27");
        pageImage = encodeURIComponent(settings.img);
        pageDescription = encodeURIComponent(settings.desc).replace(
          regex,
          "%27"
        );
        ...
        if (elm.className.indexOf("link-only") === -1) {
          ...
          keys.sort(function(x, y) {
            return wb
              .normalizeDiacritics(x)
              .localeCompare(wb.normalizeDiacritics(y));
          });
          len = keys.length;
...
(function($, window, wb) {
  ...
  $document.on("draw.dt", selector, function(event, settings) {
    ...
    if (
      paginate_buttons.length === 1 ||
      (pagination.find(".previous, .next").length === 2 &&
        paginate_buttons.length < 4)
    ) {
  ...
  $document.on("submit", ".wb-tables-filter", function(event) {
    ...
    $form.find("[name]").each(function() {
      ...
      if ($elm.is("select")) {
        ...
        if ($elm.is(":checked")) {
          var $aoptsSelector =
              '[data-aopts*=\'"column": "' + $column + "\"']:checked",
            $aopts = $($aoptsSelector),
            $aoType =
              $aopts && $aopts.data("aopts")
                ? $aopts.data("aopts").type.toLowerCase()
                : "";
...
(function($, window, wb) {
  ...
  var componentName = "wb-tabs",
    ...
    init = function(event) {
      ...
      if (elm) {
          ...
          if (!openByHash) {
            ...
            if (hashTargetLen !== 0) {
              ...
              if (!settings.ignoreSession) {
                activeId = sessionStorage.getItem(
                  pagePath + elmId + activePanel
                );
              }
            }
        ...
        // Determine the current view
        isSmallView =
          document.documentElement.className.indexOf(smallViewPattern) !== -1;
        ...
        if (!isCarousel) {
          ...
          for (i = 0; i !== len; i += 1) {
            ...
            if (isSmallView) {
              ...
              $panel.addClass(
                (Modernizr.details ? "" : open + " ") +
                  "fade " +
                  (isOpen ? "in" : "noheight out wb-inv")
              );
            }
          ...
          $panels
            ...
            .removeClass("in");
          $openPanel.addClass("in").removeClass("out noheight");
    ...
    createControls = function($tablist, settings) {
      var prevText = i18nText.prev,
        ...
        btnEnd = "</span></a></li> ",
        iconState =
          glyphiconStart + (isPlaying ? "pause" : "play") + "'></span>",
        ...
        tabCount =
          ...
          i18nTabCount
            .substring(firstReplaceIndex, lastReplaceIndex)
            .replace(
              "%curr%",
              "<span class='curr-index'>" + currentIndex + "</span>"
            )
    ...
    updateNodes = function($panels, $controls, $next, $control) {
      ...
      $controls.find(".curr-index").html(newIndex);
    ...
    onShift = function(event, $elm) {
      var data = $elm.data(componentName),
        $panels = data.panels,
        len = $panels.length,
        current = $elm.find("> .tabpanels > .in").prevAll("[role=tabpanel]")
          .length,
        autoCycle = !event.shiftto,
        next = current > len ? 0 : current + (autoCycle ? 1 : event.shiftto);

      onSelect(
        $panels[next > len - 1 ? 0 : next < 0 ? len - 1 : next].id,
        autoCycle
      );
    },
    /**
    ...
    onSelect = function(id, autoCycle) {
      ...
      if (isSmallView && $panel[0].nodeName.toLowerCase() === "details") {
        $panel
          .children("summary")
          .trigger($panel.attr("open") ? setFocusEvent : "click");
      } else {
            ...
            if ($details.length !== 0) {
              ...
              if (isSmallView) {
                ...
                for (j = 0; j !== len2; j += 1) {
                  ...
                  if (!isInit) {
                    $detailsElm.children("summary").attr({
                ...
                $openDetails = ($openDetails.length === 0
                  ? $details
                  : $openDetails
                ).eq(0);
                ...
                $openDetails.addClass("fade in").attr({
                  "aria-hidden": "false",
                  "aria-expanded": "true"
                });
              }
              ...
              if (isSmallView && !isInit) {
                ...
                $elm
                  .removeAttr("role")
                  .find(nestedTglPanelSelector)
                  .removeAttr("role");

                $elm
                  .find("> ul [href$='" + openDetailsId + "']")
                  .trigger("click");
              }
            }
          }
  ...
  // Bind the init event of the plugin
  $document.on(
    "timerpoke.wb " + initEvent + " " + shiftEvent + " " + selectEvent,
    selector,
    function(event) {
      var eventTarget = event.target,
      ...
      if (which > 36) {
        ...
        if (elm.getAttribute("role") === "tab") {
          ...
          if (which === 13 || which === 32) {
            $sldr.find(elm.getAttribute("href")).trigger(setFocusEvent);
          }
  ...
  $document.on(
    activateEvent,
    selector + " > .tabpanels > details > summary",
    function(event) {
      var which = event.which,
...
(function($, window, document, wb) {
  ...
  var componentName = "wb-txthl",
    ...
    init = function(event) {
      ...
      if (elm) {
        if (event.txthl) {
          searchCriteria = $.isArray(event.txthl)
            ? event.txthl.join("|")
            : event.txthl;
        ...
        if (searchCriteria) {
          ...
          newText = elm.innerHTML.replace(
            new RegExp(searchCriteria, "gi"),
...
(function($, window, wb) {
  ...
  var componentName = "wb-toggle",
    ...
    initAria = function(link, data) {
      ...
      if (data.group != null && data.parent != null) {
        ...
        if (parent.getAttribute("role") !== "tablist") {
          ...
          if (
            parent.className.indexOf("wb-tabs") === -1 ||
          ...
          for (i = 0, len = elms.length; i !== len; i += 1) {
            ...
            isOpen =
              elm.nodeName.toLowerCase() === "details"
    ...
    initPersist = function($link, data) {
      ...
      data.persistKey =
        componentName + (data.group ? data.group : "") + link.id;
    ...
    toggle = function(event, data) {
      if (event.namespace === componentName) {
        var dataGroup,
          ...
          $elms = isTablist
            ? $link.parent(data.group)
            : getElements(link, data);
        ...
        if (isGroup) {
          ...
          setState(
            isTablist ? $(data.parent).find(selectorTab) : $elmsGroup,
            dataGroup,
            data.stateOff
          );
  ...
  $document.on(
    "timerpoke.wb " + initEvent + " " + toggleEvent + " click",
    selector,
    function(event, data) {
      var eventType = event.type;
  ...
  $document.on("keydown", selectorTab, function(event) {
    ...
    if (!event.ctrlKey && which > 34 && which < 41) {
      ...
      $newPanel.children("summary").trigger(setFocusEvent);
    }
  });
    ...
    init = function(event) {
      ...
      if (elm) {
        ...
        for (param in pageUrl.params) {
          if (
            param &&
            pageUrl.params.hasOwnProperty(param) &&
            param !== "wbdisable"
          ) {
        ...
        try {
          if (wb.isDisabled || (wb.ie && wb.ielt7)) {
            ...
            noticehtml =
              noticehtml +
              " class='alert alert-warning text-center'><h2>" +
              noticeHeader +
              "</h2><p>" +
              noticeBody +
        ...
        li.innerHTML =
          "<a class='wb-sl' rel='alternate' href='" +
          nQuery +
          "wbdisable=true'>" +
          i18n("wb-disable") +
          "</a>";
...
(function($, wb) {
  ...
  var $document = wb.doc,
    ...
    processHash = function() {
      ...
      if (
        hash &&
        ($linkTarget = $("#" + wb.jqEscape(hash.substring(1)))).length !== 0
      ) {
        $linkTarget.trigger(setFocusEvent);
      }
    };
  ...
  var componentName = "wb-zebra",
    ...
    zebraTable = function($elm) {
      ...
      if (tblparser.lstrowgroup) {
        for (
          i = 0, iLength = tblparser.lstrowgroup.length;
          i !== iLength;
          i += 1
        ) {
      ...
      if (tblparser.colgroup) {
        for (
          i = 0, iLength = tblparser.colgroup.length;
          i !== iLength;
          i += 1
        ) {
    ...
    init = function(event) {
      ...
      // returns undefined = do not proceed with init (e.g., already initialized)
      var elm = wb.init(event, componentName, selector),
        deps = ["site!deps/tableparser" + wb.getMode() + ".js"],
        elmId;
