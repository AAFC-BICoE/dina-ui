 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    matches: { mixin: "[MIXIN] 일치하는 검색 결과가" },
    current: "(현재)",
    hide: "숨기기",
    err: "오류",
    colon: ":",
    ...
    "min-ago": "분 전",
    "coup-mins": "분 전에 몇",
    "mins-ago": { mixin: "[MIXIN] 분전" },
    "hour-ago": "한 시간 전에",
    "hours-ago": { mixin: "[MIXIN]시간 전" },
    "days-ago": { mixin: "[MIXIN] 일 전" },
    yesterday: "어제",
    nxt: "다음",
    "nxt-r": "다음 (오른쪽 화살표 키)",
    prv: "이전",
    ...
    "esc-key": "(Esc 키와)",
    show: "표시",
    "tab-rot": { off: "탭 회전을 중지", on: "탭 회전을 시작" },
    "tab-list": "탭 목록",
    ...
    close: "가까운",
    volume: "볼륨",
    mute: { on: "음소거", off: "음소거 해제" },
    cc: { off: "숨기기 캡션 휴무", on: "쇼는 캡션 휴무" },
    "cc-err": "로드하는 중 오류가 발생 자막",
    adesc: { on: "오디오 설명을 사용", off: "오디오 설명을 해제합니다" },
    pos: "현재 위치 :",
    dur: "총 시간",
    "shr-txt": "공유",
    "shr-pg": " 이 페이지",
