 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    matches: { mixin: "[MIXIN] gevonden zoekresultaten" },
    current: "(actueel)",
    hide: "Verbergen",
    err: "Fout",
    colon: ":",
    ...
    "mins-ago": { mixin: "[MIXIN] minuten geleden" },
    "hour-ago": "een uur geleden",
    "hours-ago": { mixin: "[MIXIN] uren geleden" },
    "days-ago": { mixin: "[MIXIN] dagen geleden" },
    yesterday: "gisteren",
    nxt: "Volgende",
    ...
    show: "Toon",
    "tab-rot": { off: "Stop de tabrotatie", on: "Start de tabrotatie" },
    ...
    close: "Afsluiten",
    volume: "Volume",
    mute: { on: "Geluid uitzetten", off: "Geluid aanzetten" },
    cc: { off: "Bijschrift verbergen", on: "Bijschrift tonen" },
