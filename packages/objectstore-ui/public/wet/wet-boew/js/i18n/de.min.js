 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    matches: { mixin: "[MIXIN] Ergebnisse gefunden" },
    current: "(Aktuell)",
    hide: "Verbergen",
    err: "Fehler",
    colon: ":",
    ...
    "mins-ago": { mixin: "Vor [MIXIN] Minuten" },
    "hour-ago": "Vor einer Stunde",
    "hours-ago": { mixin: "Vor [MIXIN] Stunden" },
    "days-ago": { mixin: "Vor [MIXIN] Tagen" },
    yesterday: "gestern",
    nxt: "Nächste",
    ...
    close: "Schließen",
    volume: "Lautstärke",
    mute: { on: "Stumm", off: "Stummschaltung" },
    cc: { off: "Ausblenden Untertitelung", on: "Zeige Untertitelung" },
      ...
      return (
        a.extend(a.validator.messages, {
          ...
          maxlength: a.validator.format(
            "Geben Sie bitte maximal {0} Zeichen ein."
          ),
