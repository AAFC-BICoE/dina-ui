 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    matches: { mixin: "[MIXIN] αγώνες που βρέθηκαν" },
    current: "(Τρέχουσα)",
    hide: "Κρύβω",
    err: "Σφάλμα",
    colon: ":",
    ...
    "mins-ago": { mixin: "Πριν από [MIXIN] λεπτά" },
    "hour-ago": "μια ώρα πριν από",
    "hours-ago": { mixin: "[MIXIN] ώρες πριν" },
    "days-ago": { mixin: "[MIXIN] μέρες πριν" },
    yesterday: "εχθές",
    nxt: "Επόμενος",
    ...
    mute: { on: "Σίγαση", off: "Αναίρεση σίγασης" },
    cc: { off: "Απόκρυψη Κλειστό λεζάντες", on: "Εμφάνιση Κλειστό λεζάντες" },
