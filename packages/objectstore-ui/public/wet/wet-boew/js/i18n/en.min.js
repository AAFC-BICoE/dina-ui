 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    matches: { mixin: "[MIXIN] match(es) found" },
    current: "(current)",
    hide: "Hide",
    err: "Error",
    colon: ":",
    ...
    "mins-ago": { mixin: "[MIXIN] minutes ago" },
    "hour-ago": "an hour ago",
    "hours-ago": { mixin: "[MIXIN] hours ago" },
    "days-ago": { mixin: "[MIXIN] days ago" },
    yesterday: "yesterday",
    nxt: "Next",
    ...
    "esc-key": "(escape key)",
    show: "Show",
    "tab-rot": { off: "Stop tab rotation", on: "Start tab rotation" },
    "tab-list": "Tab list",
    ...
    cc: { off: "Hide closed captioning", on: "Show closed captioning" },
    "cc-err": "Error loading closed captions",
    adesc: { on: "Enable audio description", off: "Disable audio description" },
