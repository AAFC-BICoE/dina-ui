 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    matches: { mixin: "Ditemukan [MIXIN] kecocokan" },
    current: "(saat ini)",
    hide: "Sembunyikan",
    err: "Error",
    colon: ":",
    ...
    "mins-ago": { mixin: "[MIXIN] menit yang lalu" },
    "hour-ago": "Satu jam yang lalu",
    "hours-ago": { mixin: "[MIXIN] hours ago" },
    "days-ago": { mixin: "[MIXIN] hari yang lalu" },
    yesterday: "Kemarin",
    nxt: "Berikutnya",
    ...
    show: "Tampilkan",
    "tab-rot": { off: "Hentikan rotasi tab", on: "Mulai rotasi tab" },
    "tab-list": "Daftar tab",
    ...
    close: "Tutup",
    volume: "Volume",
    mute: { on: "Redam suara", off: "Aktifkan kembali suara" },
    cc: { off: "Sembunyikan subtitel", on: "Tampilkan subtitel" },
