...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    /* Session timeout */
    "st-to-msg-bgn":
      "Your session will expire automatically in #min# min #sec# sec.",
    ...
    "geo-ariamap":
      "Map object. The descriptions of the map features are in the table below.",
    "geo-ally":
    ...
    "geo-loc-placeholder":
      "Enter placename&#44; postal code&#44; street address&#44; NTS number...",
    ...
    "geo-aoi-instructions":
      'Draw box on map or enter coordinates below and click the "Add" button.',
    "geo-aoi-title": "Draw box on map or enter coordinates",
    "geo-aoi-btndraw": "Draw",
    "geo-aoi-btnclear": "Clear",
    "geo-geoloc-btn": "Zoom to current location",
    "geo-geoloc-fail":
      "Geolocation failed. Please ensure that location services are enabled.",
