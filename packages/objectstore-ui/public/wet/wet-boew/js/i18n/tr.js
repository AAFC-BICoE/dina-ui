...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    "shr-hnt": " ile {s} ",
    "shr-disc":
      "Herhangi bir ürün veya hizmet yok onaylandığı ifade ya da ima edilir.",
    ...
    /* Session timeout */
    "st-to-msg-bgn":
      "Oturumunuz #min# dk #sec# sn otomatik olarak sona erecek.",
    "st-to-msg-end": 'turum uzatmak için "oturum devam" seçin.',
    "st-msgbx-ttl": "Oturum zaman aşımı uyarısı",
    "st-alrdy-to-msg":
      "Üzgünüz oturumu zaten doldu. Lütfen tekrar giriş yapın.",
    ...
    "geo-ariamap":
      "Harita nesne. Harita özellikleri açıklamaları aşağıdaki tabloda yer almaktadır.",
    "geo-ally":
      "<strong>Klavye kullanıcıları:</strong> harita odakta olduğunda, harita ve yakınlaştırmak için artı ve eksi tuşları kaydırmak için ok tuşlarını kullanın. Harita ölçüde yakınlaştırılmış zaman ok tuşları Haritayı kaydırmak olmaz.",
    ...
    "geo-attrttl":
      "GeoGratis - Kanada temel harita (İngilizce veya Fransızca sadece)",
    "geo-sel": "Seçmek",
    "geo-lblsel": "Harita üzerinde öğe seçmek için kontrol edin",
    "geo-locurl-geogratis": "//geogratis.gc.ca/services/geolocation/en/locate",
    "geo-loc-placeholder":
      "Konumu&#44; posta kodu&#44; adres (posta)&#44; NTS sayısının adını belirtin ...",
    "geo-loc-label": "Konum",
    "geo-aoi-north": "Kuzey",
    "geo-aoi-east": "Doğu",
    "geo-aoi-south": "Güney",
    ...
    "geo-aoi-instructions":
      'Harita üzerinde kutusu çizmek ya da aşağıdaki koordinatları girin ve "Ekle" düğmesine tıklayın.',
    ...
    "geo-geoloc-fail":
      "Yer başarısız oldu. Yer hizmetleri etkin olduğundan emin olun.",
    "geo-geoloc-uncapable":
      "Yerelleştirme tarayıcınız tarafından desteklenmiyor.",
