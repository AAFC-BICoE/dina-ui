 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    matches: { mixin: "[MIXIN] atitikmuo (-enys) rasti" },
    current: "(dabartinė)",
    hide: "Slėpti",
    err: "Klaida",
    colon: ":",
    ...
    "mins-ago": { mixin: "Prieš [MIXIN] minutes" },
    "hour-ago": "Prieš valandą",
    "hours-ago": { mixin: "Prieš [MIXIN] valandas" },
    "days-ago": { mixin: "Prieš [MIXIN] dienas" },
    yesterday: "Vakar",
    nxt: "Sekantis",
    ...
    show: "Rodyti",
    "tab-rot": { off: "Sustabdyti rotaciją", on: "Pradėti rotaciją" },
      ...
      return (
        a.extend(a.validator.messages, {
          ...
          max: a.validator.format(
            "Prašau įvesti reikšmę mažesnę arba lygią {0}."
          ),
          min: a.validator.format(
            "Prašau įvesti reikšmę didesnę arba lygią {0}."
          )
        }),
        a
      );
