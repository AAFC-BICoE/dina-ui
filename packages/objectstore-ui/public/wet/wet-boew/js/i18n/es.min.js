 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    matches: { mixin: "[MIXIN] resultado(s) encontrados" },
    current: "(actual)",
    hide: "Ocultar",
    err: "Error",
    colon: ":",
    ...
    "mins-ago": { mixin: "hace [MIXIN] minutos" },
    "hour-ago": "hace una hora",
    "hours-ago": { mixin: "hace [MIXIN] horas" },
    "days-ago": { mixin: "hace [MIXIN] días" },
    yesterday: "ayer",
    nxt: "Siguiente",
    ...
    close: "Cerrar",
    volume: "Volumen",
    mute: { on: "Silencio", off: "Habilitar sonido" },
    cc: { off: "Ocultar subtítulos", on: "Mostrar subtítulos" },
