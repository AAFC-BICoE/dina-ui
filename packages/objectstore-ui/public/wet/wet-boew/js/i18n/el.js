...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    "shr-hnt": " με {s} ",
    "shr-disc":
      "Δεν οπισθογράφηση των οποιωνδήποτε τα προϊόντα ή υπηρεσίες αυτών δεν εκφράζονται ή σιωπηρή.",
    ...
    cal: "Ημερολόγιο",
    "cal-format":
      "<span class='wb-inv'>{ddd}, {M} </span>{d}<span class='wb-inv'>, {Y}</span>",
    ...
    "st-to-msg-end":
      'Επιλέξτε "Συνέχεια συνεδρία" να παρατείνει τη συνεδρία σας.',
    "st-msgbx-ttl": "Συνεδρία προειδοποίηση χρονικού ορίου",
    "st-alrdy-to-msg":
      "Μας συγχωρείτε συνεδρίας σας έχει ήδη λήξει. Παρακαλείστε να συνδεθείτε και πάλι.",
    ...
    "geo-ariamap":
      "Χάρτης αντικείμενο. Οι περιγραφές των χαρακτηριστικών του χάρτη αναφέρονται στον πίνακα που ακολουθεί.",
    "geo-ally":
      "<strong>Οι χρήστες Πληκτρολόγιο:</strong> Όταν ο χάρτης είναι σε εστίαση, χρησιμοποιήστε τα πλήκτρα βέλους για να μετακινήσετε το χάρτη και τις συν και του ενεργητικού μείον τα τα πλήκτρα για να κάνετε ζουμ. Οι πλήκτρα με τα βέλη δεν θα τηγάνι το χάρτη όταν μεγεθύνεται στο βαθμό που χάρτη.",
    ...
    "geo-bmap-url":
      "//geoappext.nrcan.gc.ca/arcgis/rest/services/BaseMaps/CBMT3978/MapServer/WMTS/",
    "geo-bmap-matrix-set": "default028mm",
    "geo-bmapttl": "BaseMaps_CBMT3978",
    "geo-bmapurltxt":
      "//geoappext.nrcan.gc.ca/arcgis/rest/services/BaseMaps/CBMT_TXT_3978/MapServer/WMTS/tile/1.0.0/BaseMaps_CBMT3978/{Style}/{TileMatrixSet}/{TileMatrix}/{TileRow}/{TileCol}.jpg",
    "geo-attrlnk": "//geogratis.gc.ca/geogratis/CBM_CBC?lang=en",
    "geo-attrttl": "GeoGratis - Καναδάς χάρτη βάσης (αγγλικά ή γαλλικά)",
    "geo-sel": "Επιλέξτε το",
    "geo-lblsel":
      "Ελέγξτε τις για να επιλέξετε το στοιχείο σχετικά με την χάρτη",
    "geo-locurl-geogratis": "//geogratis.gc.ca/services/geolocation/en/locate",
    "geo-loc-placeholder":
      "Να αναφερθεί το όνομα της τοποθεσίας&#44; ταχυδρομικό κώδικα&#44; διεύθυνση (ταχυδρομική)&#44; ο αριθμός των NTS ...",
    ...
    "geo-aoi-instructions":
      'Σχεδιάστε το πλαίσιο στο χάρτη ή πληκτρολογήστε τις συντεταγμένες παρακάτω και κάντε κλικ στο κουμπί "Προσθήκη".',
    ...
    "geo-geoloc-fail":
      "Τοποθεσία απέτυχε. Παρακαλούμε βεβαιωθείτε ότι οι υπηρεσίες τοποθεσίας ενεργοποιημένη.",
    "geo-geoloc-uncapable":
      "Localization δεν υποστηρίζεται από το πρόγραμμα περιήγησής σας.",
    ...
    /* Filter */
    "fltr-lbl":
      'Filter<span class="wb-inv"> content: results appear below as you type.</span>',
