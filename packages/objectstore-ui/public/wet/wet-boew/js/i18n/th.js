...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    /* Session timeout */
    "st-to-msg-bgn":
      "เซสชั่นของคุณจะหมดอายุโดยอัตโนมัติใน #min# นาที #sec# วินาที.ที่จะขยายเซสชั่นของคุณ",
    "st-to-msg-end": 'เลือก "Continue เซสชั่น" ที่จะขยายเซสชั่นของคุณ',
    "st-msgbx-ttl": "เตือนหมดเวลา",
    "st-alrdy-to-msg":
      "ขออภัยเซสชันของคุณหมดอายุแล้ว กรุณาเข้าสู่ระบบอีกครั้ง.",
    ...
    "geo-ally":
      "<strong>ผู้ใช้แป้นพิมพ์:</strong> เมื่อแผนที่จะอยู่ในโฟกัสใช้ปุ่มลูกศรเพื่อเลื่อนแผนที่และคีย์บวกและลบเพื่อซูม ปุ่มลูกศรจะไม่เลื่อนแผนที่เมื่อซูมที่มีขอบเขตแผนที่.",
    ...
    "geo-attrttl":
      "GeoGratis-แคนาดาฐานแผนที่ (ภาษาอังกฤษหรือภาษาฝรั่งเศสเท่านั้น)",
    "geo-sel": "เลือก",
    "geo-lblsel": "ตรวจสอบเพื่อเลือกองค์ประกอบบนแผนที่",
    "geo-locurl-geogratis": "//geogratis.gc.ca/services/geolocation/en/locate",
    "geo-loc-placeholder":
      "ระบุชื่อสถานที่&#44; รหัสไปรษณีย์ที่อยู่ (ไปรษณีย์) จำนวน NTS ...",
    ...
    "geo-aoi-instructions":
      'วาดกล่องบนแผนที่หรือป้อนพิกัดด้านล่างและคลิกที่ปุ่ม "เพิ่ม"',
