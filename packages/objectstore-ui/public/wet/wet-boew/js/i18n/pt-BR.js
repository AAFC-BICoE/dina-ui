...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    "shr-hnt": " com {s} ",
    "shr-disc":
      "Nenhum endosso, expresso ou implícito, é concedido a quaisquer produtos ou serviços",
    ...
    "st-alrdy-to-msg":
      "Desculpe, sua sessão já expirou. Por favor, faça novo login.",
    ...
    "geo-ariamap":
      "Objeto do mapa. As descrições das características do mapa estão na tabela abaixo.",
    "geo-ally":
      "<strong>Usuários de teclado:</strong> Quando o mapa estiver em foco, use as teclas de seta para mover o mapa e as teclas de mais e de menos para ampliar e reduzir, respectivamente. As teclas de seta não funcionarão quando a imagem estiver reduzida ao tamanho do mapa.",
    ...
    "geo-loc-placeholder":
      "Indicar o nome do local&#44; CEP&#44; endereço (postal)&#44; o número de NTS ...",
    ...
    "geo-aoi-instructions":
      'Caixa Desenhe no mapa ou inserir coordenadas abaixo e clique no botão "Adicionar".',
    ...
    "geo-geoloc-fail":
      "Localização falhou. Certifique-se que os serviços de localização estão habilitados.",
