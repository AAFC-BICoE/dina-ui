...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    "shr-hnt": " с {s} ",
    "shr-disc":
      "Нет одобрение любых продуктов или услуг, выраженных или подразумеваемых.",
    ...
    /* Session timeout */
    "st-to-msg-bgn":
      "Ваш сеанс закончится автоматически в #min# мин #sec# сек.",
    ...
    "geo-ariamap":
      "Карта объектов. Описание функций карты приведены в таблице ниже.",
    "geo-ally":
      "<strong>Клавиатура пользователей:</strong> Когда карта находится в фокусе, используйте клавиши со стрелками для перемещения по карте и плюс и минус ключи, чтобы увеличить. Стрелками не будет перемещения по карте при увеличении на карту степени.",
    ...
    "geo-attrttl":
      "GeoGratis - Канада базовой карты (на английском или французском языке)",
    "geo-sel": "Выбирать",
    "geo-lblsel": "Проверьте, чтобы выбрать элемент на карте",
    "geo-locurl-geogratis": "//geogratis.gc.ca/services/geolocation/en/locate",
    "geo-loc-placeholder":
      "Укажите название места&#44; почтовый индекс&#44; адрес (почтовый)&#44; количество НТС ...",
    ...
    "geo-aoi-instructions":
      'Нарисуйте окно на карте или введите координаты ниже и нажмите кнопку "Добавить".',
    ...
    "geo-geoloc-fail":
      "Расположение не удалось. Пожалуйста, убедитесь, что услуги определения местоположения включены.",
