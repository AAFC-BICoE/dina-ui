...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    /* Session timeout */
    "st-to-msg-bgn":
      "سوف تنتهي جلسة العمل الخاصة بك تلقائيا في على  #min# دقيقة #sec# ثانية.",
    "st-to-msg-end": 'اختر "متابعة الجلسة" لتمديد جلسة العمل الخاصة بك.',
    "st-msgbx-ttl": "الدورة مهلة الإنذار",
    "st-alrdy-to-msg":
      "عذرا انتهت صلاحية جلسة العمل الخاصة بك بالفعل. يرجى تسجيل الدخول مرة أخرى.",
    ...
    "geo-ally":
      "<strong>مستخدمي لوحة المفاتيح:</strong> عندما الخريطة هي في التركيز، استخدم مفاتيح الأسهم لتحريك الخريطة ومفاتيح زائد وناقص لتكبير. فإن مفاتيح الأسهم لا تحريك الخريطة عند التكبير إلى حد الخريطة.",
    ...
    "geo-attrttl":
      "GeoGratis - كندا قاعدة الخريطة (الإنجليزية أو الفرنسية فقط)",
    "geo-sel": "حدد",
    "geo-lblsel": "تحقق لتحديد عنصر على الخريطة",
    "geo-locurl-geogratis": "//geogratis.gc.ca/services/geolocation/en/locate",
    "geo-loc-placeholder":
      "تشير إلى اسم الموقع، والرمز البريدي والعنوان (البريدي)، وعدد من NTS ...",
    "geo-loc-label": "موقع",
    "geo-aoi-north": "شمال",
    "geo-aoi-east": "شرق",
    "geo-aoi-south": "جنوب",
    ...
    "geo-aoi-instructions":
      'مربع رسم على الخريطة أو أدخل إحداثيات أدناه وانقر على زر "إضافة".',
