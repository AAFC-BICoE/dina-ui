...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    "shr-hnt": " me {s} ",
    "shr-disc":
      "Asnjë miratimi i ndonjë produkteve apo shërbimeve është shprehur apo të nënkuptuar",
    ...
    /* Session timeout */
    "st-to-msg-bgn":
      "Sesioni juaj do të përfundojë automatikisht në #min# min #sec# sec.",
    "st-to-msg-end": 'Zgjidhni "Vazhdo seancë" për të zgjeruar sesionin tuaj.',
    "st-msgbx-ttl": "Timeout Sesioni paralajmërim",
    "st-alrdy-to-msg":
      "Na vjen keq Sesioni juaj ka skaduar tashmë. Ju lutemi identifikohuni përsëri.",
    ...
    "geo-ariamap":
      "Harta objekt. Përshkrimet e karakteristika hartë janë në tabelën e mëposhtme.",
    "geo-ally":
      "<strong>Përdoruesit keyboard:</strong> Kur hartë është në fokus, përdorni arrow çelësat për të pan hartë dhe çelësat plus dhe minus për zmadhim. Arrow keys nuk do pan hartën kur zoomed në masën hartë.",
    ...
    "geo-attrttl":
      "GeoGratis - Kanada hartë bazë (anglisht ose frëngjisht vetëm)",
    "geo-sel": "Zgjedh",
    "geo-lblsel": "Kontrolloni për të zgjedhur elementin në hartë",
    "geo-locurl-geogratis": "//geogratis.gc.ca/services/geolocation/en/locate",
    "geo-loc-placeholder":
      "Shënoni emrin e vendndodhjes&#44; kod postar&#44; adresa (postare)&#44; numri i NTS ...",
    ...
    "geo-aoi-instructions":
      'Teken boks op kaart of ingaan koördinate hieronder en klik op die knoppie "Voeg deur".',
    ...
    "geo-geoloc-fail":
      "Vendndodhja dështuar. Ju lutemi të sigurojë që shërbimet lokacioni janë të aktivizuara.",
