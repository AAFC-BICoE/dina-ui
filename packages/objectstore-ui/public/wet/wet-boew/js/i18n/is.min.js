 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    matches: { mixin: "[MIXIN] niðurstöður fundust" },
    current: "(núverandi)",
    hide: "Fela",
    err: "Villa",
    colon: ":",
    ...
    "mins-ago": { mixin: "[MIXIN] mínútur síðan" },
    "hour-ago": "klukkutíma síðan",
    "hours-ago": { mixin: "[MIXIN] klst síðan" },
    "days-ago": { mixin: "[MIXIN] dögum síðan" },
    yesterday: "í gær",
    nxt: "Næsta",
