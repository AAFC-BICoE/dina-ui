 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    matches: { mixin: "[MIXIN] corrispondenza/e trovata/e" },
    current: "(attuale)",
    hide: "Nascondere",
    err: "Errore",
    colon: ":",
    ...
    "mins-ago": { mixin: "[MIXIN] Minuti fa" },
    "hour-ago": "un'ora fa",
    "hours-ago": { mixin: "[MIXIN] ore fa" },
    "days-ago": { mixin: "[MIXIN] giorni fa" },
    yesterday: "ieri",
    nxt: "Prossimo",
    ...
    close: "Chiudere",
    volume: "Volume",
    mute: { on: "Muto", off: "Riattivare audio" },
    cc: { off: "Nascondi i sottotitoli", on: "Mostra i sottotitoli" },
