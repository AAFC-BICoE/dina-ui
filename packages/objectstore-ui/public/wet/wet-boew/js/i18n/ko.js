...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    "st-alrdy-to-msg":
      "미안 세션이 이미 만료되었습니다. 다시 로그인 해주십시오.",
    "st-btn-cont": "세션을 계속",
    ...
    "geo-ariamap":
      "지도 개체입니다. 지도 기능의 설명은 아래 표에 나와 있습니다.",
    "geo-ally":
      "<strong>키보드 사용자 :</strong>지도 초점이 때,지도와 확대 할 수있는 플러스 (+) 및 마이너스 키를 이동하려면 화살표 키를 사용합니다. 지도 범위 확대 할 때 화살표 키를지도를 이동하지 않습니다.",
    ...
    "geo-loc-placeholder":
      "위치&#44; 우편 번호&#44; 주소 (우편), NTS의 개수의 이름을 나타내 ...",
    "geo-loc-label": "위치",
    "geo-aoi-north": "북쪽",
    "geo-aoi-east": "동쪽",
    "geo-aoi-south": "남쪽으로",
