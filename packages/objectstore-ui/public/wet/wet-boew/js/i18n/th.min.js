 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    matches: { mixin: "[MIXIN] พบว่าตรงกัน" },
    current: "(ปัจจุบัน)",
    hide: "ปิดบัง",
    err: "ความผิดพลาด",
    colon: ":",
    ...
    "mins-ago": { mixin: "[MIXIN] นาทีที่ผ่านมา" },
    "hour-ago": "ชั่วโมงที่ผ่านมา",
    "hours-ago": { mixin: "[MIXIN] ชั่วโมงที่ผ่านมา" },
    "days-ago": { mixin: "[MIXIN] วันที่ผ่านมา" },
    yesterday: "เมื่อวาน",
    nxt: "ต่อไป",
    ...
    "esc-key": "(คีย์หนี)",
    show: "แสดง",
    "tab-rot": { off: "หยุดหมุนแท็บ", on: "เริ่มหมุนแท็บ" },
    "tab-list": "รายการแท็บ",
    ...
    close: "ปิด",
    volume: "ปริมาณ",
    mute: { on: "ปิด", off: "เปิดเสียง" },
    cc: { off: "ซ่อนปิด captioning", on: "แสดงปิด captioning" },
    "cc-err": "ข้อผิดพลาดคำอธิบายปิดโหลด",
    adesc: { on: "เปิดใช้งานคำอธิบายเสียง", off: "ปิดการใช้งานคำอธิบายเสียง" },
    pos: "ตำแหน่งปัจจุบัน:",
    dur: "รวมเวลา:",
    "shr-txt": "แบ่งปัน",
    "shr-pg": "หน้านี้",
      ...
      return (
        a.extend(a.validator.messages, {
          ...
          minlength: a.validator.format(
            "โปรดอย่าระบุค่าที่สั้นกว่า {0} อักขระ"
          ),
