 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    matches: { mixin: "Znaleziono [MIXIN] odpowiedników" },
    current: "(bieżący)",
    hide: "Ukryj",
    err: "Błąd",
    colon: ":",
    ...
    "mins-ago": { mixin: "[MIXIN] minut temu" },
    "hour-ago": "godzinę temu",
    "hours-ago": { mixin: "[MIXIN] godzin temu" },
    "days-ago": { mixin: "[MIXIN} dni temu" },
    yesterday: "wczoraj",
    nxt: "Następny",
    ...
    close: "Zamknij",
    volume: "Głośność",
    mute: { on: "Bez dźwięku", off: "Przywróć dźwięk" },
    cc: { off: "Ukryj podpisy", on: "Pokaż podpisy" },
    "cc-err": "Błąd w ładowaniu podpisów",
    adesc: { on: "Włącz informację audio", off: "Wyłącz informację audio" },
