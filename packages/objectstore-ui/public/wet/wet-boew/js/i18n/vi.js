...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    "shr-hnt": " với {s} ",
    "shr-disc":
      "Không có chứng thực của bất kỳ sản phẩm hoặc dịch vụ được thể hiện hay ngụ ý.",
    ...
    /* Session timeout */
    "st-to-msg-bgn":
      "Phiên của bạn sẽ tự động hết hạn trong  #min# phút #sec# giây.",
    "st-to-msg-end": 'Chọn "Tiếp tục phiên" mở rộng phiên của bạn.',
    "st-msgbx-ttl": "Cảnh báo phiên thời gian chờ",
    "st-alrdy-to-msg":
      "Xin lỗi phiên làm việc của bạn đã hết hạn. Bạn có thể đăng nhập lại.",
    ...
    "geo-ariamap":
      "Bản đồ đối tượng. Những mô tả của các tính năng bản đồ trong bảng dưới đây.",
    "geo-ally":
      "Người sử dụng bàn phím: Khi bản đồ là tập trung, sử dụng các phím mũi tên để xoay bản đồ và các phím dấu cộng và trừ để phóng to. Các phím mũi tên sẽ không xoay bản đồ thu nhỏ đến mức độ bản đồ.",
    ...
    "geo-attrttl":
      "GeoGratis - Canada bản đồ cơ bản (tiếng Anh hoặc tiếng Pháp chỉ)",
    "geo-sel": "Chọn",
    "geo-lblsel": "Kiểm tra để chọn phần tử trên bản đồ",
    "geo-locurl-geogratis": "//geogratis.gc.ca/services/geolocation/en/locate",
    "geo-loc-placeholder":
      "Cho biết tên của địa điểm&#44; mã vùng&#44; địa chỉ (bưu điện)&#44; số lượng NTS ...",
    "geo-loc-label": "Nơi",
    "geo-aoi-north": "Bắc",
    "geo-aoi-east": "Đông",
    "geo-aoi-south": "Nam",
    ...
    "geo-aoi-instructions":
      'Vẽ hộp trên bản đồ hoặc nhập tọa độ bên dưới và nhấp vào nút "Add".',
    "geo-aoi-title": "Draw box on map or enter coordinates",
    "geo-aoi-btndraw": "Vẽ",
    "geo-aoi-btnclear": "Hủy bỏ",
    "geo-geoloc-btn": "Phóng to đến vị trí hiện tại",
    "geo-geoloc-fail":
      "Vị trí thất bại. Hãy đảm bảo rằng dịch vụ định vị được kích hoạt.",
    "geo-geoloc-uncapable":
      "Nội địa hóa không được hỗ trợ bởi trình duyệt của bạn.",
