 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    matches: { mixin: "[MIXIN] ndeshjet gjet" },
    current: "(aktual)",
    hide: "Fsheh",
    err: "Gabim",
    colon: ":",
    ...
    "mins-ago": { mixin: "[MIXIN] minuta më parë" },
    "hour-ago": "një orë më parë",
    "hours-ago": { mixin: "[MIXIN] orë më parë" },
    "days-ago": { mixin: "[MIXIN] ditë më parë" },
    yesterday: "dje",
    nxt: "Tjetër",
    ...
    show: "Shfaq",
    "tab-rot": { off: "Stop rotacionin tab", on: "Fillojnë rrotullimin tab" },
    "tab-list": "Lista tab",
    ...
    close: "Afër",
    volume: "Volumin",
    mute: { on: "Memec", off: "Çheshtja" },
    cc: { off: "Hide Mbyllur captioning", on: "Trego Mbyllur captioning" },
