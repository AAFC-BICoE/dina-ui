 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    matches: { mixin: "[MIXIN] atbilstība(s) nav atrasta(s)" },
    ...
    "mins-ago": { mixin: "pirms [MIXIN] minūtēm" },
    "hour-ago": "pirms stundas",
    "hours-ago": { mixin: "pirms [MIXIN] stundām" },
    "days-ago": { mixin: "pirms [MIXIN] dienām" },
    yesterday: "vakar",
    nxt: "Nākošais",
    ...
    show: "Rādīt",
    "tab-rot": { off: "Pārtraukt rotāciju", on: "Sākt rotāciju" },
    ...
    close: "Aizvērt",
    volume: "Skaļums",
    mute: { on: "Izslēgt skaņu", off: "Ieslēgt skaņu" },
    cc: { off: "Slēpt subtitrus", on: "Rādīt subtitrus" },
    "cc-err": "Kļūda lejuplādējot subtitrus",
    adesc: { on: "Ieslēgt audio aprakstu", off: "Izslēgt audio aprakstu" },
      ...
      return (
        a.extend(a.validator.messages, {
          ...
          minlength: a.validator.format(
            "Lūdzu, ievadiet vismaz {0} rakstzīmes."
          ),
