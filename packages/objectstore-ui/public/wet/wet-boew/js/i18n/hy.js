...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    "shr-hnt": " հետ {s} ",
    "shr-disc":
      "Ոչ հաստատում որեւէ արտադրանքի կամ ծառայությունների արտահայտված կամ ենթադրվող.",
    ...
    "st-to-msg-end":
      'սկզբնական Ընտրել "Շարունակել նիստը» երկարաձգել հայտվել ձեր.',
    "st-msgbx-ttl": "Նիստի ժամանակ դուրս նախազգուշացման",
    "st-alrdy-to-msg":
      "Ներեցեք Ձեր նիստն արդեն ավարտվել է: Խնդրում ենք մուտք գործել կրկին փորձել.",
    ...
    "geo-ariamap":
      "Քարտեզ օբյեկտի. Նկարագրերը եւ քարտեզը հատկանիշները են ստորեւ բերված աղյուսակում.",
    "geo-ally":
      "<strong>Ստեղնաշարի գրանցվածները:</strong> Երբ քարտեզը ուշադրության կենտրոնում, օգտագործեք սլաքը բանալիները համահայկական քարտեզի վրա եւ այն, եւ գումարած մինուս բանալին վրա, այն մեծացնելու. Սլաքը բանալիներ չեն համահայկական քարտեզը երբ Մանրացնել է քարտեզ չափով.",
    ...
    "geo-attrttl":
      "GeoGratis - Կանադա բազա քարտեզ (անգլերեն կամ ֆրանսերեն միայն)",
    "geo-sel": "Ընտրել",
    "geo-lblsel": "Ստուգեք ընտրել տարրը քարտեզի վրա",
    "geo-locurl-geogratis": "//geogratis.gc.ca/services/geolocation/en/locate",
    "geo-loc-placeholder":
      "Նշեք անունը&#44; գտնվելու վայրը&#44; փոստային կոդը&#44; հասցեն&#44; (փոստային) համարը NTS ...",
    ...
    "geo-aoi-instructions":
      'Ոչ ոքի վանդակը քարտեզի վրա, կամ մուտք գործել համակարգում ստորեւ, եւ սեղմեք "Ավելացնել" կոճակը:',
    ...
    "geo-geoloc-fail":
      "Որտեղից ձախողվեց. Խնդրում ենք համոզվել, որ այդ վայրում ծառայություններ հնարավորություն.",
