 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    matches: { mixin: "[MIXIN] открити съвпадения" },
    current: "(Текущи)",
    hide: "Крия",
    err: "Грешка",
    colon: ":",
    ...
    "mins-ago": { mixin: "[MIXIN] минути" },
    "hour-ago": "преди час",
    "hours-ago": { mixin: "[MIXIN] часа преди" },
    "days-ago": { mixin: "[MIXIN] дни" },
    yesterday: "вчера",
    nxt: "Следваща",
    ...
    close: "Близо",
    volume: "Звука",
    mute: { on: "Изключване", off: "Вкл.звук" },
    cc: { off: "Скрий Затворени надписи", on: "Покажи Затворени надписи" },
      ...
      return (
        a.extend(a.validator.messages, {
          ...
          maxlength: a.validator.format(
            "Моля, въведете повече от {0} символа."
          ),
