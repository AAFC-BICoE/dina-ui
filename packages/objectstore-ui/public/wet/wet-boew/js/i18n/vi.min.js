 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    matches: { mixin: "[MIXIN] trận được tìm thấy" },
    current: "(hiện tại)",
    hide: "Che",
    err: "Lôi",
    colon: ":",
    ...
    "mins-ago": { mixin: "[MIXIN] phút trước" },
    "hour-ago": "một giờ trước đây",
    "hours-ago": { mixin: "[MIXIN] giờ trước" },
    "days-ago": { mixin: "[MIXIN] ngày trước" },
    yesterday: "hôm qua",
    nxt: "Tiếp theo",
    ...
    "esc-key": "(phím thoát)",
    show: "Hiện",
    "tab-rot": { off: "Ngừng xoay tab", on: "Bắt đầu luân chuyển tab" },
    ...
    close: "Đóng",
    volume: "Khối lượng",
    mute: { on: "Tắt", off: "Bật tiếng" },
    cc: { off: "Hide Đóng cửa phụ đề", on: "Hiện Đóng cửa phụ đề" },
    ...
    !(function(a) {
      ...
      return (
        a.extend(a.validator.messages, {
          ...
          min: a.validator.format("Hãy nhập từ {1} trở lên.")
        }),
        a
      );
    });
