...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    "shr-hnt": " com {s} ",
    "shr-disc":
      "Não endosso de quaisquer produtos ou serviços é expressa ou implícita",
    ...
    "st-alrdy-to-msg":
      "Desculpe a sessão já expirou. Por favor, faça login novamente.",
    ...
    "geo-ariamap":
      "Objeto de mapa. As descrições das características do mapa estão na tabela abaixo.",
    "geo-ally":
      "<strong>Usuários de teclado:</strong> Quando o mapa está em foco, use as teclas de setas para mover o mapa e as teclas mais e menos para ampliar. As teclas de seta não vai percorrer o mapa quando ampliada na medida em mapa.",
