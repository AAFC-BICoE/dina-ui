...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    "shr-hnt": " con {s} ",
    "shr-disc":
      "No implica la promoción ni recomendación de ningún producto o servicio.",
    ...
    /* Session timeout */
    "st-to-msg-bgn":
      "Su sesión expirará automáticamente en #min# min #sec# seg.",
    "st-to-msg-end": 'Seleccione "Continuar sesión" para prolongar su sesión.',
    "st-msgbx-ttl": "Aviso de finalización de sesión",
    "st-alrdy-to-msg":
      "Lo sentimos, su sesión ha expirado. Por favor ingrese nuevamente.",
    ...
    "geo-ariamap":
      "Objeto: mapa. Las descripciones de las características del mapa están en la tabla a continuación.",
    "geo-ally":
      "<strong>Keyboard users:</strong> When the map is in focus, use the arrow keys to pan the map and the plus and minus keys to zoom. The arrow keys will not pan the map when zoomed to the map extent.",
    ...
    "geo-loc-placeholder":
      "Indique el nombre de la localidad&#44; código postal&#44; dirección (postal)&#44; el número de NTS ...",
    ...
    "geo-aoi-instructions":
      'Delimitar una zona en el mapa o rellene el formulario a continuación&#44; haga clic en el botón "Añadir".',
    ...
    "geo-geoloc-fail":
      "Ubicación falló. Por favor asegúrese de que los servicios de localización están habilitados.",
    "geo-geoloc-uncapable":
      "Localización puede no ser compatible con su navegador.",
