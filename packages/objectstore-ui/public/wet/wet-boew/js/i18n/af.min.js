 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    "mins-ago": { mixin: "[MIXIN] minute gelede" },
    "hour-ago": "n uur gelede",
    "hours-ago": { mixin: "[MIXIN] ure gelede" },
    "days-ago": { mixin: "[MIXIN] dae gelede" },
    yesterday: "gister",
    nxt: "Volgende",
    ...
    show: "Toon",
    "tab-rot": { off: "Stop tab rotasie", on: "Begin blad rotasie" },
    "tab-list": "Tab lys",
    ...
    close: "Close",
    volume: "Volume",
    mute: { on: "Stom", off: "Ontdemp" },
    cc: { off: "Steek Gesluit byskrifte", on: "Wys Gesluit byskrifte" },
