 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    matches: { mixin: "Leitud [MIXIN] vaste(t)" },
    current: "(praegune)",
    hide: "Peida",
    err: "Viga",
    colon: ":",
    ...
    "mins-ago": { mixin: "[MIXIN] minutit tagasi" },
    "hour-ago": "tund aega tagasi",
    "hours-ago": { mixin: "[MIXIN] tundi tagasi" },
    "days-ago": { mixin: "[MIXIN] päeva tagasi" },
    yesterday: "eile",
    nxt: "Järgmine",
    ...
    close: "Sulge",
    volume: "Helitugevus",
    mute: { on: "Vaigista", off: "Heli tagasi" },
    cc: { off: "Peida subtiitrid", on: "Näita subtiitreid" },
    "cc-err": "Viga subtiitrite avamisel",
    adesc: { on: "Luba audio kirjeldus", off: "Sulge audio kirjeldus" },
      ...
      return (
        a.extend(a.validator.messages, {
          ...
          maxlength: a.validator.format(
            "Palun sisestage vähem kui {0} tähemärki."
          ),
          minlength: a.validator.format(
            "Palun sisestage vähemalt {0} tähemärki."
          ),
