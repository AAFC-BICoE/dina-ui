 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    "min-ago": "egy perce",
    "coup-mins": "pár perce",
    "mins-ago": { mixin: "[MIXIN] perccel ezelőtt" },
    "hour-ago": "egy órával ezelőtt",
    "hours-ago": { mixin: "[MIXIN] órával ezelőtt" },
    "days-ago": { mixin: "[MIXIN] nappal ezelőtt" },
    yesterday: "tegnap",
    nxt: "Következő",
    ...
    show: "Mutat",
    "tab-rot": { off: "Tabulálás engedélyezése", on: "Tabulálás kikapcsolása" },
    ...
    close: "Bezárás",
    volume: "Hangerő",
    mute: { on: "Lenémítás", off: "Hang bekapcsolása" },
    cc: { off: "Feliratok kikapcsolása", on: "Feliratozás bekapcsolása" },
    "cc-err": "Hiba a felirat betöltése közben",
    adesc: { on: "Narráció bekapcsolása", off: "Narráció kikapcsolása" },
      ...
      return (
        a.extend(a.validator.messages, {
          ...
          maxlength: a.validator.format(
            "Legfeljebb {0} karakter hosszú legyen."
          ),
