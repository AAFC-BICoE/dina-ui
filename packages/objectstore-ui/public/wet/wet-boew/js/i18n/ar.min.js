 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    "mins-ago": { mixin: "منذ [MIXIN] دقيقة" },
    "hour-ago": "قبل ساعة",
    "hours-ago": { mixin: "منذ [MIXIN] ساعات" },
    "days-ago": { mixin: "منذ [MIXIN] أيام" },
    yesterday: "أمس",
    nxt: "التالي",
    ...
    show: "عرض",
    "tab-rot": { off: "ايقاف الدوران علامة التبويب", on: "بدء دوران التبويب" },
    ...
    close: "أغلق",
    volume: "جهارة الصوت",
    mute: { on: "كتم", off: "إلغاء كتمه" },
    cc: { off: "أغلقت إخفاء السفلية", on: "أغلقت تظهر السفلية" },
    "cc-err": "خطأ في تحميل تعليق مغلق",
    adesc: { on: "تمكين الوصف السمعي", off: "تعطيل الوصف السمعي" },
    pos: "الوظيفة الحالية:",
    dur: "إجمالي الوقت:",
    "shr-txt": "مشاركة",
    "shr-pg": " هذه الصفحة",
