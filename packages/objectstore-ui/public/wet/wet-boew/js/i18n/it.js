...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    "shr-hnt": " con {s} ",
    "shr-disc":
      "Nessuna approvazione di prodotti o servizi è espressa o implicita",
    ...
    /* Session timeout */
    "st-to-msg-bgn":
      "La sessione scadrà automaticamente in #min# min #sec# sec .",
    "st-to-msg-end":
      'Seleziona "Continua sessione" per estendere la tua sessione.',
    "st-msgbx-ttl": "Avviso scadenza sessione",
    "st-alrdy-to-msg":
      "Spiacenti la sessione è già scaduta. Effettua il login di nuovo.",
    ...
    "geo-ariamap":
      "Oggetto della mappa. Le descrizioni delle caratteristiche della mappa sono nella tabella qui sotto.",
    "geo-ally":
      "<strong>Gli utenti della tastiera:</strong> Quando la mappa è a fuoco, utilizzare i tasti freccia per scorrere la mappa e i tasti più e meno per lo zoom. I tasti freccia non scorreranno la mappa quando lo zoom è sull'intera estensione della mappa.",
    ...
    "geo-loc-placeholder":
      "Indicare il nome della località&#44; CAP&#44; indirizzo (postale)&#44; il numero di NTS ...",
    ...
    "geo-aoi-instructions":
      'Delineare un\'area sulla mappa o inserire i dati qui sotto e fare clic sul pulsante "Disegnare".',
    ...
    "geo-geoloc-fail":
      "Posizione non riuscita. Assicurarsi che i servizi di localizzazione sono abilitati.",
