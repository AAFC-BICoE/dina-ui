 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    matches: { mixin: "[MIXIN] հանդիպումները գտել" },
    current: "(Ընթացիկ)",
    hide: "Թաքցնել",
    err: "Սխալ",
    colon: ":",
    ...
    "mins-ago": { mixin: "[MIXIN] րոպե առաջ" },
    "hour-ago": "ժամ առաջ",
    "hours-ago": { mixin: "[MIXIN] ժամ առաջ" },
    "days-ago": { mixin: "[MIXIN] օր առաջ" },
    yesterday: "երեկ",
    nxt: "Հաջորդ",
    ...
    show: "Ցուցադրում",
    "tab-rot": { off: "Կանգ էջանիշը պտույտը", on: "Սկիզբ էջանիշը պտույտը" },
    ...
    close: "Մոտիկ",
    volume: "Ծավալը",
    mute: { on: "Համր", off: "Կասեցնել խլացնելու" },
    cc: { off: "Թաքցնել փակ կատալոներեն", on: "Ցուցադրել փակ կատալոներեն" },
