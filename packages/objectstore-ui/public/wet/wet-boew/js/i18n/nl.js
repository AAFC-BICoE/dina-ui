...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    "shr-hnt": " met {s} ",
    "shr-disc":
      "Er wordt hier geen goedkeuring van producten of diensten uitgedrukt.",
    ...
    "geo-ariamap":
      "Kaart object. De beschrijvingen van de kaart functies staan in de onderstaande tabel.",
    "geo-ally":
      "<strong>Keyboard gebruikers:</strong> Als de kaart is scherpgesteld, gebruikt u de pijltoetsen om de kaart en de plus en min toetsen om in te zoomen pannen. De pijltoetsen functioneren niet als schuiftoetsen bij maximale kaartgrootte.",
    ...
    "geo-loc-placeholder":
      "Vermeld de naam van de locatie&#44; postcode&#44; adres (post)&#44; het aantal NTS ...",
    ...
    "geo-aoi-instructions":
      'Bakenen een gebied op de kaart of voer de onderstaande informatie in en klik op de "Toevoegen" button.',
    ...
    "geo-geoloc-fail":
      "Locatie mislukt. Zorg ervoor dat locatiediensten zijn ingeschakeld.",
    "geo-geoloc-uncapable":
      "Lokalisatie wordt niet ondersteund door uw browser.",
