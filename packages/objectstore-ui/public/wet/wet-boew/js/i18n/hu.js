...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    "shr-hnt": " a {s} ",
    "shr-disc":
      "I jóváhagyását olyan termékek vagy szolgáltatások kifejezett vagy hallgatólagos.",
    ...
    /* Session timeout */
    "st-to-msg-bgn":
      "A munkamenet lejár automatikusan #min# perc #sec# másodperc.",
    "st-to-msg-end":
      'Válassza a "Folytatás session" kiterjeszteni a munkamenet.',
    "st-msgbx-ttl": "Munkamenet időtúllépési figyelmeztetés",
    "st-alrdy-to-msg":
      "Sajnos a munkamenet már lejárt. Kérjük, jelentkezzen be újra.",
    ...
    "geo-ariamap":
      "Térkép objektumot. A leírások A térkép funkciók az alábbi táblázat tartalmazza.",
    "geo-ally":
      "<strong>Billentyűzet felhasználók:</strong> Ha a térkép a középpontban, a nyílbillentyűkkel mozgathatja a térképet, és a plusz és mínusz gombokkal a képre. A nyilak nem fog mozogni a térképen, ha a térkép kinagyított mértékben.",
    ...
    "geo-attrttl":
      "GeoGratis - Kanada alaptérkép (angol vagy francia nyelven esetén)",
    "geo-sel": "Választ",
    "geo-lblsel": "Ellenőrizze, hogy jelölje ki az elemet a térképen",
    "geo-locurl-geogratis": "//geogratis.gc.ca/services/geolocation/en/locate",
    "geo-loc-placeholder":
      "Adja meg a helység nevét&#44; irányítószám&#44; cím (postai)&#44; a száma NTS ...",
    ...
    "geo-aoi-instructions":
      'Döntetlen box a térképen vagy adja meg a koordinátákat, majd kattintson a "Hozzáadás" gombra.',
    ...
    "geo-geoloc-fail":
      "Hely sikerült. Ügyeljen arra, hogy a helymeghatározó szolgáltatások engedélyezve vannak.",
