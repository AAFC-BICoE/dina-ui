...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    "shr-hnt": " mit {s} ",
    "shr-disc":
      "Keine Unterstützung von Produkten oder Dienstleistungen ausdrücklich oder stillschweigend.",
    ...
    "st-to-msg-end":
      'Wählen Sie "Weiter Sitzung", um die Sitzung zu verlängern.',
    "st-msgbx-ttl": "Session Zeitablaufwarnung",
    "st-alrdy-to-msg":
      "Leider Ihre Sitzung ist bereits abgelaufen. Bitte loggen Sie sich erneut.",
    ...
    "geo-ariamap":
      "Kartenobjekt. Die Beschreibungen der Karte Funktionen sind in der Tabelle unten.",
    "geo-ally":
      "<strong>Keyboard-Benutzer:</strong> Wenn die Karte im Fokus ist, verwenden Sie die Pfeiltasten, um die Karte und die Plus-und Minus-Tasten zu vergrößern schwenken. Die Pfeiltasten werden nicht schwenken die Karte, wenn die Karte soweit gezoomt.",
    ...
    "geo-loc-placeholder":
      "Geben Sie den Namen des Ortes&#44; Postleitzahl&#44; Adresse (Post)&#44; die Anzahl der NTS ...",
    ...
    "geo-aoi-instructions":
      'Zeichnen Feld auf der Karte oder geben Sie die Koordinaten ein und klicken Sie auf "Hinzufügen".',
    ...
    "geo-geoloc-fail":
      "Lage fehlgeschlagen. Bitte stellen Sie sicher, dass die Ortungsdienste aktiviert sind.",
