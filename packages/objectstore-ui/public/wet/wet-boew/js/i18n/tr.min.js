 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    matches: { mixin: "[MIXIN] eşleşme bulundu" },
    current: "(güncel)",
    hide: "Sakla",
    err: "Hata",
    colon: ":",
    ...
    "mins-ago": { mixin: "[MIXIN] dakika önce" },
    "hour-ago": "bir saat önce",
    "hours-ago": { mixin: "[MIXIN] saat önce" },
    "days-ago": { mixin: "[MIXIN] gün önce" },
    yesterday: "dün",
    nxt: "Bir sonraki",
    ...
    "esc-key": "(escape tuşu)",
    show: "Göster",
    "tab-rot": { off: "Tab dönüşünü durdur", on: "Tab dönüşünü başlat" },
    ...
    close: "Kapat",
    volume: "Hacim",
    mute: { on: "Sessiz", off: "Sesi aç" },
    cc: { off: "Kapalı eklentileri gizle", on: "Kapalı eklentileri göster" },
    "cc-err": "Kapalı eklenti yükleme hatası",
    adesc: { on: "Sesli açıklama açık", off: "Sesli açıklama kapalı" },
