 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    "min-ago": "一分鐘前",
    "coup-mins": "數分鐘前",
    "mins-ago": { mixin: "[MIXIN]分鐘前" },
    "hour-ago": "一小時前",
    "hours-ago": { mixin: "[MIXIN]數小時前" },
    "days-ago": { mixin: "[MIXIN]數天前" },
    yesterday: "昨天",
    nxt: "下一筆",
    "nxt-r": "下一筆（右箭頭鍵）",
    prv: "上一筆",
