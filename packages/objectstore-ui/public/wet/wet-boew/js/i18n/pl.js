...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    "shr-hnt": " do {s} ",
    "shr-disc":
      "Nie wyrażamy bezposrednio lub pośrednio poparcia dla żadnych produktów ani usług.",
    ...
    /* Session timeout */
    "st-to-msg-bgn":
      "Twoja sesja wygaśnie automatycznie w #min# min #sec# sek.",
    "st-to-msg-end": 'Wybierz "Kontynuuj sesję" przedłużyć sesję.',
    "st-msgbx-ttl": "Ostrzeżenie: limit czasu sesji",
    "st-alrdy-to-msg":
      "Niestety sesja już się skończyła. Zaloguj się ponownie.",
    ...
    "geo-ariamap":
      "Obiekt na mapie. Opisy funkcji na mapie są w tabeli poniżej.",
    "geo-ally":
      "<strong>Dla użytkowników klawiatury:</strong> Kiedy mapa jest w centrum, używaj klawiszy strzałek, aby przesunąć mapę oraz klawiszy plus i minus, aby ją powiększyć lub zmniejszyć. Klawisze strzałek nie będą przesuwać mapy po powiększeniu jej do granicy mapy.",
    ...
    "geo-attrttl":
      "GeoGratis - Kanada baza map (tylko w języku angielskim lub francuskim)",
    "geo-sel": "Wybrać",
    "geo-lblsel": "Wybierz element na mapie",
    "geo-locurl-geogratis": "//geogratis.gc.ca/services/geolocation/en/locate",
    "geo-loc-placeholder":
      "Podać nazwę miejscowości&#44; kod pocztowy&#44; adres (pocztowy)&#44; liczba NTS ...",
    ...
    "geo-aoi-instructions":
      'Narysuj pole na mapie lub wprowadź współrzędne poniżej i kliknij na przycisk "Dodaj".',
    ...
    "geo-geoloc-fail":
      "Lokalizacja nie powiodło się. Proszę upewnić się, że usługi lokalizacyjne są włączone.",
    "geo-geoloc-uncapable":
      "Lokalizacja nie jest obsługiwany przez przeglądarkę.",
