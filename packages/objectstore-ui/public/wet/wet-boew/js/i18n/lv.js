...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    "shr-hnt": " ar {s} ",
    "shr-disc":
      "Neviena jebkuru produktu vai pakalpojumu apstiprināšanu vai ietverta.",
    ...
    /* Session timeout */
    "st-to-msg-bgn":
      "Jūsu sesija beigsies automātiski #min# min sekundē #sec#.",
    "st-to-msg-end":
      'Izvēlieties "Turpināt sesiju", lai paplašinātu savu sesiju.',
    "st-msgbx-ttl": "Sesijas taimauts brīdinājums",
    "st-alrdy-to-msg":
      "Atvainojiet, jūsu sesija jau ir beidzies. Lūdzu pieteikties vēlreiz.",
    ...
    "geo-ally":
      "<strong>Tastatūras tīklā:</strong> Kad karte ir fokusā, izmantojiet bulttaustiņus, lai pārvietotos karti un plus un mīnus taustiņus, lai tuvinātu. Bulttaustiņi nebūs panoramētu karti kad pietuvināto uz kartes apmērā.",
    ...
    "geo-loc-placeholder":
      "Norāda nosaukumu vietu&#44; pasta indekss&#44; adresi (pasta)&#44; skaits NTS ...",
    "geo-loc-label": "Vieta",
    ...
    "geo-aoi-instructions":
      'Zīmēt rūtiņu uz kartes vai ievadīt koordinātas zemāk un noklikšķiniet uz pogas "Pievienot".',
    ...
    "geo-geoloc-fail":
      "Atrašanās vieta neizdevās. Lūdzu, pārliecinieties, ka uz atrašanās vietas pakalpojumi tiek iespējots.",
