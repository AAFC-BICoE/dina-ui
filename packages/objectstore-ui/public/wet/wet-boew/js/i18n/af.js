...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    "shr-hnt": " met {s} ",
    "shr-disc":
      "Geen endossement van enige produkte of dienste is uitgedruk of geரliseer",
    ...
    /* Session timeout */
    "st-to-msg-bgn":
      "Jou sessie sal outomaties verval in #min# min #sec# sek aan.",
    ...
    "geo-ariamap":
      "Kaart voorwerp. Die beskrywings van die kaart funksies is in die tabel hieronder.",
    "geo-ally":
      "<strong>Sleutelbord-gebruikers:</strong> Wanneer die kaart in fokus is, gebruik die pyltjie sleutels om die kaart en die plus en minus sleutels om te zoom om die pan. Die pyltjie sleutels om die kaart sal nie die pan wanneer dit aan die kaart mate vergrote.",
    ...
    "geo-loc-placeholder":
      "Dui die naam van die plek&#44; poskode&#44; adres (pos)&#44; die aantal NTS ...",
    ...
    "geo-aoi-instructions":
      'Baken \'n gebied op die kaart of die onderstaande inligting in en kliek dan op die "Teken"-knoppie.',
    ...
    "geo-geoloc-fail":
      "Plek gefaal het. Maak asseblief seker dat plek dienste word aangeskakel.",
