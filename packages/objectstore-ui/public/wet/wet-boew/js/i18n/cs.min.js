 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    matches: { mixin: "[MIXIN] zápasů nenalezen" },
    current: "(aktuální)",
    hide: "Schovat",
    err: "Chyba",
    colon: ":",
    ...
    "mins-ago": { mixin: "před [MIXIN] minutami" },
    "hour-ago": "před hodinou",
    "hours-ago": { mixin: "před [MIXIN] hodinami" },
    "days-ago": { mixin: "před [MIXIN] dny" },
    yesterday: "včera",
    nxt: "Další",
    ...
    "esc-key": "(klávesy ESC)",
    show: "Ukázat",
    "tab-rot": { off: "Zastavit kartě otáčení", on: "Zahájit kartě otáčení" },
    ...
    close: "Zavřít",
    volume: "Hlasitost",
    mute: { on: "Vypnutí", off: "Nahlas" },
    cc: { off: "Skrýt Skryté titulky", on: "Zobrazit Skryté titulky" },
    "cc-err": "Chyba při načítání uzavřené titulky",
    adesc: { on: "Povolit zvukový popis", off: "Zakázat zvukový popis" },
    pos: "Aktuální pozice:",
    dur: "Celkový čas:",
    "shr-txt": "Sdílet",
    "shr-pg": " tuto stránku",
      ...
      return (
        a.extend(a.validator.messages, {
          ...
          rangelength: a.validator.format(
            "Prosím, zadejte od {0} do {1} znaků."
          ),
          range: a.validator.format("Prosím, zadejte hodnotu od {0} do {1}."),
          max: a.validator.format(
            "Prosím, zadejte hodnotu menší nebo rovnu {0}."
          ),
          min: a.validator.format(
            "Prosím, zadejte hodnotu větší nebo rovnu {0}."
          )
        }),
        a
      );
