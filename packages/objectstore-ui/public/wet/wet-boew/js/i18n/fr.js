...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    "date-show":
      "Sélectionner une date à partir d'un calendrier pour le champ:",
    ...
    cal: "Calendrier",
    "cal-format":
      "<span class='wb-inv'>{ddd}, </span>{d}<span class='wb-inv'> {M} {Y}</span>",
    ...
    "st-alrdy-to-msg":
      "Désolé, votre session a déjà expiré. S'il vous plaît ouvrir une nouvelle session.",
    ...
    "geo-ariamap":
      "Objet de la carte. Les descriptions des caractéristiques de la carte se trouvent dans la table ci-dessous.",
    "geo-ally":
      "<strong>Utilisateurs de clavier :</strong> Lorsque la carte a l'attention, utiliser les touches flèches pour déplacer la carte et utiliser les touches plus et négatif pour faire un zoom. La carte ne peut être déplacée lorsque le zoom est à son étendue maximal.",
    ...
    "geo-bmap-url":
      "//geoappext.nrcan.gc.ca/arcgis/rest/services/BaseMaps/CBCT3978/MapServer/WMTS/",
    "geo-bmap-matrix-set": "default028mm",
    "geo-bmapttl": "BaseMaps_CBCT3978",
    "geo-bmapurltxt":
      "//geoappext.nrcan.gc.ca/arcgis/rest/services/BaseMaps/CBCT_TXT_3978/MapServer/WMTS/tile/1.0.0/BaseMaps_CBMT3978/{Style}/{TileMatrixSet}/{TileMatrix}/{TileRow}/{TileCol}.jpg",
    ...
    "geo-loc-placeholder":
      "Indiquer le nom de l&#39;endroit&#44; le code postal&#44; l&#39;adresse (postale)&#44; le numéro du SNRC...",
    "geo-loc-label": "Location",
    "geo-aoi-north": "Nord",
    "geo-aoi-east": "Est",
    "geo-aoi-south": "Sud",
    "geo-aoi-west": "Ouest",
    "geo-aoi-instructions":
      "Délimiter un territoire sur la carte ou entrer les coordonnées ci-dessous, puis cliquer sur le bouton &#171;&#160;Ajouter&#160;&#187;.",
    "geo-aoi-title":
      "Délimiter un territoire sur la carte ou entrer les coordonnées",
    "geo-aoi-btndraw": "Tracer",
    "geo-aoi-btnclear": "Enlever",
    "geo-geoloc-btn": "Zoom sur votre position actuelle",
    "geo-geoloc-fail":
      "Localisation a échoué. S'il vous plaît s'assurer que les services de localisation sont activés.",
    "geo-geoloc-uncapable":
      "Localisation n'est pas supporté par votre navigateur.",
    ...
    "disable-notice":
      "Vous naviguez présentement sur la version HTML simplifiée de cette page. Certaines fonctionnalités peuvent être désactivées.",
    ...
    /* Filter */
    "fltr-lbl":
      'Filtrer<span class="wb-inv"> le contenu: Les résultats s\'afficherons au moment même de la saisie.</span>',
