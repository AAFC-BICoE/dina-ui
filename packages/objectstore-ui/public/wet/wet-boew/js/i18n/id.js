...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    "shr-hnt": " dengan {s} ",
    "shr-disc":
      "Tidak ada dukungan dari produk atau jasa yang tersurat maupun tersi",
    ...
    /* Session timeout */
    "st-to-msg-bgn":
      "Sesi Anda akan berakhir secara otomatis dalam #min# menit #sec# detik.",
    ...
    "geo-ariamap":
      "Peta objek. Deskripsi dari fitur peta dalam tabel di bawah ini.",
    "geo-ally":
      "<strong>Pengguna Keyboard:</strong> Bila peta dalam fokus, gunakan tombol panah untuk menggeser peta dan tombol plus dan minus untuk zoom. Tombol panah tidak akan menggeser peta ketika diperbesar sejauh peta.",
    ...
    "geo-attrttl":
      "GeoGratis - Canada peta dasar (bahasa Inggris atau Perancis hanya)",
    "geo-sel": "Memilih",
    "geo-lblsel": "Periksa untuk memilih elemen pada peta",
    "geo-locurl-geogratis": "//geogratis.gc.ca/services/geolocation/en/locate",
    "geo-loc-placeholder":
      "Menunjukkan nama lokasi&#44; kode pos&#44; alamat (pos)&#44; jumlah NTS ...",
    ...
    "geo-aoi-instructions":
      'Menggambar kotak pada peta atau masukkan koordinat di bawah ini dan klik tombol "Add".',
    ...
    "geo-geoloc-fail":
      "Lokalisasi gagal. Pastikan bahwa layanan lokasi diaktifkan.",
