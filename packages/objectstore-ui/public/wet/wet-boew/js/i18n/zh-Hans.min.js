 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    "min-ago": "一分钟前",
    "coup-mins": "一两分钟前",
    "mins-ago": { mixin: "[MIXIN]数分钟前" },
    "hour-ago": "一小时前",
    "hours-ago": { mixin: "[MIXIN]数小时前" },
    "days-ago": { mixin: "[MIXIN]数天前" },
    yesterday: "昨天",
    nxt: "下一个",
    "nxt-r": "下一个（右箭头键）",
    prv: "上一个",
