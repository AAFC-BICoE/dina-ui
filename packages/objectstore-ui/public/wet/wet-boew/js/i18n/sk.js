...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    "shr-hnt": " s {s} ",
    "shr-disc":
      "Č schválenie akýchkoľvek výrobkov alebo služieb je vyjadrené alebo predpokladané.",
    ...
    "st-alrdy-to-msg":
      "Je nám ľúto, váš relácie už vypršala. Prosím, prihláste sa znova.",
    ...
    "geo-ariamap":
      "Mapa objekt. Popisy v mape funkcií sú uvedené v tabuľke nižšie.",
    "geo-ally":
      "<strong>Klávesové užívatelia:</strong> Ak je mapa v centre pozornosti, pomocou klávesov so šípkami posúvať mapu a plus a mínus pre priblíženie. Klávesov so šípkami nebude posúvanie mapy pri zväčšení na mapu rozsahu.",
    ...
    "geo-attrttl":
      "GeoGratis - Kanada základná mapa (len po anglicky alebo francúzsky)",
    "geo-sel": "Vybrať",
    "geo-lblsel": "Skontrolujte, vyberte prvok na mape",
    "geo-locurl-geogratis": "//geogratis.gc.ca/services/geolocation/en/locate",
    "geo-loc-placeholder":
      "Uveďte názov miesta&#44; poštové smerovacie číslo&#44; adresu (poštové)&#44; počet NTS ...",
    ...
    "geo-aoi-instructions":
      'Nakreslite rámček na mape alebo zadajte súradnice nižšie a kliknite na tlačidlo "Pridať".',
    ...
    "geo-geoloc-fail":
      "Lokalita zlyhalo. Uistite sa, že umiestnenie služby sú povolené.",
    "geo-geoloc-uncapable":
      "Lokalizácia nie je podporovaná vo vašom prehliadači.",
