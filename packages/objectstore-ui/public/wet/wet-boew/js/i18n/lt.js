...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    "shr-hnt": " su {s} ",
    "shr-disc":
      "Išreikštų ar numanomų ne bet kokius produktus ar paslaugas įrašas.",
    ...
    "st-alrdy-to-msg":
      "Deja, Jūsų sesija jau baigėsi. Prašome prisijungti vėl.",
    ...
    "geo-ariamap":
      "Žemėlapis objektas. Žemėlapio funkcijų aprašymai žemiau pateiktoje lentelėje.",
    "geo-ally":
      "<strong>Klaviatūros Vartotojų:</strong> žemėlapis sufokusuotas, naudokite rodyklių klavišus į panoraminį vaizdą, žemėlapį ir pliuso ir minuso klavišus. Rodyklių klavišus nebus przesuniesz žemėlapį, kai didinimas žemėlapyje,.",
    ...
    "geo-attrttl":
      "GeoGratis - Kanada bazė žemėlapis (anglų arba prancūzų kalba)",
    "geo-sel": "Pasirinkti",
    "geo-lblsel": "Patikrinkite, pasirinkite elementą žemėlapyje",
    "geo-locurl-geogratis": "//geogratis.gc.ca/services/geolocation/en/locate",
    "geo-loc-placeholder":
      "Nurodykite vietą&#44; pašto kodą&#44; adresą (pašto)&#44; į NBA numeris Pavadinimas ...",
    "geo-loc-label": "Vieta",
    ...
    "geo-aoi-instructions":
      'Lygiosios langelį žemėlapyje arba įveskite koordinates žemiau ir spustelėkite mygtuką "Pridėti".',
    ...
    "geo-geoloc-fail":
      "Vieta nepavyko. Prašome užtikrinti, kad vietos nustatymo paslaugos yra įjungtas.",
