 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    matches: { mixin: "[MIXIN] मैचों मिला" },
    current: "(वर्तमान)",
    hide: "छिपाना",
    err: "त्रुटि",
    colon: ":",
    ...
    "mins-ago": { mixin: "[MIXIN] मिनट पहले" },
    "hour-ago": "एक घंटे पहले",
    "hours-ago": { mixin: "[MIXIN] घंटे पहले" },
    "days-ago": { mixin: "[MIXIN] दिन पहले" },
    yesterday: "कल",
    nxt: "अगला",
    ...
    "esc-key": "(भागने कुंजी)",
    show: "दिखाना",
    "tab-rot": { off: "टैब रोटेशन रोकें", on: "टैब रोटेशन प्रारंभ" },
    "tab-list": "टैब सूची",
    ...
    close: "पास",
    volume: "मात्रा",
    mute: { on: "म्यूट", off: "अनम्यूट" },
    cc: { off: "बंद कैप्शन छुपाएं", on: "बंद कैप्शन दिखाएं" },
    "cc-err": "लोड करने में त्रुटि बंद कैप्शन",
    adesc: { on: "ऑडियो विवरण सक्षम", off: "ऑडियो विवरण अक्षम" },
    pos: "वर्तमान स्थिति:",
    dur: "कुल समय:",
    "shr-txt": "शेयर",
    "shr-pg": " इस पन्ने",
