 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    srch: "ᕿᓂᕈᑎ",
    "no-match": "ᐊᔾᔨᖃᙱᑦᑐᖅ",
    matches: { mixin: "[MIXIN] ᐊᔾᔨᖓ(ᖏᑦ) ᓇᓂᔭᖅ" },
    current: "(ᒫᓐᓇᐅᔪᖅ)",
    hide: "ᑕᕐᕆᓪᓕ",
    err: "ᑕᒻᒪᕐᓂᖅ",
    colon: ":",
    ...
    "mins-ago": { mixin: "[MIXIN] ᒥᓂᑦᓯᓂ ᐊᓂᒍᖅᑐᓂ" },
    "hour-ago": "ᐃᑲᕐᕋᓕᒫᒥ ᐊᓂᒍᖅᑐᒥ",
    "hours-ago": { mixin: "[MIXIN] ᐃᑲᕐᕋᓂ ᐊᓂᒍᖅᑐᓂ" },
    "days-ago": { mixin: "[MIXIN] ᐅᓪᓗᓂ ᐊᓂᒍᖅᑐᓂ" },
    yesterday: "ᐃᑉᐸᒃᓴᖅ",
    nxt: "ᑭᖑᓪᓕᖅ",
    ...
    close: "ᒪᑐᓕ",
    volume: "ᓂᐱᖅᑯᖅᑐᓯᒋᐊᕈᑦ",
    mute: { on: "ᓂᐸᖏᓪᓕ", off: "ᓂᓪᓕᐊᓕ" },
    cc: { off: "ᐅᓂᒃᑳᑉ ᑕᐃᒎᓯᖏ ᓴᖅᑭᔮᕈᓐᓃᕐᓕ", on: "ᐅᓂᒃᑳᑉ ᑕᐃᒎᓯᖏ ᓴᖅᑭᔮᕐᓕ" },
