...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    "shr-hnt": " s {s} ",
    "shr-disc":
      "Č. schválení jakýchkoli výrobků nebo služeb je vyjádřené nebo předpokládané.",
    ...
    "st-alrdy-to-msg":
      "Je nám líto, váš relace již vypršela. Prosím, přihlaste se znovu.",
    ...
    "geo-ariamap":
      "Mapa objekt. Popisy v mapě funkcí jsou uvedeny v tabulce níže.",
    "geo-ally":
      "<strong>Klávesové uživatelé:</strong> Pokud je mapa v centru pozornosti, pomocí kláves se šipkami posouvat mapu a plus a mínus pro přiblížení. Kláves se šipkami nebude posouvání mapy při zvětšení na mapu rozsahu.",
    ...
    "geo-attrttl":
      "GeoGratis - Kanada základní mapa (pouze anglicky nebo francouzsky)",
    "geo-sel": "Vybrat",
    "geo-lblsel": "Zkontrolujte, vyberte prvek na mapě",
    "geo-locurl-geogratis": "//geogratis.gc.ca/services/geolocation/en/locate",
    "geo-loc-placeholder":
      "Uveďte název místa&#44; poštovní směrovací číslo&#44; adresu (poštovní)&#44; počet NTS ...",
    ...
    "geo-aoi-instructions":
      'Vymezit oblast na mapě nebo zadejte údaje níže a poté klikněte na tlačítko "Přidat".',
    ...
    "geo-geoloc-fail":
      "Lokalita se nezdařilo. Ujistěte se, že umístění služby jsou povoleny.",
