 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    matches: { mixin: "[MIXIN] correspondance(s) trouvées" },
    current: "(actuel)",
    hide: "Masquer",
    err: "Erreur",
    colon: "&#160;:",
    ...
    "mins-ago": { mixin: "il y a [MIXIN] minutes" },
    "hour-ago": "il y a une heure",
    "hours-ago": { mixin: "il y a [MIXIN] heures" },
    "days-ago": { mixin: "il y a [MIXIN] jours" },
    yesterday: "hier",
    nxt: "Suivant",
    ...
    close: "Fermer",
    volume: "Volume",
    mute: { on: "Activer le mode muet", off: "Désactiver le mode muet" },
    cc: { off: "Masquer le sous-titrage", on: "Afficher le sous-titrage" },
      ...
      return (
        a.extend(a.validator.messages, {
          ...
          maxlength: a.validator.format(
            "Veuillez fournir au plus {0} caractères."
          ),
          ...
          step: a.validator.format(
            "Veuillez fournir une valeur multiple de {0}."
          ),
          ...
          rangeWords: a.validator.format(
            "Veuillez fournir entre {0} et {1} mots."
          ),
          ...
          vinUS:
            "Veuillez fournir un numéro d'identification du véhicule (VIN).",
