...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    "shr-hnt": "koos {s}",
    "shr-disc":
      "Mistahes tootele või teenusele pole otseselt ega kaudselt toetust avaldatud.",
    ...
    "st-alrdy-to-msg":
      "Kahjuks on su sessioon aegunud. Palun logi uuesti sisse.",
    ...
    "geo-ariamap":
      "Kaardi objekt. Võimaluste kirjeldused leiad alltoodud tabelist.",
    "geo-ally":
      "<strong>Klaviatuuri kasutajatele:</strong> Kui kaart on fookuses, kasutage nooleklahve kaardi panoraamimiseks ja pluss- ja miinusklahve suumimiseks. Nooleklahvidega ei saa panoraamida, kui kaart on suumitud kogu ulatuses.",
    ...
    "geo-attrttl":
      "GeoGratis - Kanada põhikaart (inglise või prantsuse keeles)",
    "geo-sel": "Vali",
    "geo-lblsel": "Märkige kaardil elemendi valimiseks",
    "geo-locurl-geogratis": "//geogratis.gc.ca/services/geolocation/en/locate",
    "geo-loc-placeholder":
      "Märkida nimi asukohta&#44; postiindeks&#44; aadress (postiaadress)&#44; kui palju on NTS ...",
    ...
    "geo-aoi-instructions":
      'Joonista kasti kaardil või sisesta koordinaadid ja klikkige "Lisa" nuppu.',
    ...
    "geo-geoloc-fail":
      "Asukoht ei ole. Palun veenduge, et asukoha määramise teenuste on lubatud.",
