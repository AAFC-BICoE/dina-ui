 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    matches: { mixin: "[MIXIN] cоответствий найдено" },
    current: "(текущая)",
    hide: "Скрыть",
    err: "Ошибка",
    colon: ":",
    ...
    "mins-ago": { mixin: "[MIXIN] минут назад" },
    "hour-ago": "час назад",
    "hours-ago": { mixin: "[MIXIN] часов назад" },
    "days-ago": { mixin: "[MIXIN] дней назад" },
    yesterday: "вчера",
    nxt: "Следующий",
    ...
    close: "Закрыть",
    volume: "Громкость",
    mute: { on: "Отключение звука", off: "Включить звук" },
    cc: { off: "Скрыть Субтитры", on: "Показать Субтитры" },
    "cc-err": "Ошибка загрузки субтитров",
    adesc: { on: "Включить описание аудио", off: "Отключить Описание аудио" },
    pos: "Текущая позиция:",
    dur: "Общее время:",
    "shr-txt": "Поделиться",
