...
(function(wb) {
  ...
  wb.i18nDict = {
    ...
    "shr-hnt": " með {s} ",
    "shr-disc":
      "Engin áritun allar vörur eða þjónustu er gefið eða gefið í skyn.",
    ...
    "st-alrdy-to-msg":
      "Því miður fundur hefur þegar útrunninn. Vinsamlegast skráðu þig inn aftur.",
    ...
    "geo-ariamap":
      "Kort mótmæla. Lýsingum á kort lögun eru í töflunni hér að neðan.",
    "geo-ally":
      "<strong>Lyklaborð Notendur:</strong> Þegar kort er í fókus, nota arrow takkana til að færa kortið og plús og mínus takkana til að súmma. Örvatakkana mun ekki hliðra kortinu þegar aðdregna inn á kortið marki.",
    ...
    "geo-loc-placeholder":
      "Tilgreina nafn staðsetningu&#44; póstnúmer&#44; heimilisfang (Postal)&#44; fjölda NTS ...",
    ...
    "geo-aoi-instructions":
      'Draw kassi á kortið eða sláðu hnit neðan og smelltu á "Bæta við" hnappinn.',
    ...
    "geo-geoloc-fail":
      "Staðsetning mistókst. Skaltu tryggja að staðsetningu þjónustu eru virk.",
