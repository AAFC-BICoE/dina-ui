 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    matches: { mixin: "[MIXIN] zápasov nenájdený" },
    current: "(aktuálne)",
    hide: "Schovať",
    err: "Chyba",
    colon: ":",
    ...
    "mins-ago": { mixin: "pred [MIXIN] minútami" },
    "hour-ago": "pred hodinou",
    "hours-ago": { mixin: "pred [MIXIN] hodinami" },
    "days-ago": { mixin: "pred [MIXIN] dňami" },
    yesterday: "včera",
    nxt: "Ďalšie",
    ...
    "esc-key": "(klávesy ESC)",
    show: "Ukázať",
    "tab-rot": { off: "Zastaviť kartu otáčania", on: "Dátum kartu otáčania" },
    "tab-list": "Tab Zoznam",
    ...
    close: "Zavrieť",
    volume: "Hlasitosti",
    mute: { on: "Vypnutie", off: "Nahlas" },
    cc: { off: "Skryť Skryté titulky", on: "Zobraziť Skryté titulky" },
    "cc-err": "Chyba pri načítaní uzavreté titulkami",
    adesc: { on: "Povoliť zvukový opis", off: "Zakázať zvukový opis" },
      ...
      return (
        a.extend(a.validator.messages, {
          ...
          rangelength: a.validator.format(
            "Minimálne {0} a maximálne {1} znakov."
          ),
