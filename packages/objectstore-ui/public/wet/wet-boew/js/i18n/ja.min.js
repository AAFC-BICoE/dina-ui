 ...
 */ !(function(a) {
  ...
  a.i18nDict = {
    ...
    "min-ago": "1分前",
    "coup-mins": "数分前",
    "mins-ago": { mixin: "[MIXIN] 分前" },
    "hour-ago": "1時間前",
    "hours-ago": { mixin: "[MIXIN] 時間前" },
    "days-ago": { mixin: "[MIXIN] 日前" },
    yesterday: "昨日",
    nxt: "次へ",
    "nxt-r": "次へ（右矢印キー）",
    prv: "前へ",
    ...
    close: "閉じる",
    volume: "音量",
    mute: { on: "ミュート", off: "ミュート解除" },
    cc: {
      off: "クローズドキャプションを非表示",
      on: "クローズドキャプションを表示"
    },
    "cc-err": "クローズドキャプションを実行できませんでした。",
    adesc: { on: "音声ガイドを有効にする", off: "音声ガイドを無効にする" },
    pos: "現在位置：",
    dur: "合計時間：",
    "shr-txt": "共有",
    "shr-pg": "このページ",
