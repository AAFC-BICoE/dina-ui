      ...
      f = function() {
        (c = new Date().getTime()),
          ...
          d >= e
            ...
            : (b && clearTimeout(b), (b = setTimeout(f, e - d)));
      },
      g = 0;
  })(a),
    (function(a, b, c, d) {
      ...
      function f(b, c) {
        ...
        if (
          ...
          (f = b.originalEvent),
          (g = a.event.props),
          o.search(/^(mouse|click)/) > -1 && (g = D),
          f)
        )
          for (l = g.length, i; l; ) (i = g[--l]), (b[i] = f[i]);
        if (
          (o.search(/mouse(down|up)|click/) > -1 && !b.which && (b.which = 1),
          -1 !== o.search(/^touch/) &&
            ((h = e(f)),
            (o = h.touches),
            (j = h.changedTouches),
      ...
      function q(b) {
        ...
        if (
          f &&
          1 === f.length &&
          ((c = b.target), (d = g(c)), d.hasVirtualBinding)
        ) {
      ...
      function s(b) {
        if (!L) {
          var c = e(b).touches[0],
            ...
            h = g(b.target);
          (I = I || Math.abs(c.pageX - G) > f || Math.abs(c.pageY - H) > f),
            I && !d && o("vmousecancel", b, h),
            o("vmousemove", b, h),
            m();
        }
      }
        ...
        if (!L) {
          ...
          if ((o("vmouseup", a, c), !I)) {
            ...
            d &&
              ...
              ((b = e(a).changedTouches[0]),
              J.push({ touchID: P, x: b.clientX, y: b.clientY }),
              (K = !0));
          }
        ...
        (a.event.special.tap = {
          ...
          setup: function() {
            ...
            c.bind("vmousedown", function(d) {
              ...
              function h() {
                g(),
                  c.unbind("vclick", i).unbind("vmouseup", g),
                  f.unbind("vmousecancel", h);
              }
              function i(a) {
          ...
          handleSwipe: function(b, c) {
            c.time - b.time < a.event.special.swipe.durationThreshold &&
              ...
              b.origin
                .trigger("swipe")
                .trigger(
                  b.coords[0] > c.coords[0] ? "swipeleft" : "swiperight"
                );
          },
          setup: function() {
            var b = this,
            ...
            c.bind(i, function(b) {
              function e(b) {
                g &&
                  ...
                  Math.abs(g.coords[0] - f.coords[0]) >
              ...
              c.bind(k, e).one(j, function() {
                c.unbind(k, e),
                  g && f && a.event.special.swipe.handleSwipe(g, f),
                  (g = f = d);
              });
            });
          }
