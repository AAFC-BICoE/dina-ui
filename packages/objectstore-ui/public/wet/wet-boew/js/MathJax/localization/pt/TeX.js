...
MathJax.Localization.addTranslation("pt", "TeX", {
  ...
  strings: {
    ExtraOpenMissingClose:
      "Chaveta de abertura a mais ou chaveta de fecho a menos",
    ExtraCloseMissingOpen:
      "Chaveta de fecho a mais ou chaveta de abertura a menos",
    ...
    DoubleExponentPrime:
      "\u00C9 amb\u00EDguo a que diz respeito a plica (\u2032): use chavetas para clarificar",
    CantUseHash1:
      "N\u00E3o pode usar o car\u00E1cter # que indica um par\u00E2metro de macro no modo matem\u00E1tico",
    ...
    BracketMustBeDimension:
      "O argumento nos par\u00EAnteses retos de %1 deve ser uma dimens\u00E3o",
    ...
    MissingCloseBracket:
      "N\u00E3o foi encontrado um ']' de fecho para o argumento de %1",
    MissingOrUnrecognizedDelim:
      "O delimitador para %1 est\u00E1 em falta ou n\u00E3o foi reconhecido",
    ...
    InvalidBBoxProperty:
      "'%1' n\u00E3o parece ser uma cor, uma dimens\u00E3o de espa\u00E7amento, nem um estilo",
    ...
    NewextarrowArg1:
      "O primeiro argumento de %1 deve ser o nome de uma sequ\u00EAncia de controlo",
    NewextarrowArg2:
      "O segundo argumento de %1 deve ser composto por dois inteiros separados por uma v\u00EDrgula",
    NewextarrowArg3:
      "O terceiro argumento de %1 deve ser o c\u00F3digo Unicode de um caractere",
    NoClosingChar: "N\u00E3o foi poss\u00EDvel encontrar um %1 de fecho",
    IllegalControlSequenceName:
      "O nome da sequ\u00EAncia de controlo para %1 \u00E9 inv\u00E1lido",
    IllegalParamNumber:
      "N\u00FAmero inv\u00E1lido de par\u00E2metros especificado em %1",
    ...
    MissingReplacementString:
      "Falta a string de substitui\u00E7\u00E3o para a defini\u00E7\u00E3o de %1",
