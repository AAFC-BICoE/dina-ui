...
MathJax.Localization.addTranslation("nl", "TeX", {
  ...
  strings: {
    ExtraOpenMissingClose:
      "Overtollige openende accolade of ontbrekende afsluitende accolade",
    ExtraCloseMissingOpen:
      "Overtollige afsluitende accolade of ontbrekende openende accolade",
    ...
    DoubleSubscripts:
      "Dubbele subschriften: gebruik accolades om te verduidelijken",
    DoubleExponentPrime:
      "Priem veroorzaakt een dubbele exponent: Gebruik accolades om te verduidelijken.",
    ...
    MaxMacroSub1:
      "Het MathJax maximale aantal macrovervangingen is overschreden; is er een recursieve macro-aanroep?",
    MaxMacroSub2:
      "Het MathJax maximale aantal macrovervangingen is overschreden; is er een recursieve LaTeX-omgeving?",
    MissingArgFor: "Ontbrekend argument voor %1",
    ExtraAlignTab: "Overtollige uitlijningtab in \\cases-tekst",
    BracketMustBeDimension:
      "Rechte haak argument voor %1 moet een dimensie zijn",
    InvalidEnv: 'Ongeldige omgevingsnaam "%1"',
    UnknownEnv: 'Onbekende omgeving "%1"',
    ExtraCloseLooking:
      "Overtollige afsluitende accolade terwijl gezocht wordt naar %1",
    MissingCloseBracket: "Kon afsluitende ']' niet vinden als argument voor %1",
    MissingOrUnrecognizedDelim:
      "Ontbrekend of onbekend scheidingsteken voor %1",
    ...
    MaxBufferSize:
      "MathJax interne bufferomvang overschreden; is er een recursieve macro-aanroep?",
    ...
    PositiveIntegerArg:
      "Het argument voor %1 moet een positief geheel getal zijn",
    ErroneousNestingEq: "Foutief nesten van vergelijkingsstructuren",
    MultlineRowsOneCol:
      "De regels in de omgeving %1 moeten precies \u00E9\u00E9n kolom bevatten",
    MultipleBBoxProperty: "%1 twee keer gespecificeerd in %2",
    InvalidBBoxProperty:
      '"%1" lijkt niet op een kleur, een opvuldimensie of een stijl',
    ...
    NewextarrowArg1:
      "Eerste argument voor %1 moet een bewerkingsvolgorde naam zijn.",
    NewextarrowArg2:
      "Tweede argument voor %1 moet twee gehele getallen zijn, gescheiden door een komma",
    NewextarrowArg3:
      "Derde argument voor %1 moet een Unicodekarakternummer zijn",
    NoClosingChar: "Kan afsluitende %1 niet vinden",
    IllegalControlSequenceName:
      "Niet toegestane bewerkingsvolgordenaam voor %1",
    IllegalParamNumber:
      "Niet toegestane getallen of parameters gespecificeerd in %1",
    ...
    MissingReplacementString:
      "Ontbrekende vervangende tekst voor definitie van %1",
