...
MathJax.Localization.addTranslation("it", "TeX", {
  ...
  strings: {
    ...
    MaxMacroSub1:
      "Numero massimo per le sostituzioni di macro superato da MathJax; forse una chiamata di macro ricorsiva?",
    MaxMacroSub2:
      "Numero massimo per le sostituzioni superato da MathJax; forse un'ambiente LaTeX ricorsivo?",
