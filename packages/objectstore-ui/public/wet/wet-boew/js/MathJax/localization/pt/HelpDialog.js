...
MathJax.Localization.addTranslation("pt", "HelpDialog", {
  ...
  strings: {
    ...
    ShowMath:
      "*Mostrar f\u00F3rmulas como* permite que visualize o c\u00F3digo da f\u00F3rmula para copiar e colar (como MathML ou no seu formato original).",
    Settings:
      "*Configura\u00E7\u00F5es* oferecem o controle sobre os recursos do MathJax, tais como o tamanho das f\u00F3rmulas, e o mecanismo utilizado para exibir equa\u00E7\u00F5es.",
    Language:
      "*Idioma* permite que escolha o idioma que o MathJax utiliza nos seus menus e mensagens de aviso.",
    Zoom:
    ...
    Accessibilty:
      "*Acessibilidade*: O MathJax funcionar\u00E1 automaticamente em leitores de ecr\u00E3 para tornar as f\u00F3rmulas matem\u00E1ticas acess\u00EDveis aos que possuem problemas de vis\u00E3o.",
    Fonts:
