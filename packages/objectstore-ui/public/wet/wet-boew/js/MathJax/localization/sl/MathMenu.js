...
MathJax.Localization.addTranslation("sl", "MathMenu", {
  ...
  strings: {
    ...
    WebkitNativeMMLWarning:
      "Va\u0161 brskalnik ne podpira MathML sam po sebi, zato ob preklopu na MathML matematika morda ne bo berljiva.",
    MSIENativeMMLWarning:
      "Internet Explorer potrebuje za obdelavo izhoda MathML vti\u010Dnik MathPlayer.",
    OperaNativeMMLWarning:
      "Podpora Opere za MathML je omejena, zato se bodo ob preklopu na MathML nekateri izrazi morda slabo izrisali.",
    SafariNativeMMLWarning:
      "MathML va\u0161ega brskalnika ne podpira vseh mo\u017Enosti MathJaxa, zato se nekateri izrazi morda ne bodo pravilno prikazali.",
    FirefoxNativeMMLWarning:
      "MathML va\u0161ega brskalnika ne podpira vseh mo\u017Enosti MathJaxa, zato se nekateri izrazi morda ne bodo pravilno izrisali.",
    MSIESVGWarning:
      "V Internet Explorerju pred IE9 in pri emulaciji IE8 ali manj SVG ni podprt. Ob preklopu na SVG se matematika ne bo prikazala pravilno.",
    LoadURL:
      "Nalo\u017Ei podatke za prevajanje z naslednjega spletnega naslova:",
    BadURL:
      "Spletni naslov mora biti za javaskriptno datoteko, ki opredeljuje podatke MathJax o prevajanju. Imena javaskriptnih datotek se morajo kon\u010Dati z '.js'",
    BadData: "Nalaganje podatkov za prevajanje iz %1 ni uspelo",
    SwitchAnyway: "Vseeno zamenjam izrisovalnik?",
    ScaleMath:
      "Umeri vso matematiko (v primerjavi z okoli\u0161nim besedilom) z",
    NonZeroScale: "Merilo ne sme biti ni\u010D",
    PercentScale: "Merilo naj bo odstotek (npr. 120%%)",
    IE8warning:
      "To onemogo\u010Di meni MathJax in mo\u017Enosti zumiranja, vendar pa lahko namesto tega kliknete izraz ob dr\u017Eanju tipke Alt, s \u010Dimer se prika\u017Ee meni MathJax.",
    IE9warning:
      "Kontekstni meni MathJax bo izklopljen, namesto tega pa lahko s klikom izraza ob dr\u017Eanju tipke Alt prikli\u010Dete meni MathJax.",
