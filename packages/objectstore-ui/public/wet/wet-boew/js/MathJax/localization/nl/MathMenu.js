...
MathJax.Localization.addTranslation("nl", "MathMenu", {
  ...
  strings: {
    ...
    WebkitNativeMMLWarning:
      "Uw browser lijkt MathML niet te ondersteunen. Door te kiezen voor MathML-uitvoer kunnen de wiskundige formules op de pagina onleesbaar worden.",
    MSIENativeMMLWarning:
      "Internet Explorer vereist de MathPlayer plug-in om MathML-uitvoer te verwerken",
    OperaNativeMMLWarning:
      "De ondersteuning voor MathML in Opera is beperkt, dus als u overschakelt naar weergave via MathML kunnen sommige expressies slecht worden weergegeven.",
    SafariNativeMMLWarning:
      "De in uw browser ingebouwde MathML heeft niet alle mogelijkheden die door MathJax worden gebruikt, dus niet alle expressies kunnen correct worden weergegeven.",
    FirefoxNativeMMLWarning:
      "De in uw browser ingebouwde MathML heeft niet alle mogelijkheden die door MathJax worden gebruikt, dus niet alle expressies kunnen correct worden weergegeven.",
    MSIESVGWarning:
      "SVG is niet ge\u00EFmplementeerd in Internet Explorer versies v\u00F3\u00F3r IE9 en ook niet wanneer het IE8 of lager emuleert. Kiezen voor SVG-uitvoer veroorzaakt onjuiste weergave van de wiskundige formules.",
    LoadURL: "Vertalingsdata van deze URL laden:",
    BadURL:
      'De URL moet naar een JavaScriptbestand wijzen waarin vertaalgegevens voor MathJax staan. De naam van het JavaScriptbestand moet eindigen op ".js".',
    ...
    ScaleMath:
      "Alle wiskundige formules schalen (in vergelijking tot de omliggende tekst) met",
    NonZeroScale: "De schaal hoort geen nul te zijn",
    PercentScale: "De schaal moet een percentage zijn (bijvoorbeeld 120%%)",
    IE8warning:
      "Hierdoor wordt het MathJaxmenu en zoomfuncties uitgeschakeld, maar u kunt via Alt-klik op een expressie het MathJamenu weergeven.\n\nWilt u inderdaad de instellingen van MathPlayer wijzigen?",
    IE9warning:
      "Het context menu van MathJax wordt uitgeschakeld, maar u kunt in plaats daarvan door Alt-klikken op een expressie het MathJax menu weergeven.",
