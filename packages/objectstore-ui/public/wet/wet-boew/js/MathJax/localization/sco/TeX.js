...
MathJax.Localization.addTranslation("sco", "TeX", {
  ...
  strings: {
    ...
    DoubleExponentPrime:
      "Prime causes dooble exponent: Uise brackets tae clarifie",
    ...
    MaxMacroSub1:
      "MathJax mucklest macro substitution coont exceeded; is thaur ae recursive macro caw?",
    MaxMacroSub2:
      "MathJax mucklest substitution coont exceeded; is thaur ae recursive LaTeX environment?",
    ...
    MaxBufferSize:
      "MathJax internal buffer size exceeded; is thaur ae recursive macro caw?",
    ...
    MultlineRowsOneCol:
      "The lines wiin the %1 environment maun hae exactlie yin column",
    MultipleBBoxProperty: "%1 speceefied twice in %2",
    InvalidBBoxProperty:
      "'%1' disna luik like ae colour, ae paddin dimension, or ae style",
    ...
    NewextarrowArg1:
      "Foremait argument til %1 maun be ae control sequence name",
    NewextarrowArg2:
      "Seicont argument til %1 maun be twa integers separated bi ae comma",
    NewextarrowArg3:
      "Third argument til %1 maun be ae Unicode chairacter nummer",
