...
MathJax.Localization.addTranslation("ast", "TeX", {
  ...
  strings: {
    ExtraOpenMissingClose:
      "Hai una llave d'apertura de m\u00E1s o falta una llave de zarramientu",
    ExtraCloseMissingOpen:
      "Hai una llave de zarramientu de m\u00E1s o falta una llave d'apertura",
    ...
    DoubleExponentPrime:
      "La prima causa un doble esponente: use llaves p'aclarar",
    CantUseHash1:
      "Nun pue usar el \u00ABcar\u00E1uter # de par\u00E1metru de macro\u00BB en mou matem\u00E1ticu",
    ...
    MaxMacroSub1:
      "Se sobrepas\u00F3'l n\u00FAmberu m\u00E1ximu de sustituciones de macro de MathJax; \u00BFhai ha una llamada de macro recursiva?",
    MaxMacroSub2:
      "Pas\u00F3se'l n\u00FAmberu m\u00E1ximu de sustituciones de MathJax; \u00BFhai un entornu de LaTeX recursivu?",
    MissingArgFor: "Falta l'argumentu pa %1",
    ExtraAlignTab: "Tabulador d'alliniamientu estra en testu \\cases",
    BracketMustBeDimension:
      "L'argumentu de corchete pa %1 tien de ser una dimensi\u00F3n",
    ...
    MissingCloseBracket:
      "Nun pudo alcontrase'l \u00AB]\u00BB de zarramientu pal argumentu de %1",
    MissingOrUnrecognizedDelim:
      "El delimitador pa %1 falta o nun ta reconoc\u00EDu",
    MissingDimOrUnits: "Falta la dimensi\u00F3n o les unidaes pa %1",
    TokenNotFoundForCommand: "Nun pudo alcontrase %1 pa %2",
    MathNotTerminated:
      "Espresi\u00F3n matem\u00E1tica inacabada nel cuadru de testu",
    IllegalMacroParam: "Referencia illegal a par\u00E1metru de macro",
    MaxBufferSize:
      "Se sobrepas\u00F3 el tama\u00F1u del almacenamientu intermediu internu de MathJax; \u00BFhai ha una llamada a una macro recursiva?",
    ...
    ErroneousNestingEq:
      "A\u00F1eramientu incorreutu d'estructures d'ecuaci\u00F3n",
    MultlineRowsOneCol:
      "Les fileres dientro del entornu %1 han de tener exactamente una columna",
    MultipleBBoxProperty: "Propied\u00E1 %1 especificada dos veces en %2",
    InvalidBBoxProperty:
      "'%1' nun paez un color, una distancia de separaci\u00F3n o un estilu",
    ExtraEndMissingBegin: "Sobra un %1 o falta un \\begingroup",
    GlobalNotFollowedBy:
      "%1 nun ta sigu\u00EDu por \\let, \\def o \\newcommand",
    ...
    NewextarrowArg1:
      "El primer argumentu pa %1 tien de ser un nome de secuencia de control",
    NewextarrowArg2:
      "El segundu argumentu pa %1 tienen de ser dos enteros separaos por una coma",
    NewextarrowArg3:
      "El tercer argumentu pa %1 tien de ser un n\u00FAmberu de car\u00E1uter Unicode",
    NoClosingChar: "Nun pue alcontrase'l %1 de zarru",
    IllegalControlSequenceName: "Nome incorreutu de secuencia de control pa %1",
    IllegalParamNumber:
      "N\u00FAmberu par\u00E1metros illegal especific\u00E1u en %1",
    MissingCS: "%1 tien de tar sigu\u00EDu por una secuencia de control",
    CantUseHash2: "Usu illegal de # nuna plant\u00EDa pa %1",
    SequentialParam:
      "Los par\u00E1metros pa %1 tienen de numberase de mou secuencial",
    MissingReplacementString:
      "Falta la cadena de sustituci\u00F3n pa la definici\u00F3n de %1",
