...
MathJax.Localization.addTranslation("ast", "HTML-CSS", {
  ...
  strings: {
    ...
    FirefoxCantLoadWebFont:
      "Firefox nun pue cargar les tipograf\u00EDes web dende un sirvidor remotu",
    CantFindFontUsing:
      "Nun se pue atopar una tipograf\u00EDa v\u00E1lida usando %1",
    WebFontsNotAvailable:
      "Les tipograf\u00EDes web nun tan disponibles. Usando les tipograf\u00EDes d'imaxe nel so llugar"
  }
});
