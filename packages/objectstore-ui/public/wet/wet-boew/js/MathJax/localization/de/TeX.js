...
MathJax.Localization.addTranslation("de", "TeX", {
  ...
  strings: {
    ExtraOpenMissingClose:
      "Zus\u00E4tzliche \u00F6ffnende, oder fehlende schlie\u00DFende Klammer",
    ExtraCloseMissingOpen:
      "Zus\u00E4tzliche schlie\u00DFende, oder fehlende \u00F6ffnende Klammer",
    ...
    DoubleExponent:
      "Doppeltes Hochstellen: Klammern f\u00FCr eine eindeutige Zuordnung verwenden",
    DoubleSubscripts:
      "Doppeltes Tiefstellen: Klammern f\u00FCr eine eindeutige Zuordnung verwenden",
    DoubleExponentPrime:
      "Prime f\u00FChrt zu doppeltem Hochstellen: Klammern f\u00FCr eine eindeutige Zuordnung verwenden",
    CantUseHash1:
    ...
    MaxMacroSub1:
      "Maximale Anzahl an Makro-Ersetzungen ist erreicht; wird ein rekursiver Makroaufruf verwendet?",
    MaxMacroSub2:
      "Maximale Anzahl an Ersetzungen ist erreicht; wird eine rekursive LaTeX-Umgebung verwendet?",
    MissingArgFor: "Fehlendes Argument in %1",
    ExtraAlignTab: "Zus\u00E4tzlicher Ausrichtungstabulator im '\\cases' Text",
    BracketMustBeDimension:
      "Das Klammer-Argument f\u00FCr %1 muss eine Dimension sein",
    InvalidEnv: "Ung\u00FCltiger Umgebungsname: \u201E%1\u201C",
    UnknownEnv: "Ung\u00FCltige Umgebung: \u201E%1\u201C",
    ExtraCloseLooking:
      "Zus\u00E4tzliche schlie\u00DFende Klammer w\u00E4hrend der Suche nach %1",
    MissingCloseBracket: "Argument zu %1 wurde nicht mit ']' geschlossen",
    MissingOrUnrecognizedDelim:
      "Fehlendes oder nicht erkanntes Begrenzungszeichen bei %1",
    MissingDimOrUnits: "Fehlende Dimension oder Einheiten bei %1",
    TokenNotFoundForCommand: "Konnte %1 nicht f\u00FCr %2 finden",
    MathNotTerminated:
      "Mathematischer Ausdruck im Textfeld nicht abgeschlossen",
    IllegalMacroParam: "Ung\u00FCltiger Makroparameterbezug",
    MaxBufferSize:
      "Interne Puffergr\u00F6\u00DFe \u00FCberschritten; wird ein rekursiver Makroaufruf verwendet?",
    ...
    MultlineRowsOneCol:
      "Zeilen in der %1-Umgebung m\u00FCssen genau eine Spalte haben",
    MultipleBBoxProperty: "%1 wurde zweimal in %2 angegeben",
    InvalidBBoxProperty:
      "'%1' scheint keine Farbe, Abstands-Dimension oder Stil zu sein",
    ...
    NewextarrowArg2:
      "Zweites Argument von %1 m\u00FCssen zwei ganze Zahlen sein, durch Komma getrennt",
    NewextarrowArg3:
      "Das dritte Argument von %1 muss die Nummer eines Unicode-Zeichens sein",
    ...
    NoClosingDelim:
      "Kein schlie\u00DFendes Begrenzungszeichen f\u00FCr %1 gefunden"
  }
});
