...
MathJax.Localization.addTranslation("es", "TeX", {
  ...
  strings: {
    ExtraOpenMissingClose:
      "Llave de apertura adicional o falta la llave de cierre",
    ExtraCloseMissingOpen:
      "Llave de cierre adicional o falta la llave de apertura",
    ...
    DoubleExponentPrime:
      "El s\u00EDmbolo \u00ABprima\u00BB causa un exponente doble, utiliza llaves para aclarar",
    CantUseHash1:
      'No puedes utilizar "n\u00FAmero de car\u00E1cter de par\u00E1metro de macro" en modo matem\u00E1tico',
    ...
    MaxMacroSub1:
      "Conteo m\u00E1ximo de sustituci\u00F3n de macro MathJax superado, \u00BFhay una llamada recursiva de macro?",
    MaxMacroSub2:
      "Se excedi\u00F3 el conteo m\u00E1ximo de sustituci\u00F3n MathJax, \u00BFhay un ambiente recursivo de LaTeX?",
    MissingArgFor: "Falta el argumento para %1",
    ExtraAlignTab: "Ficha de alineaci\u00F3n adicional en texto \\cases",
    BracketMustBeDimension:
      "El argumento de par\u00E9ntesis %1 debe ser una dimensi\u00F3n",
    ...
    MissingCloseBracket:
      'No se pudo encontrar "]" de cierre para el argumento %1',
    ...
    MathNotTerminated:
      "La notaci\u00F3n matem\u00E1tica no termina en el cuadro de texto",
    ...
    CommandAtTheBeginingOfLine:
      "%1 debe aparecer al principio de la l\u00EDnea",
    ...
    ErroneousNestingEq:
      "Anidaci\u00F3n err\u00F3nea de estructuras de ecuaciones",
    MultlineRowsOneCol:
      "Las filas dentro del entorno %1 deben tener exactamente una columna",
    MultipleBBoxProperty: "Se ha especificado %1 dos veces en %2",
    InvalidBBoxProperty:
      '"%1" no parece ser un color, una dimensi\u00F3n de relleno o un estilo',
    ExtraEndMissingBegin: "%1 adicional o falta \\begingroup",
    GlobalNotFollowedBy: "%1 no va seguido de \\let, \\def o \\newcommand",
    UndefinedColorModel:
      "El modelo de color \u00AB%1\u00BB no est\u00E1 definido",
    ModelArg1:
      "Los valores de color para el modelo %1 requieren 3 n\u00FAmeros",
    InvalidDecimalNumber: "El n\u00FAmero decimal no es v\u00E1lido",
    ModelArg2:
      "Los valores de color para el modelo %1 deben estar entre %2 y %3",
    InvalidNumber: "El n\u00FAmero no es v\u00E1lido",
    NewextarrowArg1:
      "El primer argumento de %1 debe ser un nombre de secuencia de control",
    NewextarrowArg2:
      "El segundo argumento de %1 debe ser dos n\u00FAmeros enteros separados por una coma",
    NewextarrowArg3:
      "El tercer argumento de %1 debe ser un n\u00FAmero de caracteres Unicode",
    NoClosingChar: "No se puede encontrar el %1 de cierre",
    IllegalControlSequenceName:
      "El nombre de la secuencia de control para %1 es incorrecto",
    IllegalParamNumber:
      "Se especific\u00F3 una cantidad incorrecta de par\u00E1metros en %1",
    MissingCS: "A %1 ha de a\u00F1ad\u00EDrsele una secuencia de control",
    CantUseHash2: "Uso incorrecto de \u00AB#\u00BB en la plantilla para %1",
    SequentialParam:
      "Los par\u00E1metros para %1 deben ser numerados de forma secuencial",
    MissingReplacementString:
      "Falta la cadena de sustituci\u00F3n para la definici\u00F3n de %1",
