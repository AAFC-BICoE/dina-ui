...
MathJax.Localization.addTranslation("de", "MathML", {
  ...
  strings: {
    ...
    MathMLSingleElement:
      "MathML muss von einem einzelnen Element gebildet werden",
    MathMLRootElement:
      "MathML muss von einem \u003Cmath\u003E-Element gebildet werden, nicht %1"
  }
});
