...
MathJax.Localization.addTranslation("br", "TeX", {
  ...
  strings: {
    ExtraOpenMissingClose:
      "Briataenn digeri\u00F1 a re pe briataenn serri\u00F1 diank",
    ExtraCloseMissingOpen:
      "Briataenn serri\u00F1 a re pe briataenn digeri\u00F1 diank",
    ...
    PositiveIntegerArg:
      "Arguzenn %1 a rank beza\u00F1 un niver pozitivel anterin",
    MultlineRowsOneCol:
      "Ar renko\u00F9 e-barzh an endro %1 a rank kaout ur bann dres",
    MultipleBBoxProperty: "%1 diferet div wech e-barzh %2",
    ExtraEndMissingBegin: "%1 a re pe \\begingroup diank",
    GlobalNotFollowedBy:
      "%1 n'eo ket heuliet gant \\let, \\def, pe \\newcommand",
    UndefinedColorModel: 'N\'eo ket termenet patrom liv "%1"',
    InvalidDecimalNumber: "Niver degel direizh",
    InvalidNumber: "Niver direizh",
    NewextarrowArg2:
      "Eil arguzenn %1 a rank beza\u00F1 daou niver anterin dispartiet gant ur virgulenn",
    NewextarrowArg3:
      "Trede arguzenn %1 a rank beza\u00F1 un niverenn arouezenn unicode",
    NoClosingChar: "Ne c'haller ket kavout an %1 serri\u00F1",
    CantUseHash2: "Implij direizh eus # er patrom evit %1",
    MismatchUseDef:
      "An implij eus %1 ne glot ket gant an termenadur anezha\u00F1",
    ...
    DoubleSubscripts:
      "Isskrid double : implijit briataenno\u00F9 evit sklaeraat",
    ...
    ExtraAlignTab:
      "Arouezenn steuda\u00F1 '\u0026' dic'hortoz evit testenn an urzh /cases",
    BracketMustBeDimension:
      "An argutezenn etre krochedo\u00F9 an urzh %1 a rank beza\u00F1 ur vent",
    ExtraCloseLooking:
      "Briataenn serri\u00F1 dic'hortoz pa'z eo bet enklasket %1",
    MissingCloseBracket: "Ne c'haller ket kavout ']' evit arguzenn an urzh %1",
    MissingOrUnrecognizedDelim:
      "Ar bevenner a vank pe n'eo ket anavezet gant an urzh %1",
    ...
    InvalidBBoxProperty:
      "Seblantout a ra n'eo ket an talvoud '%1' ul liv, ur ment marz bihanoc'h pe ur stil.",
    ModelArg1:
      "An talvoudo\u00F9 livio\u00F9 evit ar patrom %1 o deus ezhomm eus 3 niverenn",
    ModelArg2:
      "An talvoudo\u00F9 livio\u00F9 evit ar patrom %1 a rank beza\u00F1 etre %2 ha %3",
    NewextarrowArg1:
      "Arguzenn genta\u00F1 an urzhiad %1 a rank beza\u00F1 anv ur seka\u00F1s kontrolla\u00F1",
    IllegalControlSequenceName:
      "N'eo ket aotreet anv ar c'hontroll seka\u00F1s evit an urzh %1",
    IllegalParamNumber: "Niver direizh a arventenno\u00F9 evit an urzh %1",
    MissingCS:
      "%1 a rank beza\u00F1 heuliet gant ur seka\u00F1s kontrolla\u00F1",
    MissingReplacementString:
      "Ar chadennad arouezenno\u00F9 erlec'hia\u00F1 a vank evit an termenadur %1.",
    DoubleExponentPrime:
      "Un ask a zegas un usskrid doubl : implijit briataenno\u00F9 evit sklaeraat"
  }
});
