...
MathJax.Localization.addTranslation("ca", "TeX", {
  ...
  strings: {
    ExtraOpenMissingClose:
      "Sobra una clau d'apertura o falta una clau de tancament",
    ExtraCloseMissingOpen:
      "Sobra una clau de tancament o falta una clau d'abertura",
    ...
    DoubleExponentPrime:
      'El s\u00EDmbol "prima" causa doble exponent: useu claus per aclarir',
    CantUseHash1:
      "No podeu fer servir 'el car\u00E0cter # com a par\u00E0metre de macro' en mode matem\u00E0tic",
    ...
    MaxMacroSub1:
      "S'ha sobrepassat el nombre m\u00E0xim de substitucions en una macro MathJax; hi ha una crida de macro recursiva?",
    MaxMacroSub2:
      "El comptador m\u00E0xim de substitucions de MathJax s'ha sobrepassat; hi ha un entorn de LaTeX recursiu?",
    MissingArgFor: "Falta argument per %1",
    ExtraAlignTab: "Marca d'alineaci\u00F3 extra en text \\cases",
    BracketMustBeDimension:
      "Argument de claud\u00E0tor per %1 ha de ser una dimensi\u00F3",
    ...
    MissingCloseBracket:
      "No s'ha pogut trobar ']' de tancament per argument de %1",
    MissingOrUnrecognizedDelim:
      "Falta delimitador o delimitador no reconegut per %1",
    MissingDimOrUnits: "Falta dimensi\u00F3 o unitats per %1",
    TokenNotFoundForCommand: "No s'ha pogut trobar %1 per %2",
    MathNotTerminated:
      "Expressi\u00F3 matem\u00E0tica no finalitzada en quadre de text",
    IllegalMacroParam:
      "Refer\u00E8ncia il\u00B7legal a par\u00E0metre de macro",
    MaxBufferSize:
      "S'ha sobrepassat la mida de la mem\u00F2ria interm\u00E8dia interna de MathJax; hi ha una crida de macro recursiva?",
    CommandNotAllowedInEnv: "%1 no perm\u00E8s en entorn %2",
    MultipleLabel: "Etiqueta '%1' definida m\u00E9s d'una veegada",
    CommandAtTheBeginingOfLine:
      "%1 ha d'apar\u00E8ixer a l'inici de la l\u00EDnia",
    ...
    ErroneousNestingEq:
      "Nidificaci\u00F3 incorrecta d'estructures d'equaci\u00F3",
    MultlineRowsOneCol:
      "Les files dins l'entorn %1 han de tenir exactament una columna",
    MultipleBBoxProperty: "%1 s'ha especificat dues vegades dins %2",
    InvalidBBoxProperty:
      "'%1' no \u00E9s un color, una dimensi\u00F3 o un estil",
    ExtraEndMissingBegin: "Sobra %1 o falta \\begingroup",
    GlobalNotFollowedBy:
      "%1 no est\u00E0 seguit per \\let, \\def o \\newcommand",
    ...
    NewextarrowArg1:
      "El primer argument per %1 ha de ser un nom de seq\u00FC\u00E8ncia de control",
    NewextarrowArg2:
      "El segon argument per %1 ha de ser dos enters separats per una coma",
    NewextarrowArg3:
      "El tercer argument per %1 ha de ser un n\u00FAmero de car\u00E0cter Unicode",
    NoClosingChar: "No s'ha trobat el %1 de tancament",
    IllegalControlSequenceName:
      "Nom de seq\u00FC\u00E8ncia de control incorrecta per %1",
    IllegalParamNumber:
      "S'ha especificat un nombre incorrecte de par\u00E0metres dins %1",
    MissingCS: "%1 ha de ser seguit per una seq\u00FC\u00E8ncia de control",
    CantUseHash2: "\u00DAs incorrecte de # en plantilla per %1",
    SequentialParam:
      "Els par\u00E0metres per %1 s'han de numerar seq\u00FCencialment",
    MissingReplacementString:
      "Falta cadena de substituci\u00F3 a la definici\u00F3 de %1",
