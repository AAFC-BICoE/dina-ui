MathJax.Hub.Register.StartupHook("Sre Ready", function() {
  ...
  var e = (MathJax.Extension.explorer = {
      ...
      addDefaults: function() {
        for (
          var a,
            b = MathJax.Hub.CombineConfig("explorer", e.default),
            d = Object.keys(b),
            f = 0;
          (a = d[f]);
          f++
    ...
    h = (MathJax.Extension.explorer.Explorer = {
      ...
      ActivateWalker: function(a, b) {
        var c = e.getOption("speech"),
          d = h.Walkers[e.getOption("walker")] || h.Walkers.none,
          f = c
      ...
      SpeechOutput: function() {
        h.Reset(),
          ["Subtitles", "Generation"].forEach(function(a) {
          ...
          function() {
            ...
            var a,
              ...
              k = f.SUBMENU(
                ...
                f.SUBMENU(
                  ["Walker", "Walker"],
                  f.RADIO(["nowalker", "No walker"], "Assistive-walker", {
                    value: "none"
                  }),
                  f.RADIO(["syntactic", "Syntax walker"], "Assistive-walker"),
                  f.RADIO(["semantic", "Semantic walker"], "Assistive-walker")
                ),
                f.SUBMENU(
                  ["Highlight", "Highlight"],
                ...
                f.SUBMENU(
                  ...
                  { disabled: !c["Assistive-speech"] },
                  f.RADIO(["eager", "Eager"], "Assistive-generation", {
                    action: h.Regenerate
                  }),
                  f.RADIO(["mixed", "Mixed"], "Assistive-generation", {
                    action: h.Regenerate
                  }),
                  f.RADIO(["lazy", "Lazy"], "Assistive-generation", {
                    action: h.Regenerate
                  })
                ),
                f.RULE(),
