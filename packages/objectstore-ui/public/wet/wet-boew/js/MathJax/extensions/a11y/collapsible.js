!(function(a) {
  var b,
    ...
    d = {},
    e = 1e7,
    f = "data-semantic-complexity",
    g = MathJax.Ajax.config.path;
  g.a11y || (g.a11y = a.config.root + "/extensions/a11y");
  var h = (MathJax.Extension.collapsible = {
    ...
    COLLAPSE: {
      ...
      subscript: 9,
      subsup: 9,
      punctuated: { endpunct: e, startpunct: e, default: 12 }
    },
    MARKER: {
      identifier: "x",
      number: "#",
      text: "...",
      appl: { "limit function": "lim", default: "f()" },
      fraction: "/",
      sqrt: "\u221a",
      root: "\u221a",
      superscript: "\u25fd\u02d9",
      subscript: "\u25fd.",
      subsup: "\u25fd:",
      vector: { binomial: "(:)", determinant: "|:|", default: "\u27e8:\u27e9" },
      matrix: {
        squarematrix: "[::]",
        rowvector: "\u27e8\u22ef\u27e9",
        columnvector: "\u27e8\u22ee\u27e9",
    ...
    Startup: function() {
      ...
      c && c.Dependent(this), a.postInputHooks.Add(["Filter", h], 100);
    },
    ...
    MakeAction: function(a, c) {
      var d = b
        ...
        .With({
          ...
          collapsible: !0,
          attrNames: ["id", "actiontype", "selection", f],
          attr: {},
          selection: 2
        });
      if (((d.attr[f] = d.complexity), "math" === c.type)) {
        for (
          var e,
            g = b
              .mrow()
            ...
            h = c.attrNames.length - 1;
          (e = c.attrNames[h]);
          h--
        )
          "data-semantic-" === e.substr(0, 14) &&
            ((g.attr[e] = c.attr[e]),
            g.attrNames.push(e),
            delete c.attr[e],
            c.attrNames.splice(h, 1));
        (g.complexity = c.complexity),
          d.Append(g),
          (c.data = []),
          c.Append(d),
      ...
      if (b)
        if (this["Collapse_" + b]) a = this["Collapse_" + b](a);
          ...
          var c = a.attr["data-semantic-role"],
            d = this.COLLAPSE[b];
          if (
            ("number" != typeof d && (d = d[c] || d.default), a.complexity > d)
          ) {
            var e = this.MARKER[b];
            "string" != typeof e && (e = e[c] || e.default),
    ...
    Collapse_appl: function(a) {
      if (this.UncollapseChild(a, 2, 2)) {
        ...
        (b = b[a.attr["data-semantic-role"]] || b.default),
          (a = this.MakeAction(this.Marker(b), a));
      }
      return a;
    },
  ...
  a.Register.StartupHook(
    ...
    function() {
      null == c.collapsible
        ? (c.collapsible = !h.config.disabled)
        : (h.config.disabled = !c.collapsible),
        a.Register.StartupHook(
          "MathMenu Ready",
          function() {
            ...
            var a,
              b = function(a) {
                h[c.collapsible ? "Enable" : "Disable"](!0, !0),
            ...
            i
              ? ((a = i.IndexOfId("CollapsibleMath")),
                null !== a ? (i.items[a] = g) : i.items.push(e.RULE(), g))
              : ((a = f.IndexOfId("About")), f.items.splice(a, 0, g, e.RULE()));
          },
          15
        );
    },
