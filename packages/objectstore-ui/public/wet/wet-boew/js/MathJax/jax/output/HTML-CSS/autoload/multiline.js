...
MathJax.Hub.Register.StartupHook("HTML-CSS Jax Ready", function() {
  ...
  a.mbase.Augment({
    ...
    HTMLmultiline: function(n) {
      ...
      var f = {
        ...
        k = this.HTMLgetAlign(f, {}),
        h = this.HTMLgetShift(f, {}, k),
        g = [],
        i = {
          index: [],
          penalty: e.nobreak,
        ...
        j = false;
      while (
        this.HTMLbetterBreak(i, f) &&
        (i.scanW >= b.linebreakWidth || i.penalty === e.newline)
      ) {
    ...
    HTMLaddLine: function(n, g, j, f, o, l) {
      ...
      var m = this.HTMLgetAlign(f, o),
        h = this.HTMLgetShift(f, o, m);
      if (f.n > 0) {
        var k = b.FONTDATA.baselineskip * f.scale;
        var i =
          (f.values.lineleading == null ? f.VALUES : f.values).lineleading *
          f.scale;
    ...
    HTMLmoveSlice: function(g, j, o, f, p, l) {
      this.HTMLremoveColor();
      var m = this.HTMLcreateSliceSpan(o);
      this.HTMLmoveLine(g, j, m, f, p);
      m.style[l] = "";
      this.HTMLcombineBBoxes(m, o.bbox);
      this.HTMLcleanBBox(m.bbox);
      if (j.length === 0) {
        o = this.HTMLspanElement();
        var k = o;
        if (this.href) {
          o = o.parentNode;
        }
        o.parentNode.removeChild(o);
        o.nextMathJaxSpan.id = k.id;
        var h = 0;
        while ((k = k.nextMathJaxSpan)) {
          if (k.nodeName.toLowerCase() === "a") {
            k = k.firstChild;
          }
          var i = this.HTMLhandleColor(k);
          if (i) {
    ...
    HTMLmoveSpan: function(f, j, h) {
      if (
        ...
        (j.last && h.linebreakstyle === a.LINEBREAKSTYLE.AFTER)
      ) {
  ...
  a.mfenced.Augment({
    ...
    HTMLmoveLine: function(g, l, o, f, q) {
      ...
      if (n === m && g.length > 1) {
        this.data[this.dataI[n]].HTMLmoveSlice(
          g.slice(1),
          l.slice(1),
          o,
          f,
    ...
    HTMLmoveLine: function(m, g, j, l, h) {
      ...
      if (g.length === 0) {
        ...
        if (i && this.HTMLnotEmpty(i)) {
          var k = i.HTMLspanElement().parentNode;
          if (i.href) {
            k = k.parentNode;
          }
          var f = k.parentNode;
  ...
  a.mmultiscripts.Augment({
    HTMLbetterBreak: function(j, g) {
      ...
      j.scanW = j.W;
      var p = this.HTMLspanElement().bbox,
        h = this.data[this.base].HTMLspanElement().bbox;
      var f = p.w - h.w;
      j.scanW += p.dx;
      k = j.scanW;
  ...
  a.mo.Augment({
    HTMLbetterBreak: function(h, f) {
      ...
      var i = h.scanW,
        j = h.embellished || this;
      delete h.embellished;
      var n = j.HTMLspanElement(),
        o = n.bbox.w;
      ...
      if (
        f.n === 0 &&
        (p.indentshiftfirst !== f.VALUES.indentshiftfirst ||
          p.indentalignfirst !== f.VALUES.indentalignfirst)
      ) {
        var l = this.HTMLgetAlign(f, p),
          g = this.HTMLgetShift(f, p, l);
        k += h.shift - g;
      }
      ...
      if (
        (p.linebreakstyle === a.LINEBREAKSTYLE.AFTER &&
          p.texClass === a.TEXCLASS.OPEN) ||
        p.texClass === a.TEXCLASS.CLOSE
      ) {
        m += e.close;
      }
