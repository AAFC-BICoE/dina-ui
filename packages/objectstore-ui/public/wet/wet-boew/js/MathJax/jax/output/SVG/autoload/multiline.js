...
MathJax.Hub.Register.StartupHook("SVG Jax Ready", function() {
  ...
  a.mbase.Augment({
    ...
    SVGaddLine: function(l, h, k, g, p, n) {
      ...
      q.Clean();
      var o = this.SVGgetAlign(g, p),
        i = this.SVGgetShift(g, p, o);
      if (g.n > 0) {
  ...
  a.msubsup.Augment({
    ...
    SVGmoveLine: function(i, j, m, h, o) {
      ...
      if (j.length === 0) {
        var l = this.data[this.sup],
          g = this.data[this.sub],
          n = m.w,
          k;
        if (l) {
          k = l.SVGdata || {};
  ...
  a.mo.Augment({
    SVGbetterBreak: function(i, g) {
      ...
      if (
        ...
        var n = this.SVGgetAlign(g, q),
          h = this.SVGgetShift(g, q, n);
        l += i.shift - h;
      }
