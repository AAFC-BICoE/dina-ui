...
import { QueryBuilderMemo } from "./query-builder/QueryBuilder";
import {
  applyGroupFilters,
  applyPagination,
  applyRootQuery,
  ...
  useEffect(() => {
    if (queryBuilderConfig && viewMode) {
      if (customViewQuery) {
        ...
        updateSubmittedQueryBuilderTree(newTree);
        updateQueryBuilderTree(newTree);
      ...
      {!viewMode && (
        <>
          ...
          <QueryBuilderMemo
            ...
            setSubmittedQueryBuilderTree={updateSubmittedQueryBuilderTree}
