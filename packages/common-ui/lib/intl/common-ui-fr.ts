...
export const COMMON_UI_MESSAGES_FR: Partial<typeof COMMON_UI_MESSAGES_ENGLISH> =
  {
    ...
    search: "Rechercher",
    searchDinaPlaceholder: "Rechercher dans DINA...",
    globalSearchResults: "Résultats de recherche globale",
    searchErrorMessage: "Une erreur s'est produite lors de la recherche",
    ...
    splitSelectedButtonText: "Fractionnement choisi",
    startLabel: "Démarrer",
    stepLabel: "Étape",
    subjectTermsForPage:
    ...
    update: "Mise à jour",
    uploadDerivative: "Téléverser le dérivé",
    valueLabel: "Valeur",
