...
export const DINAUI_MESSAGES_ENGLISH = {
  ...
  group: "Group",
  groupHasLabel: "Has a label",
  groupLabel: "Label",
  groupLabelStatus: "Label Status",
  groupListTitle: "Groups",
  groupMembership: "Membership",
  groupMissingLabel: "Missing a label",
  groupMustBeSelected: "Group must be selected",
  groupName: "Name",
  groupSearchPlaceholder: "Search by name, path or label",
  groupsIBelongTo: "Groups I belong to",
  groupsIDoNotBelongTo: "Groups I do not belong to",
  ...
  userHasAgent: "Linked to an agent",
  userListTitle: "Users",
  userMissingAgent: "Not linked to an agent",
