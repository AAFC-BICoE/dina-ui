...
export const DINAUI_MESSAGES_ENGLISH = {
  ...
  datasetAgentRole_associatedParty: "Associated Party",
  datasetAgentRole_contact: "Contact",
  datasetAgentRole_creator: "Creator",
  datasetAgentRole_metadataProvider: "Metadata Provider",
  datasetAgentRole_publisher: "Publisher",
  datasetAgentRoles: "Agent Roles",
  datasetAward: "Award",
  datasetAwards: "Awards",
  datasetCoverage: "Coverage",
  datasetGeographicCoverage: "Geographic Coverage",
  datasetKeywordSet: "Keyword Set",
  datasetKeywordSets: "Keyword Sets",
  datasetListTitle: "Datasets",
  ...
  datasetUsageRights: "Usage Rights",
  datasets: "Datasets",
  editDatasetTitle: "Edit Dataset",
  field_abstractText: "Abstract",
  field_awardNumber: "Award Number",
  field_awardUrl: "Award URL",
  field_beginDate: "Begin Date",
  field_commonName: "Common Name",
  field_datasetType: "Dataset Type",
  field_datasetVersion: "Dataset Version",
  field_designDescription: "Design Description",
  field_east: "East",
  field_funderIdentifiers: "Funder Identifiers",
  field_funderName: "Funder Name",
  field_funding: "Funding",
  field_geographicDescription: "Geographic Description",
  field_keywords: "Keywords",
  field_licenseName: "Licence Name",
  field_licenseUrl: "Licence URL",
  field_methodSteps: "Method Steps",
  field_north: "North",
  field_publicationDate: "Publication Date",
  field_qualityControlDescriptions: "Quality Control Descriptions",
  field_rank: "Rank",
  ...
  dateRangeLast24HoursDropdown: "Last 24 Hours",
  dateRangeLast7DaysDropdown: "Last 7 Days",
  dateRangeLast30DaysDropdown: "Last 30 Days",
  dateRangeLast3MonthsDropdown: "Last 3 Months",
  dateRangeLast6MonthsDropdown: "Last 6 Months",
  dateRangeLastYearDropdown: "Last Year",
  ...
  field_collectingEventCollectors: "Collecting Event - Collectors",
  field_collectingEvent_collectingEventCollectors: "Collectors",
  ...
  latestSampleTitle: "Most Recent Sample Added",
  ...
  queryBuilder_selectResource_placeholder: "Search for a record...",
  queryBuilder_classification_placeholder: "Select classification rank...",
  queryBuilder_geoShape_placeholder: "Select geoShape rank...",
  ...
  queryBuilder_operator_intersects: "Intersects",
  queryBuilder_operator_within: "Within",
  queryBuilder_operator_contains: "Contains",
  queryBuilder_operator_disjoint: "Disjoint",
  queryBuilder_imageLink_ORIGINAL: "Original Image",
  queryBuilder_imageLink_THUMBNAIL_IMAGE: "Thumbnail Image",
  queryBuilder_imageLink_LARGE_IMAGE: "Large Image",
  ...
  queryBuilder_autocomplete_placeholder: "Search for a record...",
  ...
  title_collectingEventCollectors: "Collecting Event - Collectors",
