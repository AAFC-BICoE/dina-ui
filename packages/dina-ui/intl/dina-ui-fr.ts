...
export const DINAUI_MESSAGES_FRENCH: Partial<typeof DINAUI_MESSAGES_ENGLISH> = {
  ...
  addCollectingEventTitle: "Ajouter un événement de prélèvement",
  ...
  collectionMethodViewTitle: "Voir la méthode de prélèvement",
  ...
  editCollectingEventTitle: "Modifier l’événement de prélèvement",
  ...
  materialSampleTypeViewTitle: "Type d’échantillon de matière",
