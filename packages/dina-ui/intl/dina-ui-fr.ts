...
export const DINAUI_MESSAGES_FRENCH: Partial<typeof DINAUI_MESSAGES_ENGLISH> = {
  ...
  collectingAgentsLegend: "Agents de recouvrement",
  collectingDateLegend: "Date de recouvrement",
  collectingEvent: "Événement de recouvrement",
  collectingEventAttachments: "Pièces jointes de l'événement de recouvrement",
  collectingEventDetailsPageLink:
    "Page des détails de l'événement de recouvrement",
  collectingEventListTitle: "Événement de recouvrement",
  collectingEventManagedAttributes:
    "Attributs gérés par l'événement de recouvrement",
  collectingEventViewTitle: "Voir l'événement de recouvrement",
  collectingLocationLegend: "Lieu de recouvrement",
  collectionManagedAttributeListTitle:
    "Attributs gérés par le module de recouvrements",
  collectionSectionTitle: "Recouvrements",
  collectorGroupAgentsLabel: "Agents du groupe de recouvrement",
  collectorGroupListTitle: "Groupe de recouvrement",
  collectorGroupNameLabel: "Nom du groupe de recouvrement",
  collectorGroupViewTitle: "Voir le groupe de recouvrement",
  ...
  detachCollectingEvent: "Détacher l'événement de recouvrement",
  ...
  editCollectingEventTitle: "Editer l'événement de recouvrement",
  ...
  field_dwcOtherRecordNumbers: "Numéros de recouvrement",
  field_dwcOtherRecordNumbers_tooltip:
    "Autres numéros ou identifiants associés à l'événement de recouvrement qui permettent de le distinguer. N'incluez PAS les identifiants basés sur les spécimens, tels que les numéros d'accession.",
  ...
  materialSample: "Échantillons de matériaux",
  ...
  preparationTypeViewTitle: "Afficher le type de préparation",
  ...
  uploadNewAttachments: "Télécharger de nouvelles pièces jointes",
