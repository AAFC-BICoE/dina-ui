...
export const DINAUI_MESSAGES_FRENCH: Partial<typeof DINAUI_MESSAGES_ENGLISH> = {
  ...
  agentLinkStatus: "Lien avec un agent",
  ...
  group: "Groupe",
  groupHasLabel: "Possède une étiquette",
  groupLabel: "Étiquette",
  groupLabelStatus: "État de l’étiquette",
  groupListTitle: "Groupes",
  groupMembership: "Adhésion",
  groupMissingLabel: "Étiquette manquante",
  groupMustBeSelected: "Un groupe doit être sélectionné ",
  groupName: "Nom",
  groupSearchPlaceholder: "Rechercher par nom, chemin ou étiquette",
  groupsIBelongTo: "Groupes dont je suis membre",
  groupsIDoNotBelongTo: "Groupes dont je ne suis pas membre",
