...
export const DINAUI_MESSAGES_FRENCH: Partial<typeof DINAUI_MESSAGES_ENGLISH> = {
  ...
  addCollectionMethodTitle: "Ajouter la méthode de collecte",
  ...
  addInstitutionTitle: "Ajouter l’institution",
  ...
  collectionMethodListTitle: "La méthode de collecte",
  collectionMethodNameLabel: "Nom de la méthode de collecte",
  collectionMethodViewTitle: "Voir la méthode de collecte",
  ...
  editInstitutionTitle: "Modifier l’institution",
