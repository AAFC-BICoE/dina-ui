...
const COLLECTION_DEFAULTS: NavigationCard[] = [
  ...
  {
    id: "expeditions",
    title: "expeditionListTitle",
    icon: FaMapLocationDot,
    href: "/collection/expedition/list",
    category: "collection"
  },
  {
    id: "material-samples",
  ...
  return [
    ...
    },
    {
      ...
      href: {
        ...
        query: { id: subject, hideBackButton: true }
      },
      category: "configuration"
    }
  ];
...
export function Home2() {
  ...
  const configurationDefaults = useMemo(
    () => configDefaults(subject),
    [subject]
  );
        ...
        <Container fluid={true}>
          ...
          <section className="mb-5">
            ...
            <CustomizableCardGrid
              ...
              onChange={(next) =>
                saveCards("controlledVocabularyCardsOrder", next)
              }
              isCustomizeMode={isCustomizeMode}
            />
          </section>
