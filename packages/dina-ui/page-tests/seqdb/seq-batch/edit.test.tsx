...
import { SeqBatch, PcrPrimer } from "../../../../types/seqdb-api";

const TEST_PCRBATCH: PersistedResource<SeqBatch> = {
  id: "123",
  type: "seq-batch",
  name: "test pcr batch",
  group: "cnc",
...
describe("PcrBatch edit page", () => {
  ...
  it("Edits an existing Seq Batch", async () => {
    const wrapper = mountWithAppContext(
