...
export const TEST_COLLECTING_EVENT_1 = {
  ...
  host: null,
  managedAttributes: {},
  dwcVerbatimLatitude: null,
  dwcVerbatimLongitude: null,
  ...
  dwcMinimumDepthInMeters: null,
  dwcMaximumElevationInMeters: null,
  dwcMaximumDepthInMeters: null,
  substrate: null,
  remarks: null,
...
export const TEST_COLLECTING_EVENT_2 = {
  ...
  dwcFieldNumber: "Collecting Event 2",
  dwcRecordNumber: null,
  otherRecordNumbers: null,
  createdBy: "cnc-su",
  createdOn: "2026-07-29T19:12:05.311891Z",
...
export const TEST_COLLECTING_ORGANISM_SAMPLES: InputResource<MaterialSample>[] =
  [
    {
      ...blankMaterialSample(),
      id: "1",
...
export const TEST_FORM_TEMPLATE_COMPONENTS_DISABLED: PersistedResource<FormTemplate> =
  {
    id: "9bcc3626-05db-4cd7-b31c-6b7e35b3d490",
    type: "form-template",
    name: "template with most data components disabled",
    group: "cnc",
    restrictToCreatedBy: false,
    viewConfiguration: { type: "material-sample-form-template" },
    components: [
      ...
      },
      {
        ...
        sections: [
          ...
          },
          {
            ...
            visible: true,
            items: [
              { defaultValue: "123", name: "dwcFieldNumber", visible: false }
            ]
          },
          {
            name: "collecting-date-section",
