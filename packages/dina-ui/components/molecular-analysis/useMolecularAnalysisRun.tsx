 ...
 */
export function attachSeqReaction(
 ...
 */
export async function attachStorageUnitUsage(
 ...
 */
export async function attachMaterialSampleSummary(
  sequencingRunItem: SequencingRunItem[],
  bulkGet: <T extends KitsuResource, TReturnNull extends boolean = false>(
    paths: readonly string[],
    options?: BulkGetOptions
 ...
 */
export async function attachPcrBatchItem(
  sequencingRunItem: SequencingRunItem[],
  bulkGet: <T extends KitsuResource, TReturnNull extends boolean = false>(
    paths: readonly string[],
    options?: BulkGetOptions
