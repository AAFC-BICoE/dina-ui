...
describe("CatalogueOfLifeNameField component", () => {
  ...
  it("Sets a value from the Catalogue of Life API.", async () => {
    ...
    expect(mockOnChange).lastCalledWith(
      '<a href="https://data.catalogueoflife.org/dataset/2328/name/f3d46805-704b-459a-a3f6-58816dad2138" target="_blank" rel="noopener"><i>Poa muralis</i> Wibel, nom. illeg.</a>',
      expect.anything()
    );
