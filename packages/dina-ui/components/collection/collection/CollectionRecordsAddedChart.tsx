...
interface CollectionRecordsAddedChartProps {
  id?: string;
  query?: any;
}

export default function CollectionRecordsAddedChart({
  id
}: CollectionRecordsAddedChartProps) {
