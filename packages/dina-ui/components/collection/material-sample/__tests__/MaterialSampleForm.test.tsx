...
const mockGet = jest.fn<any, any>(async (path) => {
  switch (path) {
    ...
    case "collection-api/collecting-event/3?include=collectors,attachment,collectionMethod,protocol,expedition,site":
      return { data: testCollectionEventWithPermissions() };
    case "collection-api/collecting-event/4?include=collectors,attachment,collectionMethod,protocol,expedition,site":
      return {
