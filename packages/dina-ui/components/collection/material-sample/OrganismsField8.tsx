...
export interface OrganismsField8Props {
...
export function OrganismsField8({
  name,
  id,
  visibleManagedAttributeKeys
}: OrganismsField8Props) {
...
interface OrganismsTable8Props {
...
function OrganismsTable8({
  ...
  const rowSortHandleColumns: ColumnDef<Organism>[] = readOnly
    ? []
    : [
        {
          id: "sortingHandler",
  ...
  return (
    <>
      ...
      <ReactTable8
        ...
        renderSubComponent={({ row }) => <div className="m-2">test</div>}
